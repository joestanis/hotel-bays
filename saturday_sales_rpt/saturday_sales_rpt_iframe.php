...
$oExportPdf = new saturday_sales_rpt_export_pdf;
$oExportPdf->exportPdf();

class saturday_sales_rpt_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("saturday_sales_rpt_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['saturday_sales_rpt']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['saturday_sales_rpt']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_saturday_sales_rpt.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['saturday_sales_rpt']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['saturday_sales_rpt']['pdf_name'] : "saturday_sales_rpt.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="saturday_sales_rpt.php" target="<?php echo $NM_target; ?>" style="display: none"> 
