<?php
   include_once('saturday_sales_rpt_session.php');
   @session_start() ;
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil']          = "conn_mssql";
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_doc']        = "";
//
class saturday_sales_rpt_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['decimal_db'] = "."; 

      $this->nm_cod_apl      = "saturday_sales_rpt"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      //check prod
      if(empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      //check img
      if(empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imagens']))
      {
              /*check img*/$_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
      }
      //check tmp
      if(empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imag_temp']))
      {
              /*check tmp*/$_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
      }
      //check doc
      if(empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_doc']))
      {
              /*check doc*/$_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
      }
      //end check publication with the prod
      $this->sc_site_ssl     = (isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) == 'on') ? true : false;
      $this->sc_protocolo    = ($this->sc_site_ssl) ? 'https://' : 'http://';
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_imag_temp'];
      $this->path_doc        = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_path_doc'];
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/saturday_sales_rpt';
      ...
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['SC_Link_View'] = true;
          }
      }
...
<?php
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "saturday_sales_rpt_erro.class.php"); 
      $this->Erro = new saturday_sales_rpt_erro();
      ...
      $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      if (isset($_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['initialize'])  
      { 
          $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['Gera_log_access'] = true;
          $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['initialize']      = false;
      } 
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']) && $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil']) && $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['saturday_sales_rpt']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['embutida_init']) 
      {
      }
// 
      if (isset($_SESSION['scriptcase']['glo_decimal_db']) && !empty($_SESSION['scriptcase']['glo_decimal_db']))
      {
         $_SESSION['sc_session'][$this->sc_page]['saturday_sales_rpt']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['saturday_sales_rpt']['glo_nm_conexao'], $this->root . $this->path_prod, 'Mottech'); 
      } 
      else 
      { 
...
//
   function NM_gera_log_insert($orig="Scriptcase", $evento="", $texto="")
   {
       ...
       if (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_access))
       { 
           $comando = "INSERT INTO Motel_log (inserted_date, username, application, creator, ip_user, `action`, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'saturday_sales_rpt', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       elseif (in_array(strtolower($_SESSION['scriptcase']['glo_tpbanco']), $this->nm_bases_sqlite))
       { 
           $comando = "INSERT INTO Motel_log (id, inserted_date, username, application, creator, ip_user, action, description) VALUES (NULL, $dt, " . $this->Db->qstr($usr) . ", 'saturday_sales_rpt', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
       } 
       else
       { 
           $comando = "INSERT INTO Motel_log (inserted_date, username, application, creator, ip_user, action, description) VALUES ($dt, " . $this->Db->qstr($usr) . ", 'saturday_sales_rpt', '$orig', '" . $_SERVER['REMOTE_ADDR'] . "', '$evento', " . $this->Db->qstr($texto) . ")"; 
...
//===============================================================================
//
class saturday_sales_rpt_sub_css
{
   function saturday_sales_rpt_sub_css()
   {
      global $script_case_init;
      if (!$this->Ini) 
      { 
          $this->Ini = new saturday_sales_rpt_ini(); 
      ...
      if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['saturday_sales_rpt']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['saturday_sales_rpt'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class saturday_sales_rpt_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'])
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_saturday_sales_rpt($cadapar[1]);
                       $$cadapar[0] = $cadapar[1];
                       if ($cadapar[0] == "val_3") 
                       {
          ...
          {
              $_SESSION['val_3'] = $val_3;
              nm_limpa_str_saturday_sales_rpt($_SESSION["val_3"]);
          }
          if (isset($val_4)) 
          {
              $_SESSION['val_4'] = $val_4;
              nm_limpa_str_saturday_sales_rpt($_SESSION["val_4"]);
          }
          if (isset($val_1)) 
          {
              $_SESSION['val_1'] = $val_1;
              nm_limpa_str_saturday_sales_rpt($_SESSION["val_1"]);
          }
          if (isset($val_2)) 
          {
              $_SESSION['val_2'] = $val_2;
              nm_limpa_str_saturday_sales_rpt($_SESSION["val_2"]);
          }
      } 
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("en_us");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "saturday_sales_rpt_erro.class.php"); 
      } 
      $this->Erro      = new saturday_sales_rpt_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_lookup.class.php"); 
      } 
      $this->Lookup       = new saturday_sales_rpt_lookup();
      $this->Lookup->Db   = $this->Db;
      $this->Lookup->Ini  = $this->Ini;
      $this->Lookup->Erro = $this->Erro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_All_Groupby'] = array('Shift' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Ind_Groupby'] = $Ind;
      } 
      $this->Ini->Apl_resumo  = "saturday_sales_rpt_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "saturday_sales_rpt_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['SC_Ind_Groupby'] . ".class.php"; 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['Gera_log_access'])
      {
          $this->Ini->NM_gera_log_insert("Scriptcase", "access");
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['Gera_log_access'] = false;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_res'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = 'pdf';
          $nmgp_opcao = 'pdf';
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_treeview'] = false;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "room";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "prices";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "time_in";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "time_out";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "elapsed";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "overtime";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "flag";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "plate";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "grandtotal";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'][] = "start_shift";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['field_order'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['saturday_sales_rpt']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['saturday_sales_rpt']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['saturday_sales_rpt']['exit'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = "inicio" ;  
      }   
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['saturday_sales_rpt']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['saturday_sales_rpt']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = "busca";
          }   
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida_form'] && $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "busca")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = "inicio";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_all'] = true;
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq'])
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = 'igual';
          } 
          else 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['contr_array_resumo'] = "NAO";
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = 'pesq';
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['orig_pesq'] = 'grid';
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"]))  
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['prim_cons'] = true;  
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq_filtro'];
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
      {
         ...
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_saturday_sales_rpt_html_" . session_id() . "_2.html";
            ...
            {
                $nm_arquivo_pdf_base = "/sc_pdf_" . date("YmdHis") . "_" . rand(0, 1000) . "_saturday_sales_rpt.pdf";
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            }
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_saturday_sales_rpt_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->java_protocol . $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_saturday_sales_rpt_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          $nm_arquivo_doc_word = "/sc_saturday_sales_rpt_res_" . session_id() . ".doc";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_xls.class.php"); 
          } 
          $this->xls  = new saturday_sales_rpt_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_xml.class.php"); 
          } 
          $this->xml  = new saturday_sales_rpt_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_csv.class.php"); 
          } 
          $this->csv  = new saturday_sales_rpt_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_rtf.class.php"); 
          } 
          $this->rtf  = new saturday_sales_rpt_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . saturday_sales_rpt . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new saturday_sales_rpt_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'], 8));
          }
          else
          { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "busca")  
      { 
          require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_pesq.class.php"); 
          $this->pesq  = new saturday_sales_rpt_pesq();
          $this->prep_modulos("pesq");
          $this->pesq->monta_busca();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['doc_word']  = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['opcao']     = "pdf";
              $_SESSION['scriptcase']['saida_word'] = true;
              $nm_arquivo_doc_word = "/sc_saturday_sales_rpt_" . session_id() . ".doc";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "saturday_sales_rpt/saturday_sales_rpt_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "saturday_sales_rpt_grid.class.php"); 
          } 
          $this->grid  = new saturday_sales_rpt_grid();
...
//--- 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_det'])
            {
            ...
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_name']))
            {
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_name']);
            }
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['pdf_file'] = $nm_arquivo_pdf_serv;
}
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
?>
<FORM name="F0" method=post action="saturday_sales_rpt.php" target="<?php echo $NM_target; ?>"> 
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq_filtro'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['fast_search']);
          return;
      }
      $comando = "";
      $sv_data = $data_search;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq_filtro'] = "( " . $comando . " )";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig'])) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_orig'] . " and ( " . $comando . " )"; 
      }
      else
      {
          $comando = " where (" . $comando . ")"; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['saturday_sales_rpt']['decimal_db'] == ".")
         {
             $nm_aspas = "";
         }
         if (is_array($campo))
...
<input type="hidden" name="nm_tit_doc" value="saturday_sales_rpt.doc"> 
<input type="hidden" name="nm_name_doc" value="<?php echo NM_encode_input($this->Ini->path_imag_temp . $nm_arquivo_doc_word) ?>"> 
</form>
<FORM name="F0" method=post action="saturday_sales_rpt.php"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
//======= =========================
   ...
   {
       include_once("saturday_sales_rpt_nmutf8.php");
   }
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_saturday_sales_rpt($nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']);
               $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida']) && $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['saturday_sales_rpt']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['saturday_sales_rpt']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['saturday_sales_rpt']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['saturday_sales_rpt']['protect_modal']) && !empty($_SESSION['scriptcase']['saturday_sales_rpt']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['saturday_sales_rpt']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        {
            $_SESSION['scriptcase']['sc_apl_menu_atual'] = "saturday_sales_rpt";
        }
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            ...
            {
                if ($nome_apl == 'saturday_sales_rpt' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('saturday_sales_rpt' == $sReferer || 'saturday_sales_rpt_' == substr($sReferer, 0, 19))
       {
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['initialize'] = false;
       }
       else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['tot_geral']);
   }

   $_POST['script_case_init'] = $script_case_init;
   if (isset($nmgp_opcao) && $nmgp_opcao == "busca" && isset($nmgp_orig_pesq))
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['b_sair'] = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'saturday_sales_rpt')
   {
       $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/saturday_sales_rpt_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'] && $nmgp_opcao != "formphp")
   { 
...
ORDER BY Total", $cadapar[0]);
                if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['SC_Ind_Groupby'] == "Shift")
                { 
                    $Temp_parms .= (empty($Temp_parms)) ? "" : " and ";
                    $Temp_parms .= $cadapar[0] . " = " . str_replace("@aspass@", $delimit, $cadapar[1]) ;
                } 
           }
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['where_resumo'] = $Temp_parms;
       } 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opcao'] = $nmgp_opcao ;  
       }   
       ...
       {
          $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       {
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['res_hrz'] = ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['res_hrz']) ? false : true;
       }
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['volta_redirect_tp'] = "";
           $nm_url_saida = "saturday_sales_rpt_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['sc_modal'] = true;
               }
               $nm_url_saida = "saturday_sales_rpt_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['menu_desenv'] = true;   
       } 
       if (isset($_GET["nmgp_parms_ret"])) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opc_psq'] = true ;   
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opc_psq'] = false ;   
       } 
       if ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida_form'])
       {
           $_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['mostra_edit'] = "N";   
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['opc_psq']) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['saturday_sales_rpt']) || $_SESSION['scriptcase']['sc_apl_seg']['saturday_sales_rpt'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['iframe_menu']) ? false : true;
...
<?php
       ...
       $contr_saturday_sales_rpt = new saturday_sales_rpt_apl();
       $contr_saturday_sales_rpt->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['saturday_sales_rpt']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_saturday_sales_rpt(&$str)
   {
