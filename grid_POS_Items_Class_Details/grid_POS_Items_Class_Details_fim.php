...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____grid_POS_Items_Class_Details"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____grid_POS_Items_Class_Details"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_POS_Items_Class_Details']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_POS_Items_Class_Details']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_POS_Items_Class_Details']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_POS_Items_Class_Details']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_POS_Items_Class_Details']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_POS_Items_Class_Details</TITLE>
