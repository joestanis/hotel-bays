...
class yesterday_sales_rpt_xls
{
   ...
   var $tit_doc;
   //---- 
   function yesterday_sales_rpt_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_yesterday_sales_rpt";
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "yesterday_sales_rpt.xls";
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['order_grid'];
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
   ...
   function NM_export_elapsed()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->elapsed);
         $this->xls_col++;
   }
   //----- overtime
   function NM_export_overtime()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->overtime);
         $this->xls_col++;
   }
   //----- flag
   function NM_export_flag()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->flag);
         $this->xls_col++;
   }
   //----- plate
   function NM_export_plate()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->plate);
         $this->xls_col++;
   }
   //----- grandtotal
   function NM_export_grandtotal()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->grandtotal))
         {
             $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getNumberFormat()->setFormatCode('#,###.##');
         }
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->grandtotal);
         $this->xls_col++;
   }
   //----- start_shift
   function NM_export_start_shift()
   {
         ...
         $this->xls_dados->getActiveSheet()->getStyle($this->calc_cell($this->xls_col) . $this->xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->start_shift);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xls_file'] = $this->xls_f;
      }
?>
