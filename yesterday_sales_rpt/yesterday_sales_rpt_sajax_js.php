  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_yesterday_sales_rpt" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function yesterday_sales_rpt_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    x_yesterday_sales_rpt_ajax_save_filter( var_room_cond, var_room, var_time_in_cond, var_time_in_dia, var_time_in_mes, var_time_in_ano, var_time_in_input_2_dia, var_time_in_input_2_mes, var_time_in_input_2_ano, var_time_in_hor, var_time_in_min, var_time_in_seg, var_time_in_input_2_hor, var_time_in_input_2_min, var_time_in_input_2_seg, var_time_out_cond, var_time_out_dia, var_time_out_mes, var_time_out_ano, var_time_out_input_2_dia, var_time_out_input_2_mes, var_time_out_input_2_ano, var_time_out_hor, var_time_out_min, var_time_out_seg, var_time_out_input_2_hor, var_time_out_input_2_min, var_time_out_input_2_seg, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, yesterday_sales_rpt_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function yesterday_sales_rpt_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function yesterday_sales_rpt_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_yesterday_sales_rpt_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, yesterday_sales_rpt_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function yesterday_sales_rpt_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
  ...
  // ---------- delete_filter
  function yesterday_sales_rpt_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_yesterday_sales_rpt_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, yesterday_sales_rpt_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function yesterday_sales_rpt_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "time_in";
  ajax_field_list[2] = "time_out";
