...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____yesterday_sales_rpt"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____yesterday_sales_rpt"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['yesterday_sales_rpt']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['yesterday_sales_rpt']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['yesterday_sales_rpt']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['yesterday_sales_rpt']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['yesterday_sales_rpt']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>yesterday_sales_rpt</TITLE>
