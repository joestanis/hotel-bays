...
class yesterday_sales_rpt_xml
{
   ...
   //---- 
   function yesterday_sales_rpt_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "yesterday_sales_rpt.xml";
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<yesterday_sales_rpt";
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<FORM name="F0" method=post action="yesterday_sales_rpt.php" style="display: none"> 
