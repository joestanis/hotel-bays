...
class yesterday_sales_rpt_csv
{
   ...
   //---- 
   function yesterday_sales_rpt_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->arquivo    .= ".csv";
      $this->tit_doc    = "yesterday_sales_rpt.csv";
      $this->delim_dados = "\"";
      $this->delim_col   = ";";
      $this->delim_line  = "\r\n";
   }
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_name']);
      }
...
$_SESSION['scriptcase']['yesterday_sales_rpt']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['yesterday_sales_rpt']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
