...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_retrieve_pswd']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
<?php
  if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
  {
      ...
      {
         echo "alert('" . html_entity_decode($mensagem) . "');";
      }
  }
?> 
 NM_tp_critica(1);
...
{ 
   ...
   document.F4.action               = "Mottech_retrieve_pswd_fim.php";
   document.F4.submit(); 
} 
