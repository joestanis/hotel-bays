  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Mottech_retrieve_pswd" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_Mottech_retrieve_pswd_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_retrieve_pswd_validate_login(var_login, var_script_case_init, do_ajax_Mottech_retrieve_pswd_validate_login_cb);
  } // do_ajax_Mottech_retrieve_pswd_validate_login

  function do_ajax_Mottech_retrieve_pswd_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_retrieve_pswd_validate_login_cb
  // ---------- Form
  function do_ajax_Mottech_retrieve_pswd_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Mottech_retrieve_pswd_submit_form(var_login, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_Mottech_retrieve_pswd_submit_form_cb);
  } // do_ajax_Mottech_retrieve_pswd_submit_form

  function do_ajax_Mottech_retrieve_pswd_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_Mottech_retrieve_pswd_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_Mottech_retrieve_pswd_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_Mottech_retrieve_pswd_navigate_form

  function do_ajax_Mottech_retrieve_pswd_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_Mottech_retrieve_pswd_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Mottech_retrieve_pswd_navigate_form_cb
