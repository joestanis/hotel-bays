...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Top_Electricity_Consumption_Rooms_chart']['contr_erro']) && $_SESSION['scriptcase']['Top_Electricity_Consumption_Rooms_chart']['contr_erro'] == 'on')
    {
