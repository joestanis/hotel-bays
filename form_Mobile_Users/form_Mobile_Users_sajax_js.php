  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Mobile_Users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_Mobile_Users_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Mobile_Users_validate_id(var_id, var_script_case_init, do_ajax_form_Mobile_Users_validate_id_cb);
  } // do_ajax_form_Mobile_Users_validate_id

  function do_ajax_form_Mobile_Users_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Mobile_Users_validate_id_cb

  // ---------- Validate login
  function do_ajax_form_Mobile_Users_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Mobile_Users_validate_login(var_login, var_script_case_init, do_ajax_form_Mobile_Users_validate_login_cb);
  } // do_ajax_form_Mobile_Users_validate_login

  function do_ajax_form_Mobile_Users_validate_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "login";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Mobile_Users_validate_login_cb

  // ---------- Validate password
  function do_ajax_form_Mobile_Users_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Mobile_Users_validate_password(var_password, var_script_case_init, do_ajax_form_Mobile_Users_validate_password_cb);
  } // do_ajax_form_Mobile_Users_validate_password

  function do_ajax_form_Mobile_Users_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Mobile_Users_validate_password_cb

  // ---------- Validate fullname
  function do_ajax_form_Mobile_Users_validate_fullname()
  {
    var nomeCampo_fullname = "fullname";
    var var_fullname = scAjaxGetFieldText(nomeCampo_fullname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Mobile_Users_validate_fullname(var_fullname, var_script_case_init, do_ajax_form_Mobile_Users_validate_fullname_cb);
  } // do_ajax_form_Mobile_Users_validate_fullname

  function do_ajax_form_Mobile_Users_validate_fullname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fullname";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Mobile_Users_validate_fullname_cb
  // ---------- Form
  function do_ajax_form_Mobile_Users_submit_form()
  {
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_login = scAjaxGetFieldText("login");
    var var_password = scAjaxGetFieldText("password");
    var var_fullname = scAjaxGetFieldText("fullname");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_Mobile_Users_submit_form(var_id, var_login, var_password, var_fullname, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_Mobile_Users_submit_form_cb);
  } // do_ajax_form_Mobile_Users_submit_form

  function do_ajax_form_Mobile_Users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("fullname");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_Mobile_Users_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_Mobile_Users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_Mobile_Users_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_Mobile_Users_navigate_form_cb);
  } // do_ajax_form_Mobile_Users_navigate_form

  function do_ajax_form_Mobile_Users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_Mobile_Users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_Mobile_Users_navigate_form_cb
  ...
  ajax_field_list[2] = "password";
  ajax_field_list[3] = "fullname";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id": {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_Id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "password": {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_password'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fullname": {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_fullname'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fullname"][1] = "fullname";
  ...
  var ajax_field_id = {
    ...
    "fullname": new Array("hidden_field_label_fullname", "hidden_field_data_fullname")
  };
