...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____form_Mobile_Users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____form_Mobile_Users"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_Mobile_Users']['db_changed'])
           {
