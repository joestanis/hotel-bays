...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Mobile Users"); } else { echo strip_tags("Update Mobile Users"); } ?></TITLE>
...
<?php
include_once("form_Mobile_Users_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_Mobile_Users_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['recarga'];
}
?>
...
<?php
 include_once("form_Mobile_Users_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_Mobile_Users'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_Mobile_Users'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Mobile Users"; } else { echo "Update Mobile Users"; } ?></span></td>
...
<tr><td>
<?php
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R")
{
?>
...
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>;"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span></TD>
...
<span id="id_read_on_login" class="sc-ui-readonly-login" style=";<?php echo $sStyleReadLab_login; ?>"><?php echo NM_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"><img src="../_lib/img/scriptcase__NM__nm_transparent.gif" style="vertical-align: middle; display: none" class="sc-js-ui-statusimg" id="id_sc_status_login" /></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_password" style="<?php echo $sStyleHidden_password; ?>;"><span id="id_label_password"><?php echo $this->nm_new_label['password']; ?></span></TD>
...
<span id="id_read_on_password" class="sc-ui-readonly-password" style=";<?php echo $sStyleReadLab_password; ?>"><?php echo NM_encode_input($this->password); ?></span><span id="id_read_off_password" style="white-space: nowrap;<?php echo $sStyleReadInp_password; ?>"><input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_password" type=password name="password" value="" 
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: 'Password', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"><img src="../_lib/img/scriptcase__NM__nm_transparent.gif" style="vertical-align: middle; display: none" class="sc-js-ui-statusimg" id="id_sc_status_password" /></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['fullname']))
    {
        $this->nm_new_label['fullname'] = "fullname";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_fullname = '';
   if (isset($this->nmgp_cmp_hidden['fullname']) && $this->nmgp_cmp_hidden['fullname'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['fullname']);
       $sStyleHidden_fullname = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_fullname = 'display: none;';
   $sStyleReadInp_fullname = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['fullname']) && $this->nmgp_cmp_readonly['fullname'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['fullname']);
       $sStyleReadLab_fullname = '';
       $sStyleReadInp_fullname = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['fullname']) && $this->nmgp_cmp_hidden['fullname'] == 'off') { $sc_hidden_yes++;  ?>
<input type=hidden name="fullname" value="<?php echo NM_encode_input($fullname) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_fullname" style="<?php echo $sStyleHidden_fullname; ?>;"><span id="id_label_fullname"><?php echo $this->nm_new_label['fullname']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_fullname" style="<?php echo $sStyleHidden_fullname; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fullname"]) &&  $this->nmgp_cmp_readonly["fullname"] == "on") { 

 ?>
<input type=hidden name="fullname" value="<?php echo NM_encode_input($fullname) . "\">" . $fullname . ""; ?>
<?php } else { ?>
<span id="id_read_on_fullname" class="sc-ui-readonly-fullname" style=";<?php echo $sStyleReadLab_fullname; ?>"><?php echo NM_encode_input($this->fullname); ?></span><span id="id_read_off_fullname" style="white-space: nowrap;<?php echo $sStyleReadInp_fullname; ?>">
 <input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_fullname" type=text name="fullname" value="<?php echo NM_encode_input($fullname) ?>"
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"><img src="../_lib/img/scriptcase__NM__nm_transparent.gif" style="vertical-align: middle; display: none" class="sc-js-ui-statusimg" id="id_sc_status_fullname" /></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_fullname_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_fullname_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Mobile_Users']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
{
?>
<script>parent.scAjaxDetailStatus("form_Mobile_Users");</script>
<?php
}
?>
<?php
