  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_POS_Items_Class_Details" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate items_
  function do_ajax_form_POS_Items_Class_Details_validate_items_(iNumLinha)
  {
    var nomeCampo_items_ = "items_" + iNumLinha;
    var var_items_ = scAjaxGetFieldText(nomeCampo_items_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_POS_Items_Class_Details_validate_items_(var_items_, iNumLinha, var_script_case_init, do_ajax_form_POS_Items_Class_Details_validate_items__cb);
  } // do_ajax_form_POS_Items_Class_Details_validate_items_

  function do_ajax_form_POS_Items_Class_Details_validate_items__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_POS_Items_Class_Details_validate_items__cb

  // ---------- Validate prices_
  function do_ajax_form_POS_Items_Class_Details_validate_prices_(iNumLinha)
  {
    var nomeCampo_prices_ = "prices_" + iNumLinha;
    var var_prices_ = scAjaxGetFieldText(nomeCampo_prices_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_POS_Items_Class_Details_validate_prices_(var_prices_, iNumLinha, var_script_case_init, do_ajax_form_POS_Items_Class_Details_validate_prices__cb);
  } // do_ajax_form_POS_Items_Class_Details_validate_prices_

  function do_ajax_form_POS_Items_Class_Details_validate_prices__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_POS_Items_Class_Details_validate_prices__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_POS_Items_Class_Details_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_POS_Items_Class_Details_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_POS_Items_Class_Details_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_POS_Items_Class_Details_add_new_line_cb);
  } // do_ajax_form_POS_Items_Class_Details_add_new_line

  function do_ajax_form_POS_Items_Class_Details_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_POS_Items_Class_Details_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_POS_Items_Class_Details_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_link_id_ = scAjaxGetFieldText("link_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_POS_Items_Class_Details_backup_line(var_id_, var_link_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_POS_Items_Class_Details_backup_line_cb);
  } // do_ajax_form_POS_Items_Class_Details_backup_line

  function do_ajax_form_POS_Items_Class_Details_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_POS_Items_Class_Details_backup_line_cb

  function do_ajax_form_POS_Items_Class_Details_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_POS_Items_Class_Details_cancel_insert

  function do_ajax_form_POS_Items_Class_Details_cancel_update(iSeqVert)
  {
    do_ajax_form_POS_Items_Class_Details_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_POS_Items_Class_Details_cancel_update

  function do_ajax_form_POS_Items_Class_Details_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_POS_Items_Class_Details_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_POS_Items_Class_Details_table_refresh()
  {
    var var_id_ = document.F2.id_.value;
    var var_link_id_ = document.F2.link_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_POS_Items_Class_Details_table_refresh(var_id_, var_link_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_POS_Items_Class_Details_table_refresh_cb);
  } //  do_ajax_form_POS_Items_Class_Details_table_refresh

  function do_ajax_form_POS_Items_Class_Details_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.link_id_.value = scAjaxGetKeyValue("link_id_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_POS_Items_Class_Details_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_POS_Items_Class_Details_submit_form(iNumLinha, indexTR)
  {
...
?>
    x_ajax_form_POS_Items_Class_Details_submit_form(var_items_, var_prices_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_POS_Items_Class_Details_submit_form_cb);
  } // do_ajax_form_POS_Items_Class_Details_submit_form

  function do_ajax_form_POS_Items_Class_Details_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_POS_Items_Class_Details_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_POS_Items_Class_Details_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_POS_Items_Class_Details_navigate_form(var_id_, var_link_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_POS_Items_Class_Details_navigate_form_cb);
  } // do_ajax_form_POS_Items_Class_Details_navigate_form

  function do_ajax_form_POS_Items_Class_Details_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.link_id_.value = scAjaxGetKeyValue("link_id_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_POS_Items_Class_Details_navigate_form_cb
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["items_" + iRow] || "on" == ajax_error_count["prices_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["items_" + iRow] && "off" == ajax_error_count["prices_" + iRow]))
    {
      if (bErrorRow)
      {
