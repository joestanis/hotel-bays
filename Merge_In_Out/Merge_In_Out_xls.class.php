...
class Merge_In_Out_xls
{
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Merge_In_Out']['xls_file'] = $this->xls_f;
      }
?>
...
<HEAD>
 <TITLE>Time In & Time Out Counter :: Excel</TITLE>
