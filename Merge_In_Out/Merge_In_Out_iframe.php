...
$oExportPdf = new Merge_In_Out_export_pdf;
$oExportPdf->exportPdf();

class Merge_In_Out_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Merge_In_Out_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Merge_In_Out']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Merge_In_Out']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Merge_In_Out.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Merge_In_Out']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Merge_In_Out']['pdf_name'] : "Merge_In_Out.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="Merge_In_Out.php" target="<?php echo $NM_target; ?>" style="display: none"> 
