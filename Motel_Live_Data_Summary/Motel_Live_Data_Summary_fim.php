...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Live_Data_Summary"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Live_Data_Summary"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Motel_Live_Data_Summary</TITLE>
