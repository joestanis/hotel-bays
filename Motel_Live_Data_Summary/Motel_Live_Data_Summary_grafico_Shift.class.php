...
class Motel_Live_Data_Summary_grafico
{
   var $Db;
   var $Ini;
   var $Erro;
   ...
   //---- 
   function Motel_Live_Data_Summary_grafico()
   {
   ...
   function monta_grafico($chart_key = '', $operation = 'chart')
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'];
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_opc_atual'] == 1)
       {
           $this->sc_graf_sint = true;
       }
       ...
       {
           $b_export = true;
           $chart_key = key($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['pivot_charts']);
       }
       elseif ('' == $chart_key)
       {
       ...
       if ($graf_field)
       {
           ...
           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field]['graf_pyram_forma'],
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf'] = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary'][$field];
           $this->grafico_flash($arr_param, $this->grafico_dados($chart_data, $arr_param['export']), $mode);
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['pivot_charts'][$chart_key]))
       {
           $chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['pivot_charts'][$chart_key];

           $arr_param = array(
               'type'        => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_tipo'],
               'width'       => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_larg'],
               'height'      => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_alt'],
               'barra_orien' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_orien'],
               'barra_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_forma'],
               'barra_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_dimen'],
               'barra_sobre' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_sobre'],
               'barra_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_empil'],
               'barra_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_inver'],
               'barra_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_agrup'],
               'barra_funil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_barra_funil'],
               'pizza_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pizza_forma'],
               'pizza_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pizza_dimen'],
               'pizza_orden' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pizza_orden'],
               'pizza_explo' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pizza_explo'],
               'pizza_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pizza_valor'],
               'linha_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linha_forma'],
               'linha_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linha_inver'],
               'linha_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linha_agrup'],
               'area_forma'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_area_forma'],
               'area_empil'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_area_empil'],
               'area_inver'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_area_inver'],
               'area_agrup'  => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_area_agrup'],
               'marca_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_marca_inver'],
               'marca_agrup' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_marca_agrup'],
               'gauge_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_gauge_forma'],
               'radar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_radar_forma'],
               'radar_empil' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_radar_empil'],
               'polar_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_polar_forma'],
               'funil_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_funil_dimen'],
               'funil_inver' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_funil_inver'],
               'pyram_dimen' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pyram_dimen'],
               'pyram_valor' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pyram_valor'],
               'pyram_forma' => $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_pyram_forma'],
               'tit_datay'   => $chart_data['label_y'],
               'tit_label'   => $chart_data['label_x'],
               'tit_chart'   => $chart_data['title'],
           ...
           elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_full'])
           {
               $mode = 'full';
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_full']);
           }
           elseif (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_bot'])
           {
               $mode = 'full';
           }
           elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_first'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_first'] = false;
               $mode = array('js', 'chart');
           }
           else
           {
           ...
           elseif ((!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']) && (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_bot']))
           {
               exit;
           }
       }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_opc_atual'] == 1)
      {
         $this->sc_graf_sint = true;
      }
      //---- 
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "" . $this->Ini->Nm_lang['lang_dbo_Motel_Live_Data_Qry_fld_Start_Shift'] . "";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['contr_label_graf']['start_shift']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['contr_label_graf']['start_shift']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['contr_label_graf']['start_shift'];
      }
   }
   ...
   function monta_arrays()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_total']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_total'] as $label => $valor)
          {
          ...
          if (!$this->sc_graf_sint)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linhas'] as $cada_elemento)
              {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linhas']))
      {
          if ($this->campo > 0)
          {
              $lab_quebra    = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linhas'][$this->campo][0], 1);
              $lab_quebra    = str_replace("&nbsp;", "", $lab_quebra);
              $this->titulo .= " - " . $this->label[$this->nivel] . " = " . $lab_quebra;
          }
          if ($this->campo > 0)
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_linhas'][$this->campo] as $ind => $valor)
              {
                  if ($ind > 0)
                  {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['del_graph_col']))
      {
          ...
          {
              $tst_ind = $ind + 1;
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['del_graph_col'][$tst_ind]))
              {
   ...
   function grafico_flash($arr_param, $arr_charts, $html_par = 'full')
   {
      global $nm_saida, $nm_retorno_graf;
         ...
         $this->orderCharts($arr_charts, $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_order']);
...
<?php
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_font']))
       {
           $chart_attr[] = "baseFontSize=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_font'] . "\"";
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['chartpallet']))
       {
           $chart_attr[] = "palette=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['chartpallet'] . "\"";
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }

       $s_xml = "<chart showValues=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_exibe_val'] . "\" caption=\"" . $this->formatFusionLabel($tit_graf) . "\" xAxisName=\"" . $this->formatFusionLabel($tit_label) . "\" yAxisName=\"" . $this->formatFusionLabel($tit_datay) . "\" paletteColors=\"" . $this->getColorList($arr_series, $_SESSION["sc_session"][$this->Ini->sc_page]["Motel_Live_Data_Summary"]["parms_graf"]["paletteColors"]) . "\" " . implode(' ', $chart_attr) . " " . $value_format . ">" . $newline;
       $link_call = '';
       if ('Gauge' == $tipo)
       {
           $iMin = 0;
...
?>
<form name="flashRedir" method="GET" action="Motel_Live_Data_Summary.php" style="display: none">
...
<?php
   ...
   function grafico_flash_config_js()
   {
      ...
      $sUrlConfigSave = $this->Ini->path_link . "Motel_Live_Data_Summary/Motel_Live_Data_Summary_config_graf_flash.php?nome_apl=Motel_Live_Data_Summary&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us";
      ...
      $nm_saida->saida("          nome_apl: \"Motel_Live_Data_Summary\",\r\n");
   ...
   function grafico_flash_config_div()
   {
      ...
      $aChartDisp        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_disp'])      && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_disp']))    ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_disp']      : array('Bar');
      $sChartType        = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_tipo'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_tipo'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_tipo']      : 'Bar';
      $iSinteticAnalitic = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_opc_atual']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_opc_atual']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_opc_atual'] : '2';
      $iChartWidth       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_larg'])      && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_larg'])      ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_larg']      : '800';
      $iChartHeight      = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_alt'])       && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_alt'])       ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_alt']       : '500';
      $sChartOrder       = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_order'])     && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_order'])     ? $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['graf_order']     : '';
      ...
      $nm_saida->saida("</div>\r\n");
      $sUrlConfigXml = "Motel_Live_Data_Summary.php";
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      else
      {
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['charts_html'] = "  FusionCharts.setCurrentRenderer('javascript');";
         }
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['charts_html'] .= $sPDFHtmlCall;
      }
   }
   ...
   function getChartRenderer($bMulti)
   {
       $sChart = '';
       $sMulti = $bMulti ? 'MS' : '';
       switch ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_tipo'])
       {
           case 'Bar':
               if ('Horizontal' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_barra_orien'])
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       $sChart .= 'StackedBar';
                       $sChart .= '3d' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_barra_dimen'] && $bMulti ? '3D' : '2D';
                   }
                   else
                   {
                       $sChart .= $sMulti . 'Bar';
               ...
               else
               {
                   if ('Off' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_barra_empil'] && $bMulti)
                   {
                       ...
                       $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_barra_dimen'] ? '2D' : '3D';
                   }
                   else
                   {
               ...
               break;
           case 'Pie':
               if ('Pie' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_pizza_forma'])
               {
                   $sChart .= 'Pie';
               }
               else
               ...
               $sChart .= '2d' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_pizza_dimen'] ? '2D' : '3D';
               break;
           case 'Line':
               if ('Line' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_linha_forma'])
               {
                   $sChart .= $sMulti . 'Line';
               }
               elseif ('Spline' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_linha_forma'])
               {
               ...
               break;
           case 'Area':
               if ('Area' == $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_area_forma'])
               {
                   if ($bMulti)
                   {
                       $sChart .= $sMulti . 'Area';
   ...
   function getChartModule($sChartType = '')
   {
       if ('' == $sChartType)
       {
           $sChartType = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['parms_graf']['graf_tipo'];
       }
       switch ($sChartType)
       {
           case 'Bar':
