...
class Motel_Live_Data_Summary_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function Motel_Live_Data_Summary_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Motel_Live_Data_Summary_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Motel_Live_Data_Summary_pack_protect_string($Tipo_filter[0]) . "\">.." . Motel_Live_Data_Summary_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "Motel_Live_Data_Summary.php";
?>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  Motel_Live_Data_Summary_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  Motel_Live_Data_Summary_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  Motel_Live_Data_Summary_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("Motel_Live_Data_Summary_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="Motel_Live_Data_Summary.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $time_in_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_dia']; 
          $time_in_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_mes']; 
          $time_in_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_ano']; 
          $time_in_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_dia']; 
          $time_in_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_mes']; 
          $time_in_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_ano']; 
          $time_in_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_hor']; 
          $time_in_min = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_min']; 
          $time_in_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_seg']; 
          $time_in_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_hor']; 
          $time_in_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_min']; 
          $time_in_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_seg']; 
          $time_in_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($start_shift_cond) || empty($start_shift_cond))
      {
         $start_shift_cond = "eq";
      }
...
<?php
   if (is_file("Motel_Live_Data_Summary_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['time_in'])) ? $this->New_label['time_in'] : "Date"; ?></TD>
      
      <INPUT type="hidden" name="time_in_cond" value="bw">
...
?>
<?php
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['opc_psq'] && !$this->aba_iframe)
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_time_in_dia').bind('change', function() {sc_Motel_Live_Data_Summary_valida_dia(this)});
    $('#SC_time_in_hor').bind('change', function() {sc_Motel_Live_Data_Summary_valida_hora(this)});
    $('#SC_time_in_input_2_dia').bind('change', function() {sc_Motel_Live_Data_Summary_valida_dia(this)});
    $('#SC_time_in_input_2_hor').bind('change', function() {sc_Motel_Live_Data_Summary_valida_hora(this)});
    $('#SC_time_in_input_2_mes').bind('change', function() {sc_Motel_Live_Data_Summary_valida_mes(this)});
    $('#SC_time_in_input_2_min').bind('change', function() {sc_Motel_Live_Data_Summary_valida_min(this)});
    $('#SC_time_in_input_2_seg').bind('change', function() {sc_Motel_Live_Data_Summary_valida_seg(this)});
    $('#SC_time_in_mes').bind('change', function() {sc_Motel_Live_Data_Summary_valida_mes(this)});
    $('#SC_time_in_min').bind('change', function() {sc_Motel_Live_Data_Summary_valida_min(this)});
    $('#SC_time_in_seg').bind('change', function() {sc_Motel_Live_Data_Summary_valida_seg(this)});
 }
 function sc_Motel_Live_Data_Summary_valida_dia(obj)
 {
 ...
 function sc_Motel_Live_Data_Summary_valida_mes(obj)
 {
 ...
 function sc_Motel_Live_Data_Summary_valida_hora(obj)
 {
 ...
 function sc_Motel_Live_Data_Summary_valida_min(obj)
 {
 ...
 function sc_Motel_Live_Data_Summary_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_Motel_Live_Data_Summary_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_Motel_Live_Data_Summary_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_Motel_Live_Data_Summary_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_Motel_Live_Data_Summary_valida_cic(obj);
     }
     else
     {
         return sc_Motel_Live_Data_Summary_valida_cnpj(obj);
     }
 }
 function sc_Motel_Live_Data_Summary_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/Motel_Live_Data_Summary";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          $NM_patch .= "Motel_Live_Data_Summary/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data_Summary']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
              ...
              if (isset($tp_html[$Cada_cmp[0]]))
              {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = Motel_Live_Data_Summary_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(Motel_Live_Data_Summary_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $time_in_cond, $time_in, $time_in_dia, $time_in_mes, $time_in_ano, $time_in_hor, $time_in_min, $time_in_seg, $time_in_input_2_dia, $time_in_input_2_mes, $time_in_input_2_ano, $time_in_input_2_min, $time_in_input_2_hor, $time_in_input_2_seg, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_dia'] = $time_in_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_mes'] = $time_in_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_ano'] = $time_in_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_dia'] = $time_in_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_mes'] = $time_in_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_ano'] = $time_in_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_hor'] = $time_in_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_min'] = $time_in_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_seg'] = $time_in_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_hor'] = $time_in_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_min'] = $time_in_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2_seg'] = $time_in_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_cond'] = $time_in_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2'] = $Conteudo; 
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']['time_in_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data_Summary']['where_pesq_ant'] = $this->comando . $this->comando_fim;
