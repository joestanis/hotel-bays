...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Acumulative_Cars_Counter_Chart_1_to_50']['contr_erro']) && $_SESSION['scriptcase']['Acumulative_Cars_Counter_Chart_1_to_50']['contr_erro'] == 'on')
    {
