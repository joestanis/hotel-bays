...
$oExportPdf = new Acumulative_Cars_Counter_Chart_1_to_50_export_pdf;
$oExportPdf->exportPdf();

class Acumulative_Cars_Counter_Chart_1_to_50_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Acumulative_Cars_Counter_Chart_1_to_50_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Acumulative_Cars_Counter_Chart_1_to_50']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Acumulative_Cars_Counter_Chart_1_to_50']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Acumulative_Cars_Counter_Chart_1_to_50.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Acumulative_Cars_Counter_Chart_1_to_50']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Acumulative_Cars_Counter_Chart_1_to_50']['pdf_name'] : "Acumulative_Cars_Counter_Chart_1_to_50.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="Acumulative_Cars_Counter_Chart_1_to_50.php" target="<?php echo $NM_target; ?>" style="display: none"> 
