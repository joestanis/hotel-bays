...
$old_error_handler = set_error_handler("form_dbo_POS_Item_Class_scriptcase_error_handler");

function form_dbo_POS_Item_Class_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_dbo_POS_Item_Class']['contr_erro']) && $_SESSION['scriptcase']['form_dbo_POS_Item_Class']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_dbo_POS_Item_Class->contr_form_dbo_POS_Item_Class->Apl_com_erro = true;
            if ($inicial_form_dbo_POS_Item_Class->contr_form_dbo_POS_Item_Class->NM_ajax_flag)
            {
                $inicial_form_dbo_POS_Item_Class->contr_form_dbo_POS_Item_Class->NM_ajax_info['errList']['geral_form_dbo_POS_Item_Class'][] = $msg;
                return;
            }
            form_dbo_POS_Item_Class_scriptcase_error_display($msg, $err_no);
        }
...
function form_dbo_POS_Item_Class_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_dbo_POS_Item_Class'])  && '' != $_SESSION['scriptcase']['error_icon']['form_dbo_POS_Item_Class'])  ? $_SESSION['scriptcase']['error_icon']['form_dbo_POS_Item_Class']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_dbo_POS_Item_Class']) && '' != $_SESSION['scriptcase']['error_close']['form_dbo_POS_Item_Class']) ? $_SESSION['scriptcase']['error_close']['form_dbo_POS_Item_Class'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_dbo_POS_Item_Class']) && '' != $_SESSION['scriptcase']['error_span_title']['form_dbo_POS_Item_Class']) ? $_SESSION['scriptcase']['error_span_title']['form_dbo_POS_Item_Class'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_dbo_POS_Item_Class']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_dbo_POS_Item_Class']) ? $_SESSION['scriptcase']['error_icon_title']['form_dbo_POS_Item_Class'] : '';
?>
