  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_POS_Item_Class" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate item_class_
  function do_ajax_form_dbo_POS_Item_Class_validate_item_class_(iNumLinha)
  {
    var nomeCampo_item_class_ = "item_class_" + iNumLinha;
    var var_item_class_ = scAjaxGetFieldText(nomeCampo_item_class_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Item_Class_validate_item_class_(var_item_class_, iNumLinha, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_validate_item_class__cb);
  } // do_ajax_form_dbo_POS_Item_Class_validate_item_class_

  function do_ajax_form_dbo_POS_Item_Class_validate_item_class__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "item_class_" + iLineNumber;
    }
    else
    {
      sFieldValid = "item_class_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "item_class_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "item_class_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_POS_Item_Class_validate_item_class__cb

  // ---------- Validate link_id_
  function do_ajax_form_dbo_POS_Item_Class_validate_link_id_(iNumLinha)
  {
    var nomeCampo_link_id_ = "link_id_" + iNumLinha;
    var var_link_id_ = scAjaxGetFieldHidden(nomeCampo_link_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Item_Class_validate_link_id_(var_link_id_, iNumLinha, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_validate_link_id__cb);
  } // do_ajax_form_dbo_POS_Item_Class_validate_link_id_

  function do_ajax_form_dbo_POS_Item_Class_validate_link_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_POS_Item_Class_validate_link_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_POS_Item_Class_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_POS_Item_Class_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_POS_Item_Class_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_add_new_line_cb);
  } // do_ajax_form_dbo_POS_Item_Class_add_new_line

  function do_ajax_form_dbo_POS_Item_Class_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_dbo_POS_Item_Class_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_POS_Item_Class_backup_line(iNumLinha)
  {
    var var_link_id_ = scAjaxGetFieldHidden("link_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Item_Class_backup_line(var_link_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_backup_line_cb);
  } // do_ajax_form_dbo_POS_Item_Class_backup_line

  function do_ajax_form_dbo_POS_Item_Class_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_dbo_POS_Item_Class_backup_line_cb

  function do_ajax_form_dbo_POS_Item_Class_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_POS_Item_Class_cancel_insert

  function do_ajax_form_dbo_POS_Item_Class_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_POS_Item_Class_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_POS_Item_Class_cancel_update

  function do_ajax_form_dbo_POS_Item_Class_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_POS_Item_Class_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_POS_Item_Class_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_POS_Item_Class_table_refresh(var_link_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_table_refresh_cb);
  } //  do_ajax_form_dbo_POS_Item_Class_table_refresh

  function do_ajax_form_dbo_POS_Item_Class_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_POS_Item_Class_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_POS_Item_Class_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_item_class_ = scAjaxGetFieldText("item_class_" + iNumLinha);
    var var_link_id_ = scAjaxGetFieldHidden("link_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_POS_Item_Class_submit_form(var_item_class_, var_link_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_submit_form_cb);
  } // do_ajax_form_dbo_POS_Item_Class_submit_form

  function do_ajax_form_dbo_POS_Item_Class_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("item_class_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_dbo_POS_Item_Class_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dbo_POS_Item_Class_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_POS_Item_Class_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("item_class_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_POS_Item_Class_navigate_form(var_link_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_dbo_POS_Item_Class_navigate_form_cb);
  } // do_ajax_form_dbo_POS_Item_Class_navigate_form

  function do_ajax_form_dbo_POS_Item_Class_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_dbo_POS_Item_Class_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "item_class_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "link_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["item_class_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_POS_Item_Class_fld_Item_Class'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["link_id_" + iNumLinha] = {"label": "Link ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["item_class_"][iNumLinha] = "item_class_" + iNumLinha;
    ajax_field_mult["link_id_"][iNumLinha] = "link_id_" + iNumLinha;
    ajax_field_id["item_class_" + iNumLinha] = new Array("hidden_field_label_item_class_", "hidden_field_data_item_class_" + iNumLinha);
    ajax_error_count["item_class_" + iNumLinha] = "off";
    ajax_error_count["link_id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["item_class_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["item_class_" + iNumLinha] = "on";
    ajax_read_only["link_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["item_class_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["item_class_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["item_class_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["item_class_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["item_class_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["item_class_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['item_class_'])) ? $this->nmgp_cmp_readonly['item_class_'] : 'off';
?>
    scAjaxFieldRead("item_class_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['link_id_'])) ? $this->nmgp_cmp_readonly['link_id_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("item_class_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["item_class_" + iRow] || "on" == ajax_error_count["link_id_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_item_class_" + iRow))
        document.getElementById("hidden_field_data_item_class_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["item_class_" + iRow] && "off" == ajax_error_count["link_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["item_class_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_item_class_" + iRow))
        document.getElementById("hidden_field_data_item_class_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_link_id_" + iRow))
