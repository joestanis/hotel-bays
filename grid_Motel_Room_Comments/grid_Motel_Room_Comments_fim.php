...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____grid_Motel_Room_Comments"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____grid_Motel_Room_Comments"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_Motel_Room_Comments</TITLE>
