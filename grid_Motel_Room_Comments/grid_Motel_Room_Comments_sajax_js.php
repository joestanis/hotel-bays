  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_Motel_Room_Comments" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_Motel_Room_Comments_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    x_grid_Motel_Room_Comments_ajax_save_filter( var_room_cond, var_room, var_car_plate_cond, var_car_plate, var_note_cond, var_note, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_Motel_Room_Comments_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_Motel_Room_Comments_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_Motel_Room_Comments_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Motel_Room_Comments_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_Motel_Room_Comments_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_Motel_Room_Comments_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_Motel_Room_Comments_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Motel_Room_Comments_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_Motel_Room_Comments_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_Motel_Room_Comments_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
