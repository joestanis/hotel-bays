...
class POS_Items_Class_resumo
{
   ...
   //---- 
   function POS_Items_Class_resumo($tipo = "")
   {
      ...
      $this->array_total_item_class = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['contr_total_geral'] == "OK")
      {
          $this->array_total_item_class = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['arr_total']['item_class'];
      }
      else
      {
          $this->array_total_item_class = array();
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['arr_total']['item_class'] = $this->array_total_item_class;
   ...
   function completeMatrix()
   {
       ...
       //-----
       foreach ($this->array_total_item_class as $i_item_class => $d_item_class) {
           if (!in_array($i_item_class, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_item_class[2] ] = $d_item_class[1];
               $this->comp_label[0][ $d_item_class[2] ] = $d_item_class[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'item_class', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_item_class => $l_item_class) {
           if (isset($this->array_total_item_class[$i_item_class])) {
               $this->comp_group[$i_item_class] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_item_class;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Group Item"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_POS_Items_Class_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_POS_Items_Class_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "POS_Items_Class_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] = "print";
      ...
      $this->total   = new POS_Items_Class_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_groupby_1("res", $this->array_total_item_class);
      ksort($this->array_total_item_class);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_POS_Items_Class_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_POS_Items_Class_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_POS_Items_Class_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css'] . '.css');
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "POS_Items_Class/POS_Items_Class_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "POS_Items_Class/POS_Items_Class_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=800&conf_larg=N&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "POS_Items_Class/POS_Items_Class_config_graf_flash.php?nome_apl=POS_Items_Class&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'POS_Items_Class_config_pivot.php?nome_apl=POS_Items_Class&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"POS_Items_Class.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"POS_Items_Class.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "POS_Items_Class/POS_Items_Class_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "POS_Items_Class/POS_Items_Class_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_POS_Items_Class_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $item_class = $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['campos_busca']['item_class']; 
          $tmp_pos = strpos($item_class, "##@@");
          if ($tmp_pos !== false)
          {
              $item_class = substr($item_class, 0, $tmp_pos);
          }
      } 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['graf_total'] = $this->array_total_item_class;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      ksort($this->array_total_item_class);
      if (isset($this->array_total_item_class))
      {
         foreach ($this->array_total_item_class as $campo_item_class => $dados_item_class)
         {
            $campo_titulo = $campo_item_class;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['embutida'])
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 0, 0, '', '_blank')", "nm_graf_submit(0, 0, 0, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Group Item X " .  $this->Ini->Nm_lang['lang_othr_rows'] . "", "", "", "", "only_text", "text_right", "", "");
      $nm_saida->saida("          $Cod_Btn \r\n");
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
   }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_item_class))
      {
         ...
         if (isset($this->array_total_item_class))
         {
             ...
             {
                 $col++;
                 $this->conv_col[$campo_item_class] = $col;
                 $this->array_item_class[$col] = $dados_item_class[3];
             }
      } // isset item_class
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['POS_Items_Class']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   //---- 
   function adiciona_registro($quebra_item_class, $quebra_item_class_orig)
   {
      $quebra_item_class = $quebra_item_class;
      //----- Group Item
      if (!isset($this->array_total_item_class[$quebra_item_class_orig]))
      {
         $this->array_total_item_class[$quebra_item_class_orig][0] = 1;
         $this->array_total_item_class[$quebra_item_class_orig][1] = $quebra_item_class;
         $this->array_total_item_class[$quebra_item_class_orig][2] = $quebra_item_class_orig;
      }
      else
      {
         $this->array_total_item_class[$quebra_item_class_orig][0]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->item_class = $rs_res->fields[0] ;  
            $this->link_id = $rs_res->fields[1] ;  
            $this->item_class_orig = $this->item_class;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->item_class, $this->item_class_orig);
            }
   }
//
