...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____POS_Items_Class"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____POS_Items_Class"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_POS_Items_Class_Details'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['POS_Items_Class']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['POS_Items_Class']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['POS_Items_Class']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['POS_Items_Class']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['POS_Items_Class']['sc_modal']);
