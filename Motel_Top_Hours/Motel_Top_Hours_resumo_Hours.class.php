...
class Motel_Top_Hours_resumo
{
   ...
   //---- 
   function Motel_Top_Hours_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['contr_total_geral'] == "OK")
      {
          $this->array_total_hours = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['arr_total']['hours'];
      }
      else
      {
          $this->array_total_hours = array();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['arr_total']['hours'] = $this->array_total_hours;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['contr_array_resumo'] = "OK";
   ...
   function completeMatrix()
   {
       ...
       $this->comp_sum = array(
           ...
           2 => "Count In(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")",
       );
       ...
       $this->comp_sum_lnk = array(
           ...
           2 => array('field' => "count_in", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_hours as $i_hours => $d_hours) {
           if (!in_array($i_hours, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_hours[3] ] = $d_hours[2];
               $this->comp_label[0][ $d_hours[3] ] = $d_hours[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_col'] = 2;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_sort'] = 'd';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_col']  = 0;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_hours => $l_hours) {
           if (isset($this->array_total_hours[$i_hours])) {
               $this->comp_group[$i_hours] = array();
           }
       }
               ...
               if ($this->comp_tabular)
               {
                   foreach ($tab_col as $i_tab_col => $a_col_data)
                   {
                       $new_data[] = array(
                           ...
                           'link'   => in_array($a_col_data['group'], $this->comp_links_gr) ? $this->getLabelLink($params, $i_tab_col) : '',
                       );
                   }
               }
               if (!$b_subtotal)
   ...
   function getLabelLink($param, $i_tmp = -1)
   {
       $a_links = array();
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText("Acumulative Hours Counter"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Hours"),
               'label_y'  => $this->getChartText("Count In(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_charts'] = $this->comp_chart_data;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "Motel_Top_Hours_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] = "print";
      ...
      $this->total   = new Motel_Top_Hours_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_Hours("res", $this->array_total_hours);
      ksort($this->array_total_hours);
      if ("out" == $this->tipo)
      {
         $this->total->quebra_geral();
      }
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Acumulative Hours Counter</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['doc_word'])
{
      ...
      $nm_saida->saida("  BODY { " . $css_body . " }\r\n");
       ...
       $nm_saida->saida(" .res_count_in_avg_label { text-align: right; vertical-align: top }\r\n");
       $nm_saida->saida(" .res_count_in_avg_field { text-align: right; vertical-align: top }\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Top_Hours_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Motel_Top_Hours_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Top_Hours_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'] && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] == "pdf")
      { 
          $nm_saida->saida("    <TR>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Motel_Top_Hours/Motel_Top_Hours_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Motel_Top_Hours/Motel_Top_Hours_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'Motel_Top_Hours_config_pivot.php?nome_apl=Motel_Top_Hours&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"Motel_Top_Hours.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"Motel_Top_Hours.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "Motel_Top_Hours/Motel_Top_Hours_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "Motel_Top_Hours/Motel_Top_Hours_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Top_Hours_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['num_css'] . '.css', 'a');
           @fwrite($NM_css, " .res_NM_Count__field { text-align: right }\r\n");
           @fwrite($NM_css, " .res_count_in_avg_label { text-align: right; vertical-align: top }\r\n");
           @fwrite($NM_css, " .res_count_in_avg_field { text-align: right; vertical-align: top }\r\n");
           @fclose($NM_css);
       }
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['print_all'];
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new Motel_Top_Hours_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_bot'] = false;
   }
 }
//--- 
   //----- 
   function monta_cabecalho()
   {
      ...
      { 
          $hours = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['campos_busca']['hours']; 
          $tmp_pos = strpos($hours, "##@@");
          if ($tmp_pos !== false)
          {
              $hours = substr($hours, 0, $tmp_pos);
          }
          $count_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['campos_busca']['count_in']; 
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Acumulative Hours Counter</span></td>\r\n");
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_total'] = $this->array_total_hours;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      ksort($this->array_total_hours);
      if (isset($this->array_total_hours))
      {
         foreach ($this->array_total_hours as $campo_hours => $dados_hours)
         {
            $campo_titulo = $campo_hours;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" COLSPAN=" . $span_lin_res . " >" . $valor_campo . "\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['embutida'])
      {
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['array_graf_pdf'][] = array("0" => 0, "1" => "T", "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
      $this->NM_tit_val[0] = "" .  $this->Ini->Nm_lang['lang_othr_rows'] . "";
      $this->NM_tit_val[1] = "Count In(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")";
      $this->NM_tit_graf[] = "" .  $this->Ini->Nm_lang['lang_othr_rows'] . "";
      $this->NM_tit_graf[] = "Count In(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avgt'] . ")";
      if ($this->NM_totaliz_hrz)
      {
          ...
          foreach ($this->NM_tit_val as $IND => $campo_titulo)
          {
              if ($IND == 0 || $IND == 1)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
              $ind_graf++;
          }
      }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_hours))
      {
         ...
         if (isset($this->array_total_hours))
         {
             ...
             {
                 $col++;
                 $this->conv_col[$campo_hours] = $col;
                 $this->array_hours[$col] = $dados_hours[3];
             }
      } // isset hours
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Top_Hours']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   function monta_geral()
   {
      ...
      if (isset($this->array_total_hours))
      {
         ...
         {
            $valores   = array();
            $valores[0] = $dados_hours[0];
            $valores[1] = $dados_hours[1];
            $ind = 1;
            foreach ($valores as $i => $valor_campo)
            {
   ...
   //---- 
   function adiciona_registro($avg_count_in, $quebra_hours, $quebra_hours_orig)
   {
      $quebra_hours = $quebra_hours;
      //----- Hours
      if (!isset($this->array_total_hours[$quebra_hours_orig]))
      {
         $this->array_total_hours[$quebra_hours_orig][0] = 1;
         $this->array_total_hours[$quebra_hours_orig][1] = $avg_count_in;
         $this->array_total_hours[$quebra_hours_orig][2] = $quebra_hours;
         $this->array_total_hours[$quebra_hours_orig][3] = $quebra_hours_orig;
      }
      else
      {
         $this->array_total_hours[$quebra_hours_orig][0]++;
         $this->array_total_hours[$quebra_hours_orig][1] += $avg_count_in;
      }
   }
   ...
   function finaliza_arrays()
   {
      foreach ($this->array_total_hours as $campo_hours => $dados_hours)
      {
         if ($this->array_total_hours[$campo_hours][0] != 0) {$this->array_total_hours[$campo_hours][1] /= $this->array_total_hours[$campo_hours][0];}
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->hours = $rs_res->fields[0] ;  
            $this->count_in = $rs_res->fields[1] ;  
            $this->hours_orig = $this->hours;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->count_in, $this->hours, $this->hours_orig);
            }
   }
//
