...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Top_Hours"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Top_Hours"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Top_Hours']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Motel_Top_Hours']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Top_Hours']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Motel_Top_Hours']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Motel_Top_Hours']['sc_modal']);
