  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_dbo_Motel_Room_Comments" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_dbo_Motel_Room_Comments_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_dbo_motel_room_comments_car_plate_cond = scAjaxGetFieldSelect("dbo_motel_room_comments_car_plate_cond");
    var var_dbo_motel_room_comments_car_plate = scAjaxGetFieldText("dbo_motel_room_comments_car_plate");
    var var_count_cond = scAjaxGetFieldSelect("count_cond");
    var var_count = scAjaxGetFieldText("count");
    ...
    x_grid_dbo_Motel_Room_Comments_ajax_save_filter( var_dbo_motel_room_comments_car_plate_cond, var_dbo_motel_room_comments_car_plate, var_count_cond, var_count, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_dbo_Motel_Room_Comments_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_dbo_Motel_Room_Comments_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_dbo_Motel_Room_Comments_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_dbo_Motel_Room_Comments_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_dbo_Motel_Room_Comments_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_dbo_Motel_Room_Comments_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_dbo_Motel_Room_Comments_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_dbo_Motel_Room_Comments_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_dbo_Motel_Room_Comments_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_dbo_Motel_Room_Comments_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "dbo_motel_room_comments_car_plate";
  ajax_field_list[1] = "count";

  var ajax_error_list = {
    "dbo_motel_room_comments_car_plate": {"label": "Car Plate", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "count": {"label": "Count", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
