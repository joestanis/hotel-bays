...
class Motel_Live_Data_resumo
{
   ...
   //---- 
   function Motel_Live_Data_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "Motel_Live_Data.php" ; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['where_resumo'] = "";
      $this->resumo_init();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['tot_geral'] as $ind => $val)
          {
              if ($ind > 0)
              {
          ...
          $this->array_total_start_shift = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['arr_total']['start_shift'];
      }
      else
      {
          $this->array_total_start_shift = array();
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_charts'] = $this->comp_chart_data;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "Motel_Live_Data_total.class.php"); 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] = "print";
      ...
      $this->total   = new Motel_Live_Data_total($this->Ini->sc_page);
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Live_Data_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_charts']))
   {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['charts_html'])
       {
            ...
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          ...
          $time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['campos_busca']['time_in']; 
          ...
          $time_out = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['campos_busca']['time_out']; 
          ...
          $tmp_pos = strpos($start_shift, "##@@");
          if ($tmp_pos !== false)
          {
              $start_shift = substr($start_shift, 0, $tmp_pos);
          }
      } 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['graf_total'] = $this->array_total_start_shift;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" COLSPAN=" . $span_lin_res . " >" . $valor_campo . "\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['embutida'])
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 'T', 1, '', '_blank')", "nm_graf_submit(0, 'T', 1, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Shift", "", "", "", "only_text", "text_right", "", "");
      $nm_saida->saida("          $Cod_Btn \r\n");
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['array_graf_pdf'][] = array("0" => 0, "1" => "T", "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
      ...
      if ($this->NM_totaliz_hrz)
      {
          ...
          {
              if ($IND == 1 || $IND == 3 || $IND == 2)
              {
                  $this->link_graph_tot[$ind_graf] = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 0, $IND, '', '_blank')", "nm_graf_submit(0, 0, $IND, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Shift X " . $campo_titulo . "", "", "", "", "only_text", "text_right", "", "");
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
              $ind_graf++;
          }
      }
      ...
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" " . $title_align . ">" . $campo_titulo . "\r\n");
              if ($IND == 1 || $IND == 3 || $IND == 2)
              {
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['embutida'])
                  {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 0, $IND, '', '_blank')", "nm_graf_submit(0, 0, $IND, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Shift X " . $campo_titulo . "", "", "", "", "only_text", "text_right", "", "");
      $nm_saida->saida("          $Cod_Btn \r\n");
                  }
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      ksort($this->array_total_start_shift);
      ...
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['arr_total']['start_shift'] as $campo_start_shift => $dados_start_shift)
      {
...
if ($this->start_shift =="To Go")
{ 
$this->NM_field_color["start_shift"] = "#3300FF";
}
else
{ 
$this->NM_field_color["start_shift"] = "";
}
