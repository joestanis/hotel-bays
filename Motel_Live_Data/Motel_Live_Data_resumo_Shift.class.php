...
class Motel_Live_Data_resumo
{
   ...
   function completeMatrix()
   {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Live_Data']['pivot_order_level'] = -1;
       }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Motel_Live_Data_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Motel_Live_Data_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
