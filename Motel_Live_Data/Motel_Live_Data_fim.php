...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Live_Data"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Live_Data"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Motel_Live_Data']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Motel_Live_Data']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Motel_Live_Data']['sc_modal']);
