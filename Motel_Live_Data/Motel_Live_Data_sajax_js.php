  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Motel_Live_Data" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function Motel_Live_Data_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_room_cond = scAjaxGetFieldText("room_cond");
    var var_room = scAjaxGetFieldCheckbox("room", "@?@");
    var var_prices_cond = scAjaxGetFieldText("prices_cond");
    var var_prices = scAjaxGetFieldCheckbox("prices", "@?@");
    var var_time_in_cond = scAjaxGetFieldText("time_in_cond");
    var var_time_in_dia = scAjaxGetFieldText("time_in_dia");
    var var_time_in_mes = scAjaxGetFieldText("time_in_mes");
    var var_time_in_ano = scAjaxGetFieldText("time_in_ano");
    var var_time_in_input_2_dia = scAjaxGetFieldText("time_in_input_2_dia");
    var var_time_in_input_2_mes = scAjaxGetFieldText("time_in_input_2_mes");
    var var_time_in_input_2_ano = scAjaxGetFieldText("time_in_input_2_ano");
    var var_time_in_hor = scAjaxGetFieldText("time_in_hor");
    var var_time_in_min = scAjaxGetFieldText("time_in_min");
    var var_time_in_seg = scAjaxGetFieldText("time_in_seg");
    var var_time_in_input_2_hor = scAjaxGetFieldText("time_in_input_2_hor");
    var var_time_in_input_2_min = scAjaxGetFieldText("time_in_input_2_min");
    var var_time_in_input_2_seg = scAjaxGetFieldText("time_in_input_2_seg");
    var var_time_out_cond = scAjaxGetFieldText("time_out_cond");
    var var_time_out_dia = scAjaxGetFieldText("time_out_dia");
    var var_time_out_mes = scAjaxGetFieldText("time_out_mes");
    var var_time_out_ano = scAjaxGetFieldText("time_out_ano");
    var var_time_out_input_2_dia = scAjaxGetFieldText("time_out_input_2_dia");
    var var_time_out_input_2_mes = scAjaxGetFieldText("time_out_input_2_mes");
    var var_time_out_input_2_ano = scAjaxGetFieldText("time_out_input_2_ano");
    var var_time_out_hor = scAjaxGetFieldText("time_out_hor");
    var var_time_out_min = scAjaxGetFieldText("time_out_min");
    var var_time_out_seg = scAjaxGetFieldText("time_out_seg");
    var var_time_out_input_2_hor = scAjaxGetFieldText("time_out_input_2_hor");
    var var_time_out_input_2_min = scAjaxGetFieldText("time_out_input_2_min");
    var var_time_out_input_2_seg = scAjaxGetFieldText("time_out_input_2_seg");
    var var_start_shift_cond = scAjaxGetFieldText("start_shift_cond");
    var var_start_shift = scAjaxGetFieldCheckbox("start_shift", "@?@");
    var var_nmgp_save_name = scAjaxGetFieldText("nmgp_save_name_" + pos);
    var var_NM_operador = scAjaxGetFieldRadio("NM_operador");
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_Live_Data_ajax_save_filter( var_room_cond, var_room, var_prices_cond, var_prices, var_time_in_cond, var_time_in_dia, var_time_in_mes, var_time_in_ano, var_time_in_input_2_dia, var_time_in_input_2_mes, var_time_in_input_2_ano, var_time_in_hor, var_time_in_min, var_time_in_seg, var_time_in_input_2_hor, var_time_in_input_2_min, var_time_in_input_2_seg, var_time_out_cond, var_time_out_dia, var_time_out_mes, var_time_out_ano, var_time_out_input_2_dia, var_time_out_input_2_mes, var_time_out_input_2_ano, var_time_out_hor, var_time_out_min, var_time_out_seg, var_time_out_input_2_hor, var_time_out_input_2_min, var_time_out_input_2_seg, var_start_shift_cond, var_start_shift, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, Motel_Live_Data_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function Motel_Live_Data_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function Motel_Live_Data_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_Live_Data_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, Motel_Live_Data_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function Motel_Live_Data_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    NM_cond = document.F1.time_in_cond.value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_time_in').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_time_in').style.display = 'none';
    }
    NM_cond = document.F1.time_out_cond.value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_time_out').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_time_out').style.display = 'none';
    }
    scAjaxProcOff();
    scAjaxShowDebug();
  ...
  // ---------- delete_filter
  function Motel_Live_Data_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_Live_Data_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, Motel_Live_Data_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function Motel_Live_Data_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "room";
  ajax_field_list[1] = "prices";
  ajax_field_list[2] = "time_in";
  ajax_field_list[3] = "time_out";
  ajax_field_list[4] = "start_shift";

  var ajax_error_list = {
    "room": {"label": "{lang_dbo_Motel_Live_Data_Qry_fld_Room}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "prices": {"label": "{lang_dbo_Motel_Live_Data_Qry_fld_Prices}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "time_in": {"label": "Time In", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "time_out": {"label": "Time Out", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "start_shift": {"label": "Shift", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
