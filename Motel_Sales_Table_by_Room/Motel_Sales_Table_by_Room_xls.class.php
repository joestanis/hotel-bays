...
class Motel_Sales_Table_by_Room_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $tit_doc;
   //---- 
   function Motel_Sales_Table_by_Room_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "Motel_Sales_Table_by_Room.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xls_file'] = $this->xls_f;
      }
?>
...
<HEAD>
 <TITLE>Sales Table by Room :: Excel</TITLE>
