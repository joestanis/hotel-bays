...
class Motel_Sales_Table_by_Room_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Motel_Sales_Table_by_Room_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= "_Motel_Sales_Table_by_Room";
      $this->arquivo_view = $this->arquivo . "_view.xml";
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "Motel_Sales_Table_by_Room.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<Motel_Sales_Table_by_Room";
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Sales Table by Room :: XML</TITLE>
...
<FORM name="F0" method=post action="Motel_Sales_Table_by_Room.php" style="display: none"> 
