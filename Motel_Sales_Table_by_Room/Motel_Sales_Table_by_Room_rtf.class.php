...
class Motel_Sales_Table_by_Room_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Motel_Sales_Table_by_Room_rtf()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "Motel_Sales_Table_by_Room.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_name']);
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Sales Table by Room :: RTF</TITLE>
