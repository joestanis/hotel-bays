...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Sales_Table_by_Room"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Motel_Sales_Table_by_Room"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Sales_Table_by_Room']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Motel_Sales_Table_by_Room']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Motel_Sales_Table_by_Room']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Motel_Sales_Table_by_Room']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Motel_Sales_Table_by_Room']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Motel_Sales_Table_by_Room</TITLE>
