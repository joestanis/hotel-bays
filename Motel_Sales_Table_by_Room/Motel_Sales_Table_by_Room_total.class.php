...
class Motel_Sales_Table_by_Room_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //----- 
   function Motel_Sales_Table_by_Room_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("en_us");
      if (isset($_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']))
      { 
          $this->room = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['room']; 
          $tmp_pos = strpos($this->room, "##@@");
          if ($tmp_pos !== false)
          {
              $this->room = substr($this->room, 0, $tmp_pos);
          }
          $room_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['room_input_2']; 
          $this->room_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['room_input_2']; 
          $this->time_in = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['time_in']; 
          $tmp_pos = strpos($this->time_in, "##@@");
          if ($tmp_pos !== false)
          {
              $this->time_in = substr($this->time_in, 0, $tmp_pos);
          }
          $time_in_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['time_in_input_2']; 
          $this->time_in_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['time_in_input_2']; 
          $this->prices = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['prices']; 
          $tmp_pos = strpos($this->prices, "##@@");
          if ($tmp_pos !== false)
          {
              $this->prices = substr($this->prices, 0, $tmp_pos);
          }
          $prices_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['prices_input_2']; 
          $this->prices_2 = $_SESSION['sc_session'][$this->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['prices_input_2']; 
      } 
   }
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(Prices) as sum_prices from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), sum(Prices) as sum_prices from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_total_geral'] = "OK";
   } 
