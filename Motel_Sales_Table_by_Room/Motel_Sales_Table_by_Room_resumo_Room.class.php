...
class Motel_Sales_Table_by_Room_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Motel_Sales_Table_by_Room_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz . "Motel_Sales_Table_by_Room.php"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_total_geral'] == "OK")
      {
          $this->array_total_room = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['arr_total']['room'];
      }
      else
      {
          $this->array_total_room = array();
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['arr_total']['room'] = $this->array_total_room;
   ...
   function completeMatrix()
   {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Room"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '0|1' => array(
               'title'    => $this->getChartText("Prices(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Room"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Motel_Sales_Table_by_Room_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Motel_Sales_Table_by_Room_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->tipo)
      {
         require_once($this->Ini->path_aplicacao . "Motel_Sales_Table_by_Room_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] = "print";
      ...
      $this->total   = new Motel_Sales_Table_by_Room_total($this->Ini->sc_page);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Sales_Table_by_Room_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Motel_Sales_Table_by_Room_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Sales_Table_by_Room_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Motel_Sales_Table_by_Room/Motel_Sales_Table_by_Room_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Motel_Sales_Table_by_Room/Motel_Sales_Table_by_Room_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Motel_Sales_Table_by_Room/Motel_Sales_Table_by_Room_config_graf_flash.php?nome_apl=Motel_Sales_Table_by_Room&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'Motel_Sales_Table_by_Room_config_pivot.php?nome_apl=Motel_Sales_Table_by_Room&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"Motel_Sales_Table_by_Room.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"Motel_Sales_Table_by_Room.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "Motel_Sales_Table_by_Room/Motel_Sales_Table_by_Room_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
   $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "Motel_Sales_Table_by_Room/Motel_Sales_Table_by_Room_iframe.php?nmgp_opcao=pdf_res&scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Motel_Sales_Table_by_Room_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          ...
          $time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['campos_busca']['time_in']; 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['graf_total'] = $this->array_total_room;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" COLSPAN=" . $span_lin_res . " >" . $valor_campo . "\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'])
      {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 'T', 1, '', '_blank')", "nm_graf_submit(0, 'T', 1, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Room", "", "", "", "only_text", "text_right", "", "");
      $nm_saida->saida("          $Cod_Btn \r\n");
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['array_graf_pdf'][] = array("0" => 0, "1" => "T", "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
      ...
      if ($this->NM_totaliz_hrz)
      {
          ...
          foreach ($this->NM_tit_val as $IND => $campo_titulo)
          {
              if ($IND == 0 || $IND == 1)
              {
                  $this->link_graph_tot[$ind_graf] = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 0, $IND, '', '_blank')", "nm_graf_submit(0, 0, $IND, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Room X " . $campo_titulo . "", "", "", "", "only_text", "text_right", "", "");
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
              $ind_graf++;
          }
      }
      ...
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" " . $title_align . ">" . $campo_titulo . "\r\n");
              if ($IND == 0 || $IND == 1)
              {
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['embutida'])
                  {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgraf", "nm_graf_submit(0, 0, $IND, '', '_blank')", "nm_graf_submit(0, 0, $IND, '', '_blank')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "Room X " . $campo_titulo . "", "", "", "", "only_text", "text_right", "", "");
      $nm_saida->saida("          $Cod_Btn \r\n");
                  }
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_room))
      ...
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_Sales_Table_by_Room']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            nmgp_Form_Num_Val($this->room, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
