...
$oExportPdf = new Motel_Sales_Table_by_Room_export_pdf;
$oExportPdf->exportPdf();

class Motel_Sales_Table_by_Room_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Motel_Sales_Table_by_Room_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Motel_Sales_Table_by_Room']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Motel_Sales_Table_by_Room']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Motel_Sales_Table_by_Room.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Motel_Sales_Table_by_Room']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Motel_Sales_Table_by_Room']['pdf_name'] : "Motel_Sales_Table_by_Room.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="Motel_Sales_Table_by_Room.php" target="<?php echo $NM_target; ?>" style="display: none"> 
