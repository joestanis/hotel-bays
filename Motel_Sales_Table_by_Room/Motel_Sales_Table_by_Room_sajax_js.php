  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Motel_Sales_Table_by_Room" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function Motel_Sales_Table_by_Room_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_room_cond = scAjaxGetFieldSelect("room_cond");
    var var_room = scAjaxGetFieldText("room");
    var var_room_input_2 = scAjaxGetFieldText("room_input_2");
    var var_time_in_cond = scAjaxGetFieldSelect("time_in_cond");
    ...
    var var_prices_cond = scAjaxGetFieldSelect("prices_cond");
    var var_prices = scAjaxGetFieldText("prices");
    var var_prices_input_2 = scAjaxGetFieldText("prices_input_2");
    ...
    x_Motel_Sales_Table_by_Room_ajax_save_filter( var_room_cond, var_room, var_room_input_2, var_time_in_cond, var_time_in_dia, var_time_in_mes, var_time_in_ano, var_time_in_input_2_dia, var_time_in_input_2_mes, var_time_in_input_2_ano, var_time_in_hor, var_time_in_min, var_time_in_seg, var_time_in_input_2_hor, var_time_in_input_2_min, var_time_in_input_2_seg, var_prices_cond, var_prices, var_prices_input_2, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, Motel_Sales_Table_by_Room_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function Motel_Sales_Table_by_Room_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function Motel_Sales_Table_by_Room_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_Sales_Table_by_Room_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, Motel_Sales_Table_by_Room_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function Motel_Sales_Table_by_Room_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    var indsel = document.F1.room_cond.selectedIndex;
    NM_cond = document.F1.room_cond.options[indsel].value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_room').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_room').style.display = 'none';
    }
    var indsel = document.F1.time_in_cond.selectedIndex;
    NM_cond = document.F1.time_in_cond.options[indsel].value;
    if (NM_cond == "bw")
    {
    ...
    var indsel = document.F1.prices_cond.selectedIndex;
    NM_cond = document.F1.prices_cond.options[indsel].value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_prices').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_prices').style.display = 'none';
    }
    scAjaxProcOff();
    scAjaxShowDebug();
  ...
  // ---------- delete_filter
  function Motel_Sales_Table_by_Room_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_Sales_Table_by_Room_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, Motel_Sales_Table_by_Room_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function Motel_Sales_Table_by_Room_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[2] = "prices";

  var ajax_error_list = {
    "room": {"label": "Room", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "time_in": {"label": "Time In", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "prices": {"label": "Prices", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
