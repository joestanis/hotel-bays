...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Year_Chart_Comparasion"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Year_Chart_Comparasion"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Year_Chart_Comparasion']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Year_Chart_Comparasion']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Year_Chart_Comparasion']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Year_Chart_Comparasion']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Year_Chart_Comparasion']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Year_Chart_Comparasion</TITLE>
