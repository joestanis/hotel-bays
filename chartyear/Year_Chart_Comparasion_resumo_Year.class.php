...
class Year_Chart_Comparasion_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $count_ger;
   var $sum_prices;
   var $sc_proc_quebra_time_in;
   var $count_time_in;
   var $sum_time_in_prices;
   var $sc_proc_quebra_start_shift;
   var $count_start_shift;
   var $sum_start_shift_prices;

   //---- 
   function Year_Chart_Comparasion_resumo($tipo = "")
   {
      ...
      $this->array_total_time_in     = array();
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Year_Chart_Comparasion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Year_Chart_Comparasion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Year_Chart_Comparasion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("Year_Chart_Comparasion", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['contr_total_geral'] == "OK")
      {
          $this->array_total_time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_total']['time_in'];
          $this->array_total_start_shift = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_total']['start_shift'];
      }
      else
      {
          $this->array_total_time_in = array();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_total']['time_in'] = $this->array_total_time_in;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_total']['start_shift'] = $this->array_total_start_shift;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       $this->comp_sum = array(
           ...
           2 => "Prices(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       //-----
       foreach ($this->array_total_time_in as $i_time_in => $d_time_in) {
           if (!in_array($i_time_in, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_time_in[3] ] = $d_time_in[2];
               $this->comp_label[0][ $d_time_in[3] ] = $d_time_in[2];
           }
           foreach ($this->array_total_start_shift[$i_time_in] as $i_start_shift => $d_start_shift) {
               if (!in_array($i_start_shift, $this->comp_label[1][ $d_time_in[3] ], true)) {
                   $this->comp_index[1][ $d_start_shift[3] ] = $d_start_shift[2];
                   $this->comp_label[1][ $d_time_in[3] ][ $d_start_shift[3] ] = $d_start_shift[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'time_in', 'prot' => '@aspass@'),
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_time_in => $l_time_in) {
           if (isset($this->array_total_time_in[$i_time_in])) {
               $this->comp_group[$i_time_in] = array();
           }
           foreach ($this->comp_label[1][$i_time_in] as $i_start_shift => $l_start_shift) {
               if (isset($this->array_total_start_shift[$i_time_in][$i_start_shift])) {
                   $this->comp_group[$i_time_in][$i_start_shift] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_time_in;
       }
       elseif (1 == $level) {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               'title'    => $this->getChartText("Car Records Chart Year Comparation"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Time In"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           '0|1' => array(
               'title'    => $this->getChartText("Sales Chart Year Comparation"),
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Time In"),
               'label_y'  => $this->getChartText("Prices(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")"),
               'format'   => $this->formatChartValue(1),
           ),
       );

       $aTotalGeneral = true ? $this->comp_totals_al : $this->comp_totals_a;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_charts'] = $this->comp_chart_data;
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Year_Chart_Comparasion_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Year_Chart_Comparasion_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'])
                   {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Year_Chart_Comparasion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Year_Chart_Comparasion']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Year_Chart_Comparasion']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Year_Chart_Comparasion']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "Year_Chart_Comparasion_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] = "print";
      ...
      $this->total   = new Year_Chart_Comparasion_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_Year("res", $this->array_total_time_in, $this->array_total_start_shift);
      ksort($this->array_total_time_in);
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Sales Chart by Year</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['doc_word'])
{
      ...
      $sFusionChartModule = Year_Chart_Comparasion_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = Year_Chart_Comparasion_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Year_Chart_Comparasion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Year_Chart_Comparasion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Year_Chart_Comparasion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chartyear/Year_Chart_Comparasion_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chartyear/Year_Chart_Comparasion_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form)
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chartyear/Year_Chart_Comparasion_config_graf_flash.php?nome_apl=Year_Chart_Comparasion&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&tp_apl=ger_gra&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         if (is_file("Year_Chart_Comparasion_help.txt") && !$this->grid_emb_form)
         {
            $Arq_WebHelp = file("Year_Chart_Comparasion_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_pdf'] == "S")
      {
      }
      else
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'Year_Chart_Comparasion_config_pivot.php?nome_apl=Year_Chart_Comparasion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"Year_Chart_Comparasion.php\" style=\"display: none\">\r\n");
       ...
       $nm_saida->saida("</form>\r\n");
          ...
          $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"Year_Chart_Comparasion.php\"\r\n");
          ...
          $nm_saida->saida("                    action=\"Year_Chart_Comparasion.php\" \r\n");
          $nm_saida->saida("                    target=\"_self\" style=\"display: none\"> \r\n");
          ...
          $nm_saida->saida("   {\r\n");
          $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chartyear/Year_Chart_Comparasion_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
          $nm_saida->saida("   }\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  {\r\n");
          $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chartyear/Year_Chart_Comparasion_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
          $nm_saida->saida("  }\r\n");
          $nm_saida->saida("  else\r\n");
          $nm_saida->saida("  {\r\n");
          ...
          $nm_saida->saida("    document.F3.action = \"Year_Chart_Comparasion.php\";\r\n");
          $nm_saida->saida(" } \r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Year_Chart_Comparasion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_charts']))
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
       ...
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new Year_Chart_Comparasion_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['campos_busca']['id']; 
          $tmp_pos = strpos($id, "##@@");
          if ($tmp_pos !== false)
          {
              $id = substr($id, 0, $tmp_pos);
          }
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['campos_busca']['room']; 
          $tmp_pos = strpos($room, "##@@");
          if ($tmp_pos !== false)
          {
              $room = substr($room, 0, $tmp_pos);
          }
          $prices = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['campos_busca']['prices']; 
          $tmp_pos = strpos($prices, "##@@");
          if ($tmp_pos !== false)
          {
              $prices = substr($prices, 0, $tmp_pos);
          }
          $time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['campos_busca']['time_in']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orrr']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_andd']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Sales Chart by Year</span></td>\r\n");
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_total'] = $this->array_total_time_in;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      $span_lin_res = ($this->NM_totaliz_hrz) ? 1 : 2;
      $title_align = " align=\"center\"";
      ksort($this->array_total_time_in);
      if (isset($this->array_total_time_in))
      {
         foreach ($this->array_total_time_in as $campo_time_in => $dados_time_in)
         {
            $campo_titulo = $campo_time_in;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" COLSPAN=" . $span_lin_res . " >" . $valor_campo . "\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'])
      {
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['array_graf_pdf'][] = array("0" => 0, "1" => "T", "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
      $this->NM_tit_val[0] = "" .  $this->Ini->Nm_lang['lang_othr_rows'] . "";
      $this->NM_tit_val[1] = "Prices(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")";
      $this->NM_tit_graf[] = "" .  $this->Ini->Nm_lang['lang_othr_rows'] . "";
      $this->NM_tit_graf[] = "Prices(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")";
      if ($this->NM_totaliz_hrz)
      {
          ...
          foreach ($this->NM_tit_val as $IND => $campo_titulo)
          {
              if ($IND == 0 || $IND == 1)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
              $ind_graf++;
          }
      }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      $this->array_hist_start_shift = array();
      if (isset($this->array_total_time_in))
      {
         foreach ($this->array_total_time_in as $campo_time_in => $dados_time_in)
         {
            if (isset($this->array_total_start_shift[$campo_time_in]))
            {
               foreach ($this->array_total_start_shift[$campo_time_in] as $campo_start_shift => $dados_start_shift)
               {
                  $this->array_hist_start_shift[$campo_start_shift][$campo_time_in] =  $dados_start_shift;
               } // foreach start_shift
            } // isset start_shift
         } // foreach time_in
      } // isset time_in
         if (isset($this->array_total_time_in))
         {
             ...
             {
                 $col++;
                 $this->conv_col[$campo_time_in] = $col;
                 $this->array_time_in[$col] = $dados_time_in[3];
             }
            if (isset($this->array_hist_start_shift))
            {
                ksort($this->array_hist_start_shift);
                foreach ($this->array_hist_start_shift as $campo_start_shift => $dados_start_shift)
                {
                    $lin++;
                    ksort($dados_start_shift);
                    foreach ($dados_start_shift as $cmp_coluna => $valores)
                    {
                        $this->array_start_shift[$lin] = $valores[3];
                        $valor_start_shift = $valores[2];
                        break;
                    }
                    $Parms_1 = "Start_Shift?#?@aspass@" . $this->array_start_shift[$lin] . "@aspass@";
                    $parms_cons = $Parms_1;
                    $this->resumo_campos = $dados_start_shift;
                    $this->monta_tab($campo_start_shift, 1, $lin, $col, "start_shift");
                } // foreach start_shift
            } // isset start_shift
      } // isset time_in
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   function monta_linha($lin, $ind_tot=1, $tit_tot="")
   {
      ...
      for ($i = 1; $i < $this->quant_colunas; $i++)
      {
          for ($ind = 1; $ind <= 2; $ind++)
          {
              if (!$this->NM_totaliz_hrz || $ind_tot == $ind)
              {
                  ...
                  if (isset($this->resumo_campos[$i][$ind]) && ($Nivel == " " || $Nivel == 1))
                  {
      ...
      for ($IND = 1; $IND <= 2; $IND++)
      {
           if (!$this->NM_totaliz_hrz || $ind_tot == $IND)
           {
               ...
               $img_html = "";
               if (($Nivel == 1) && ($IND == 1 || $IND == 2))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['array_graf_pdf'][] = array("0" => $lin, "1" => $Nivel, "2" => $IND);
               }
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['opcao'] != "pdf" && $Nivel != " " && !$_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['embutida'])
               {
                   $tit_cmp_quebra = str_replace("&nbsp;", "", substr($this->resumo_campos[0], 1)); 
               }
   ...
   function monta_geral()
   {
      ...
      if (isset($this->array_total_time_in))
      {
         ...
         {
            $valores   = array();
            $valores[0] = $dados_time_in[0];
            $valores[1] = $dados_time_in[1];
            $ind = 1;
            foreach ($valores as $i => $valor_campo)
            {
   ...
   //---- 
   function adiciona_registro($sum_prices, $quebra_time_in, $quebra_start_shift, $quebra_time_in_orig, $quebra_start_shift_orig)
   {
      $quebra_time_in = $quebra_time_in;
      $quebra_start_shift = $quebra_start_shift;
      //----- Time In
      if (!isset($this->array_total_time_in[$quebra_time_in_orig]))
      {
         $this->array_total_time_in[$quebra_time_in_orig][0] = 1;
         $this->array_total_time_in[$quebra_time_in_orig][1] = $sum_prices;
         $this->array_total_time_in[$quebra_time_in_orig][2] = $quebra_time_in;
         $this->array_total_time_in[$quebra_time_in_orig][3] = $quebra_time_in_orig;
      }
      else
      {
         $this->array_total_time_in[$quebra_time_in_orig][0]++;
         $this->array_total_time_in[$quebra_time_in_orig][1] += $sum_prices;
      }
      //----- Start Shift
      if (!isset($this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig]))
      {
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][0] = 1;
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][1] = $sum_prices;
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][2] = $quebra_start_shift;
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][3] = $quebra_start_shift_orig;
      }
      else
      {
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][0]++;
         $this->array_total_start_shift[$quebra_time_in_orig][$quebra_start_shift_orig][1] += $sum_prices;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT Prices, str_replace (convert(char(10),Time_In,102), '.', '-') + ' ' + convert(char(8),Time_In,20), Start_Shift from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT Prices, Time_In, Start_Shift from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT Prices, convert(char(23),Time_In,121), Start_Shift from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT Prices, Time_In, Start_Shift from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Year_Chart_Comparasion']['where_pesq']; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->prices = $rs_res->fields[0] ;  
            $this->prices =  str_replace(",", ".", $this->prices);
            $this->time_in = $rs_res->fields[1] ;  
            $this->start_shift = $rs_res->fields[2] ;  
            $this->time_in = substr($this->time_in, 0, 7);
            $this->time_in_orig = $this->time_in;
            $this->start_shift_orig = $this->start_shift;
            $conteudo_x =  $this->time_in;
            nm_conv_limpa_dado($conteudo_x, "YYYY-MM");
            if (is_numeric($conteudo_x) && $conteudo_x > 0) 
            { 
                $this->nm_data->SetaData($this->time_in, "YYYY-MM");
                $this->time_in = $this->nm_data->FormataSaida($this->Nm_date_format("DT", "mmaaaa"));
            } 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prices, $this->time_in, $this->start_shift, $this->time_in_orig,  $this->start_shift_orig);
            }
   }
//
