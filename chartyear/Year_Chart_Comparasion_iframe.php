...
$oExportPdf = new Year_Chart_Comparasion_export_pdf;
$oExportPdf->exportPdf();

class Year_Chart_Comparasion_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Year_Chart_Comparasion_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Year_Chart_Comparasion']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Year_Chart_Comparasion']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Year_Chart_Comparasion.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Year_Chart_Comparasion']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Year_Chart_Comparasion']['pdf_name'] : "Year_Chart_Comparasion.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = (!isset($aParams['nmgp_opcao']) || 'pdf_res' != $aParams['nmgp_opcao']) ? "volta_grid" : "resumo";
?>
<form name="F0" method="post" action="Year_Chart_Comparasion.php" target="<?php echo $NM_target; ?>" style="display: none"> 
