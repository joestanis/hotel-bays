  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_POS_Items_Class_Details" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate link_id_
  function do_ajax_form_dbo_POS_Items_Class_Details_validate_link_id_(iNumLinha)
  {
    var nomeCampo_link_id_ = "link_id_" + iNumLinha;
    var var_link_id_ = scAjaxGetFieldSelect(nomeCampo_link_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Items_Class_Details_validate_link_id_(var_link_id_, iNumLinha, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_validate_link_id__cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_link_id_

  function do_ajax_form_dbo_POS_Items_Class_Details_validate_link_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "link_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "link_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "link_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "link_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_link_id__cb

  // ---------- Validate items_
  function do_ajax_form_dbo_POS_Items_Class_Details_validate_items_(iNumLinha)
  {
    var nomeCampo_items_ = "items_" + iNumLinha;
    var var_items_ = scAjaxGetFieldText(nomeCampo_items_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Items_Class_Details_validate_items_(var_items_, iNumLinha, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_validate_items__cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_items_

  function do_ajax_form_dbo_POS_Items_Class_Details_validate_items__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "items_" + iLineNumber;
    }
    else
    {
      sFieldValid = "items_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "items_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "items_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_items__cb

  // ---------- Validate prices_
  function do_ajax_form_dbo_POS_Items_Class_Details_validate_prices_(iNumLinha)
  {
    var nomeCampo_prices_ = "prices_" + iNumLinha;
    var var_prices_ = scAjaxGetFieldText(nomeCampo_prices_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Items_Class_Details_validate_prices_(var_prices_, iNumLinha, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_validate_prices__cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_prices_

  function do_ajax_form_dbo_POS_Items_Class_Details_validate_prices__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "prices_" + iLineNumber;
    }
    else
    {
      sFieldValid = "prices_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "prices_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "prices_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_POS_Items_Class_Details_validate_prices__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_POS_Items_Class_Details_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_POS_Items_Class_Details_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_POS_Items_Class_Details_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_add_new_line_cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_add_new_line

  function do_ajax_form_dbo_POS_Items_Class_Details_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_dbo_POS_Items_Class_Details_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_POS_Items_Class_Details_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_POS_Items_Class_Details_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_backup_line_cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_backup_line

  function do_ajax_form_dbo_POS_Items_Class_Details_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_dbo_POS_Items_Class_Details_backup_line_cb

  function do_ajax_form_dbo_POS_Items_Class_Details_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_POS_Items_Class_Details_cancel_insert

  function do_ajax_form_dbo_POS_Items_Class_Details_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_POS_Items_Class_Details_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_POS_Items_Class_Details_cancel_update

  function do_ajax_form_dbo_POS_Items_Class_Details_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_POS_Items_Class_Details_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_POS_Items_Class_Details_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_POS_Items_Class_Details_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_table_refresh_cb);
  } //  do_ajax_form_dbo_POS_Items_Class_Details_table_refresh

  function do_ajax_form_dbo_POS_Items_Class_Details_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_POS_Items_Class_Details_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_POS_Items_Class_Details_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_link_id_ = scAjaxGetFieldSelect("link_id_" + iNumLinha);
    var var_items_ = scAjaxGetFieldText("items_" + iNumLinha);
    var var_prices_ = scAjaxGetFieldText("prices_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_POS_Items_Class_Details_submit_form(var_link_id_, var_items_, var_prices_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_submit_form_cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_submit_form

  function do_ajax_form_dbo_POS_Items_Class_Details_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("link_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("items_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("prices_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_dbo_POS_Items_Class_Details_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dbo_POS_Items_Class_Details_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("link_id_" + iNavForm);
      scAjaxHideErrorDisplay("items_" + iNavForm);
      scAjaxHideErrorDisplay("prices_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_POS_Items_Class_Details_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_dbo_POS_Items_Class_Details_navigate_form_cb);
  } // do_ajax_form_dbo_POS_Items_Class_Details_navigate_form

  function do_ajax_form_dbo_POS_Items_Class_Details_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_dbo_POS_Items_Class_Details_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "link_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "items_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "prices_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["link_id_" + iNumLinha] = {"label": "Gorup ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["items_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_POS_Items_Class_Details_fld_Items'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["prices_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_POS_Items_Class_Details_fld_Prices'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["link_id_"][iNumLinha] = "link_id_" + iNumLinha;
    ajax_field_mult["items_"][iNumLinha] = "items_" + iNumLinha;
    ajax_field_mult["prices_"][iNumLinha] = "prices_" + iNumLinha;
    ajax_field_id["link_id_" + iNumLinha] = new Array("hidden_field_label_link_id_", "hidden_field_data_link_id_" + iNumLinha);
    ajax_field_id["items_" + iNumLinha] = new Array("hidden_field_label_items_", "hidden_field_data_items_" + iNumLinha);
    ajax_field_id["prices_" + iNumLinha] = new Array("hidden_field_label_prices_", "hidden_field_data_prices_" + iNumLinha);
    ajax_error_count["link_id_" + iNumLinha] = "off";
    ajax_error_count["items_" + iNumLinha] = "off";
    ajax_error_count["prices_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["link_id_" + iNumLinha] = "off";
    ajax_read_only["items_" + iNumLinha] = "off";
    ajax_read_only["prices_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["link_id_" + iNumLinha] = "on";
    ajax_read_only["items_" + iNumLinha] = "on";
    ajax_read_only["prices_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["link_id_" + iNumLinha] = null;
    ajax_error_list["items_" + iNumLinha] = null;
    ajax_error_list["prices_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["link_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["link_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["link_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["link_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["link_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["items_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["items_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["items_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["items_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["items_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["prices_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["prices_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["prices_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["prices_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["prices_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['link_id_'])) ? $this->nmgp_cmp_readonly['link_id_'] : 'off';
?>
    scAjaxFieldRead("link_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['items_'])) ? $this->nmgp_cmp_readonly['items_'] : 'off';
?>
    scAjaxFieldRead("items_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['prices_'])) ? $this->nmgp_cmp_readonly['prices_'] : 'off';
?>
    scAjaxFieldRead("prices_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("link_id_" + iSeq, "on");
    scAjaxFieldRead("items_" + iSeq, "on");
    scAjaxFieldRead("prices_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["link_id_" + iRow] || "on" == ajax_error_count["items_" + iRow] || "on" == ajax_error_count["prices_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_link_id_" + iRow))
        document.getElementById("hidden_field_data_link_id_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_items_" + iRow))
        document.getElementById("hidden_field_data_items_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_prices_" + iRow))
        document.getElementById("hidden_field_data_prices_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["link_id_" + iRow] && "off" == ajax_error_count["items_" + iRow] && "off" == ajax_error_count["prices_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["link_id_" + iRow] = "off";
        ajax_error_count["items_" + iRow] = "off";
        ajax_error_count["prices_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_link_id_" + iRow))
        document.getElementById("hidden_field_data_link_id_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_items_" + iRow))
        document.getElementById("hidden_field_data_items_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_prices_" + iRow))
        document.getElementById("hidden_field_data_prices_" + iRow).className = sCssLine;
    }
  }
