...
$layout->blocks["top"][] = "toplinks";$page_layouts["Electricity_Chart_by_Rent_Chart_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Electricity_Chart_by_Rent_Chart",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Electricity_Chart_by_Rent_Chart_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Electricity_Chart_by_Rent_Chart_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Electricity_Chart_by_Rent_Chart"))
