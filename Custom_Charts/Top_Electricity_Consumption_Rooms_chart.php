...
include("include/Top_Electricity_Consumption_Rooms_variables.php");
...
$layout = new TLayout("chart4","Purific1BlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Top_Electricity_Consumption_Rooms_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Top_Electricity_Consumption_Rooms",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Top_Electricity_Consumption_Rooms_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Top_Electricity_Consumption_Rooms_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Top_Electricity_Consumption_Rooms"))
