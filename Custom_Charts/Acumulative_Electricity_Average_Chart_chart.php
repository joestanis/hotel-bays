...
include("include/Acumulative_Electricity_Average_Chart_variables.php");
...
$layout = new TLayout("chart4","BoldFire1","MobileFire1");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Acumulative_Electricity_Average_Chart_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Acumulative_Electricity_Average_Chart",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Acumulative_Electricity_Average_Chart_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Acumulative_Electricity_Average_Chart_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Acumulative_Electricity_Average_Chart"))
