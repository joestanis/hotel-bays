...
include("include/Acumulative_Sales_By_Month_variables.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Acumulative_Sales_By_Month_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Acumulative_Sales_By_Month",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Acumulative_Sales_By_Month_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Acumulative_Sales_By_Month_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Acumulative_Sales_By_Month"))
