...
include("include/Top_10_Rooms_Chart_variables.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Top_10_Rooms_Chart_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Top_10_Rooms_Chart",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Top_10_Rooms_Chart_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Top_10_Rooms_Chart_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Top_10_Rooms_Chart"))
