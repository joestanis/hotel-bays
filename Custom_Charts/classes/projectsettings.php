...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("Acumulative Sales By Month" == $table) 
		return "Acumulative_Sales_By_Month";
	if("Acumultive Sale by Shift" == $table) 
		return "Acumultive_Sale_by_Shift";
	if("Top Electricity Consumption Rooms" == $table) 
		return "Top_Electricity_Consumption_Rooms";
	if("Top 10 Rooms Chart" == $table) 
		return "Top_10_Rooms_Chart";
}
...
{	
	...
	if(!$shortTName)
		return false;
	if("Acumulative_Sales_By_Month" == $shortTName) 
		return "Acumulative Sales By Month";
	if("Acumultive_Sale_by_Shift" == $shortTName) 
		return "Acumultive Sale by Shift";
	if("Top_Electricity_Consumption_Rooms" == $shortTName) 
		return "Top Electricity Consumption Rooms";
	if("Top_10_Rooms_Chart" == $shortTName) 
		return "Top 10 Rooms Chart";
}
