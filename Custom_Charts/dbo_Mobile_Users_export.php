...
$layout = new TLayout("export","PurificBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "export";$page_layouts["dbo_Mobile_Users_export"] = $layout;
...
$xt->display("dbo_Mobile_Users_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=dbo_Mobile_Users.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=dbo_Mobile_Users.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=dbo_Mobile_Users.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=dbo_Mobile_Users.csv");
...
// write header
	...
	echo "</tr>";
		...
		$totalsFields[] = array('fName'=>"Id", 'totalsType'=>'', 'viewFormat'=>"");
			$totals["login"] = array("value" => 0, "numRows" => 0);
		$totalsFields[] = array('fName'=>"login", 'totalsType'=>'', 'viewFormat'=>"");
			$totals["password"] = array("value" => 0, "numRows" => 0);
		$totalsFields[] = array('fName'=>"password", 'totalsType'=>'', 'viewFormat'=>"");
			$totals["fullname"] = array("value" => 0, "numRows" => 0);
		$totalsFields[] = array('fName'=>"fullname", 'totalsType'=>'', 'viewFormat'=>"");
