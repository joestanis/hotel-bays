...
_zeroPad(d.getUTCSeconds())+'Z';},stringify:function(o,w,ind){return Native&&Y.JSON.useNativeStringify?Native.stringify(o,w,ind):_stringify(o,w,ind);},charCacheThreshold:100});},'3.6.0',{requires:['yui-base']});