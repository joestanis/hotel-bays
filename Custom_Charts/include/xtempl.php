...
class XTempl
{
	...
	function XTempl()
	{
		...
		$this->assign_function("Acumulative_Sales_By_Month_chart","xt_showchart",array("chartname"=>"Acumulative_Sales_By_Month","table"=>"Acumulative Sales By Month"));
		$this->assign_function("Acumultive_Sale_by_Shift_chart","xt_showchart",array("chartname"=>"Acumultive_Sale_by_Shift","table"=>"Acumultive Sale by Shift"));
		$this->assign_function("Top_Electricity_Consumption_Rooms_chart","xt_showchart",array("chartname"=>"Top_Electricity_Consumption_Rooms","table"=>"Top Electricity Consumption Rooms"));
		$this->assign_function("Top_10_Rooms_Chart_chart","xt_showchart",array("chartname"=>"Top_10_Rooms_Chart","table"=>"Top 10 Rooms Chart"));
