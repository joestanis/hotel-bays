...
class tDAL
{
	var $Month_Merge_Conversion;
	var $Motel_Live_Data_Qry;
	var $Motel_Electricity_Average;
	var $Motel_Top_Rooms;
	var $lstTables;
	var $Table=array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
	  $this->lstTables[]=array("name"=>"Month_Merge_Conversion","varname"=>"Month_Merge_Conversion");
	  $this->lstTables[]=array("name"=>"Motel_Live_Data_Qry","varname"=>"Motel_Live_Data_Qry");
	  $this->lstTables[]=array("name"=>"Motel_Electricity_Average","varname"=>"Motel_Electricity_Average");
	  $this->lstTables[]=array("name"=>"Motel_Top_Rooms","varname"=>"Motel_Top_Rooms");
	}
