...
if($('.pdflink').length>0)
$('.pdflink').attr("target","_blank").click(function(){var maxwidth=maxheight=0,minleft=mintop=999999;if($('[name="page"]').length>0){$('[name="page"]').each(function(ind,element){if($('table[class*="runner-c-grid"]',element).length>0)
