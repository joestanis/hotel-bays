...
$layout = new TLayout("edit2","PurificBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "details";$page_layouts["dbo_Mobile_Users_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "dbo_Mobile_Users_inline_edit.htm" : "dbo_Mobile_Users_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: dbo_Mobile_Users_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: dbo_Mobile_Users_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='dbo_Mobile_Users_view.php?".$viewlink."'\"");
