...
$layout = new TLayout("view2","PurificBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "details";$page_layouts["dbo_Mobile_Users_view"] = $layout;
...
//login - 
	...
	if($mainTableOwnerID=="login")
		$ownerIdValue=$value;
	$xt->assign("login_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='dbo_Mobile_Users_edit.php?".$editlink."'\"");
