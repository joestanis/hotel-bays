...
$layout = new TLayout("print","PurificBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "pdf";$page_layouts["dbo_Mobile_Users_print"] = $layout;
...
$arr = array();
$arr['fName'] = "login";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("login");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "password";
...
//	login - 
			$record["login_value"] = $pageObject->showDBValue("login", $data, $keylink);
			$record["login_class"] = $pageObject->fieldAlignClass("login");
//	password - 
			$record["password_value"] = $pageObject->showDBValue("password", $data, $keylink);
			$record["password_class"] = $pageObject->fieldAlignClass("password");
//	fullname - 
			$record["fullname_value"] = $pageObject->showDBValue("fullname", $data, $keylink);
			$record["fullname_class"] = $pageObject->fieldAlignClass("fullname");
			if($col<$colsonpage)
...
$xt->assign("login_fieldheadercolumn",true);
$xt->assign("login_fieldheader",true);
$xt->assign("login_fieldcolumn",true);
$xt->assign("login_fieldfootercolumn",true);
