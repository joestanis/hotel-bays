...
include("include/Acumultive_Sale_by_Shift_variables.php");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["Acumultive_Sale_by_Shift_chart"] = $layout;
...
$params = array("id" => $id,
				"tName" => $strTableName,
				"pageType" => PAGE_CHART,
				"shortTableName" => "Acumultive_Sale_by_Shift",
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Acumultive_Sale_by_Shift_search.php';return false;\"");
...
$xt->assign("showallbutton_attrs","onclick=\"window.location.href='Acumultive_Sale_by_Shift_chart.php?a=showall';\"");
$xt->assign("advsearchlink_attrs", "id=\"advButton".$id."\"");

if(!GetChartXML("Acumultive_Sale_by_Shift"))
