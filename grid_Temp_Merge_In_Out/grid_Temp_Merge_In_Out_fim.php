...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____grid_Temp_Merge_In_Out"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____grid_Temp_Merge_In_Out"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Temp_Merge_In_Out']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_Temp_Merge_In_Out']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_Temp_Merge_In_Out']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_Temp_Merge_In_Out']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_Temp_Merge_In_Out']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_Temp_Merge_In_Out</TITLE>
