<?php
   ...
   session_start();
    $Sel_Cmp = new grid_Temp_Merge_In_Out_sel_cmp(); 
    $Sel_Cmp->Sel_cmp_init();
   
class grid_Temp_Merge_In_Out_sel_cmp
{
function Sel_cmp_init()
{
   ...
   $tab_ger_campos['hours'] = "on";
   $tab_ger_campos['count_in'] = "on";
   $tab_ger_campos['count_out'] = "on";
   $tab_ger_campos['dates'] = "on";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
...
function Sel_processa_out($campos_sel)
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel'] = array();
   }
   $arr_order = $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order'];
   $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order'] = array();
   $campos_sel = explode("@?@", $campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order'][] = $campo_order;
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order']))
       {
           $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order'][] = $campo_order;
       }
   }
   ...
   if ($arr_temp === $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel'])
   {
       $alt = "N";
   }
   else
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['usr_cmp_sel'] = $arr_temp;
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - dbo.Temp_Merge_In_Out</TITLE>
...
?>
       <OPTION value="<?php echo NM_encode_input($NM_cada_field); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['field_order'] as $NM_cada_field)
   {
       if ($tab_ger_campos[$NM_cada_field] == "on")
       {
?>
       <OPTION value="<?php echo NM_encode_input($NM_cada_field); ?>" selected><?php echo $_SESSION['sc_session'][$sc_init]['grid_Temp_Merge_In_Out']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
