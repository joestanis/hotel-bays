  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_Temp_Merge_In_Out" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_Temp_Merge_In_Out_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_hours_cond = scAjaxGetFieldSelect("hours_cond");
    var var_hours = scAjaxGetFieldText("hours");
    var var_count_in_cond = scAjaxGetFieldSelect("count_in_cond");
    var var_count_in = scAjaxGetFieldText("count_in");
    var var_count_out_cond = scAjaxGetFieldSelect("count_out_cond");
    var var_count_out = scAjaxGetFieldText("count_out");
    var var_dates_cond = scAjaxGetFieldSelect("dates_cond");
    var var_dates_dia = scAjaxGetFieldText("dates_dia");
    var var_dates_mes = scAjaxGetFieldText("dates_mes");
    var var_dates_ano = scAjaxGetFieldText("dates_ano");
    var var_dates_input_2_dia = scAjaxGetFieldText("dates_input_2_dia");
    var var_dates_input_2_mes = scAjaxGetFieldText("dates_input_2_mes");
    var var_dates_input_2_ano = scAjaxGetFieldText("dates_input_2_ano");
    ...
    x_grid_Temp_Merge_In_Out_ajax_save_filter( var_hours_cond, var_hours, var_count_in_cond, var_count_in, var_count_out_cond, var_count_out, var_dates_cond, var_dates_dia, var_dates_mes, var_dates_ano, var_dates_input_2_dia, var_dates_input_2_mes, var_dates_input_2_ano, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_Temp_Merge_In_Out_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_Temp_Merge_In_Out_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_Temp_Merge_In_Out_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Temp_Merge_In_Out_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_Temp_Merge_In_Out_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_Temp_Merge_In_Out_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    var indsel = document.F1.dates_cond.selectedIndex;
    NM_cond = document.F1.dates_cond.options[indsel].value;
    formata_bi_dates(NM_cond);
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_dates').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_dates').style.display = 'none';
    }
    scAjaxProcOff();
    scAjaxShowDebug();
  ...
  // ---------- delete_filter
  function grid_Temp_Merge_In_Out_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Temp_Merge_In_Out_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_Temp_Merge_In_Out_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_Temp_Merge_In_Out_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  var var_Campo_bi = "";
  var var_Opc_bi   = "";
  function grid_Temp_Merge_In_Out_do_ajax_proc_bi(Campo_bi, Opc_bi)
  {
    scAjaxProcOn();
    var_Campo_bi = Campo_bi;
    var_Opc_bi = Opc_bi;
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = "proc_bi";
    x_grid_Temp_Merge_In_Out_ajax_proc_bi( var_Campo_bi, var_Opc_bi, var_script_case_init, var_bprocessa, grid_Temp_Merge_In_Out_do_ajax_proc_bi_cb);
  } // do_ajax_proc_bi

  function grid_Temp_Merge_In_Out_do_ajax_proc_bi_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    x = eval("formata_bi_" + var_Campo_bi);
    x(var_Opc_bi);
    scAjaxProcOff();
    scAjaxShowDebug();
  } // do_ajax_proc_bi_cb
  ...
  ajax_field_list[0] = "hours";
  ajax_field_list[1] = "count_in";
  ajax_field_list[2] = "count_out";
  ajax_field_list[3] = "dates";

  var ajax_error_list = {
    "hours": {"label": "{lang_dbo_Temp_Merge_In_Out_fld_Hours}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "count_in": {"label": "{lang_dbo_Temp_Merge_In_Out_fld_Count_In}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "count_out": {"label": "{lang_dbo_Temp_Merge_In_Out_fld_Count_Out}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "dates": {"label": "{lang_dbo_Temp_Merge_In_Out_fld_Dates}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
