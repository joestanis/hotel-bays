  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_dbo_POS_Item_Class" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_dbo_POS_Item_Class_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_item_class_cond = scAjaxGetFieldSelect("item_class_cond");
    var var_item_class = scAjaxGetFieldText("item_class");
    ...
    x_grid_dbo_POS_Item_Class_ajax_save_filter( var_item_class_cond, var_item_class, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_dbo_POS_Item_Class_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_dbo_POS_Item_Class_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_dbo_POS_Item_Class_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_dbo_POS_Item_Class_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_dbo_POS_Item_Class_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_dbo_POS_Item_Class_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_dbo_POS_Item_Class_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_dbo_POS_Item_Class_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_dbo_POS_Item_Class_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_dbo_POS_Item_Class_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "item_class";

  var ajax_error_list = {
    "item_class": {"label": "{lang_dbo_POS_Item_Class_fld_Item_Class}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
