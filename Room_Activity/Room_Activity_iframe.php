...
$oExportPdf = new Room_Activity_export_pdf;
$oExportPdf->exportPdf();

class Room_Activity_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Room_Activity_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Room_Activity']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Room_Activity']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Room_Activity.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Room_Activity']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Room_Activity']['pdf_name'] : "Room_Activity.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="Room_Activity.php" target="<?php echo $NM_target; ?>" style="display: none"> 
