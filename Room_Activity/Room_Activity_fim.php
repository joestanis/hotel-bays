...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Room_Activity"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Room_Activity"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Room_Activity']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Room_Activity']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Room_Activity']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Room_Activity']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Room_Activity']['sc_modal']);
