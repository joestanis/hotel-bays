...
class sunday_sales_rpt_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "sunday_sales_rpt.rtf";
   }
...
$_SESSION['scriptcase']['sunday_sales_rpt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_name']);
      }
...
$_SESSION['scriptcase']['sunday_sales_rpt']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
