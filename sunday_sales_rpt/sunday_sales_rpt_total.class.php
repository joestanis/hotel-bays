...
class sunday_sales_rpt_total
{
   ...
   //----- 
   function sunday_sales_rpt_total($sc_page)
   {
      $this->sc_page = $sc_page;
      $this->nm_data = new nm_data("en_us");
      if (isset($_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']))
      { 
          $this->room = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['room']; 
          $tmp_pos = strpos($this->room, "##@@");
          if ($tmp_pos !== false)
          {
              $this->room = substr($this->room, 0, $tmp_pos);
          }
          $this->time_in = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_in']; 
          $tmp_pos = strpos($this->time_in, "##@@");
          if ($tmp_pos !== false)
          {
              $this->time_in = substr($this->time_in, 0, $tmp_pos);
          }
          $time_in_2 = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_in_input_2']; 
          $this->time_in_2 = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_in_input_2']; 
          $this->time_out = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_out']; 
          $tmp_pos = strpos($this->time_out, "##@@");
          if ($tmp_pos !== false)
          {
              $this->time_out = substr($this->time_out, 0, $tmp_pos);
          }
          $time_out_2 = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_out_input_2']; 
          $this->time_out_2 = $_SESSION['sc_session'][$this->sc_page]['sunday_sales_rpt']['campos_busca']['time_out_input_2']; 
      } 
   }
   ...
   function quebra_geral()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(Prices) as sum_prices, 0 as S_grandtotal from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), sum(Prices) as sum_prices, 0 as S_grandtotal from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
