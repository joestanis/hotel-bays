...
class sunday_sales_rpt_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "sunday_sales_rpt.xls";
...
$_SESSION['scriptcase']['sunday_sales_rpt']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
...
$_SESSION['scriptcase']['sunday_sales_rpt']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['xls_file'] = $this->xls_f;
      }
?>
