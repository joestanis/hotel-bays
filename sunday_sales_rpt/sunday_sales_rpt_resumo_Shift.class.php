...
class sunday_sales_rpt_resumo
{
   ...
   //---- 
   function sunday_sales_rpt_resumo($tipo = "")
   {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['where_resumo'] = "";
      $this->resumo_init();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['tot_geral'] as $ind => $val)
          {
              if ($ind > 0)
              {
          ...
          $this->array_total_start_shift = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['arr_total']['start_shift'];
      }
      else
      {
          $this->array_total_start_shift = array();
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_sunday_sales_rpt_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_sunday_sales_rpt_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] == "pdf" || $this->Print_All)
   {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "sunday_sales_rpt_total.class.php"); 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['opcao'] = "print";
      ...
      $this->total   = new sunday_sales_rpt_total($this->Ini->sc_page);
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_sunday_sales_rpt_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['campos_busca']['room']; 
          $tmp_pos = strpos($room, "##@@");
          if ($tmp_pos !== false)
          {
              $room = substr($room, 0, $tmp_pos);
          }
          $time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['campos_busca']['time_in']; 
          ...
          $time_out = $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['campos_busca']['time_out']; 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['graf_total'] = $this->array_total_start_shift;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      ksort($this->array_total_start_shift);
      ...
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['sunday_sales_rpt']['arr_total']['start_shift'] as $campo_start_shift => $dados_start_shift)
      {
