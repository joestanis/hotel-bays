...
$old_error_handler = set_error_handler("Motel_Room_Configuration_scriptcase_error_handler");

function Motel_Room_Configuration_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Motel_Room_Configuration']['contr_erro']) && $_SESSION['scriptcase']['Motel_Room_Configuration']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Motel_Room_Configuration->contr_Motel_Room_Configuration->Apl_com_erro = true;
            if ($inicial_Motel_Room_Configuration->contr_Motel_Room_Configuration->NM_ajax_flag)
            {
                $inicial_Motel_Room_Configuration->contr_Motel_Room_Configuration->NM_ajax_info['errList']['geral_Motel_Room_Configuration'][] = $msg;
                return;
            }
            Motel_Room_Configuration_scriptcase_error_display($msg, $err_no);
        }
...
function Motel_Room_Configuration_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Motel_Room_Configuration'])  && '' != $_SESSION['scriptcase']['error_icon']['Motel_Room_Configuration'])  ? $_SESSION['scriptcase']['error_icon']['Motel_Room_Configuration']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Motel_Room_Configuration']) && '' != $_SESSION['scriptcase']['error_close']['Motel_Room_Configuration']) ? $_SESSION['scriptcase']['error_close']['Motel_Room_Configuration'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Motel_Room_Configuration']) && '' != $_SESSION['scriptcase']['error_span_title']['Motel_Room_Configuration']) ? $_SESSION['scriptcase']['error_span_title']['Motel_Room_Configuration'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Motel_Room_Configuration']) && '' != $_SESSION['scriptcase']['error_icon_title']['Motel_Room_Configuration']) ? $_SESSION['scriptcase']['error_icon_title']['Motel_Room_Configuration'] : '';
?>
