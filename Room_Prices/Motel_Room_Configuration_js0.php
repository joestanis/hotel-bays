...
{
  nm_gp_submit('<?php echo $this->Ini->link_form_dbo_Motel_Room_Groups_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert?#?N?@?NM_btn_update?#?S?@?NM_btn_delete?#?N?@?NM_btn_navega?#?N?@?"; ?>', '', '_self');
}
 NM_tp_critica(1);
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_Motel_Room_Configuration_submit_form(y, z); 
} 
<?php
}
?>
