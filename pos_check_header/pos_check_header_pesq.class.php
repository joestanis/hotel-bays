...
class pos_check_header_pesq
{
    ...
    * @access  public
    */
   function pos_check_header_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      global 
      $room_cond, $room,
             $sensor_trans_id_cond, $sensor_trans_id,
             $check_num_cond, $check_num,
      ...
      if (isset($this->NM_ajax_info['param']['sensor_trans_id_cond']))
      {
          $sensor_trans_id_cond = $this->NM_ajax_info['param']['sensor_trans_id_cond'];
      }
      if (isset($this->NM_ajax_info['param']['sensor_trans_id']))
      {
          $sensor_trans_id = $this->NM_ajax_info['param']['sensor_trans_id'];
      }
      if (isset($this->NM_ajax_info['param']['check_num_cond']))
      {
          $check_num_cond = $this->NM_ajax_info['param']['check_num_cond'];
      }
      if (isset($this->NM_ajax_info['param']['check_num']))
      {
          $check_num = $this->NM_ajax_info['param']['check_num'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . pos_check_header_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . pos_check_header_pack_protect_string($Tipo_filter[0]) . "\">.." . pos_check_header_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "dbo.POS_Check_Header.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "pos_check_header.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - dbo.POS_Check_Header</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  pos_check_header_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  pos_check_header_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  pos_check_header_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("pos_check_header_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="pos_check_header.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - dbo.POS_Check_Header</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['room']; 
          $room_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['room_cond']; 
          $sensor_trans_id = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['sensor_trans_id']; 
          $sensor_trans_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['sensor_trans_id_cond']; 
          $check_num = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['check_num']; 
          $check_num_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['check_num_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['NM_operador']; 
          ...
          if (strtoupper($sensor_trans_id_cond) != "II" && strtoupper($sensor_trans_id_cond) != "QP" && strtoupper($sensor_trans_id_cond) != "NP" && strtoupper($sensor_trans_id_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($sensor_trans_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($check_num_cond) != "II" && strtoupper($check_num_cond) != "QP" && strtoupper($check_num_cond) != "NP" && strtoupper($check_num_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($check_num, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($sensor_trans_id_cond) || empty($sensor_trans_id_cond))
      {
         $sensor_trans_id_cond = "eq";
      }
      if (!isset($check_num_cond) || empty($check_num_cond))
      {
         $check_num_cond = "eq";
      }
      ...
      if (!isset($sub_total_cond) || empty($sub_total_cond))
      {
         $sub_total_cond = "eq";
      }
      ...
      if (!isset($cash_cond) || empty($cash_cond))
      {
         $cash_cond = "eq";
      }
      if (!isset($total_change_cond) || empty($total_change_cond))
      {
         $total_change_cond = "eq";
      }
      if (!isset($discount_cond) || empty($discount_cond))
      {
         $discount_cond = "eq";
      }
      if (!isset($paid_method_cond) || empty($paid_method_cond))
      {
         $paid_method_cond = "eq";
      }
      if (!isset($close_time_cond) || empty($close_time_cond))
      {
         $close_time_cond = "eq";
      }
      ...
      if (!isset($tax1_cond) || empty($tax1_cond))
      {
         $tax1_cond = "eq";
      }
      if (!isset($tax2_cond) || empty($tax2_cond))
      {
         $tax2_cond = "eq";
      }
      if (!isset($room) || $room == "")
      ...
      if (!isset($sensor_trans_id) || $sensor_trans_id == "")
      {
          $sensor_trans_id = "";
      }
      if (isset($sensor_trans_id) && !empty($sensor_trans_id))
      {
         $tmp_pos = strpos($sensor_trans_id, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sensor_trans_id = substr($sensor_trans_id, 0, $tmp_pos);
         }
      }
      ...
      if (isset($check_num) && !empty($check_num))
      {
         $tmp_pos = strpos($check_num, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $check_num = substr($check_num, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("pos_check_header_help.txt"))
   {
...
<INPUT  type="text" id="SC_room" name="room" value="<?php echo NM_encode_input($room) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['sensor_trans_id'])) ? $this->New_label['sensor_trans_id'] : "Sensor Trans ID"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="sensor_trans_id_cond">
       <OPTION value="eq" <?php if ("eq" == $sensor_trans_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $sensor_trans_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $sensor_trans_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $sensor_trans_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['sensor_trans_id'])) ? $this->New_label['sensor_trans_id'] : "Sensor Trans ID";
 $nmgp_tab_label .= "sensor_trans_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_sensor_trans_id" name="sensor_trans_id" value="<?php echo NM_encode_input($sensor_trans_id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['check_num'])) ? $this->New_label['check_num'] : "" . $this->Ini->Nm_lang['lang_dbo_POS_Check_Header_fld_Check_Num'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="check_num_cond">
       <OPTION value="eq" <?php if ("eq" == $check_num_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $check_num_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $check_num_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $check_num_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['check_num'])) ? $this->New_label['check_num'] : "" . $this->Ini->Nm_lang['lang_dbo_POS_Check_Header_fld_Check_Num'] . "";
 $nmgp_tab_label .= "check_num?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_check_num" name="check_num" value="<?php echo NM_encode_input($check_num) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pos_check_header']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['pos_check_header']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="pos_check_header.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.sensor_trans_id.value = "";
   document.F1.check_num.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/pos_check_header";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['pos_check_header']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          if ($sensor_trans_id_cond != "in")
          {
              nm_limpa_numero($sensor_trans_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $sensor_trans_id);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
              ...
              $sensor_trans_id = implode(",", $Nm_sc_valores);
          }
          if ($check_num_cond != "in")
          {
              nm_limpa_numero($check_num, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $check_num);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
              ...
              $check_num = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($sensor_trans_id_cond)) ? $sensor_trans_id_cond : ""; 
          $NM_str_filter .= "sensor_trans_id_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($sensor_trans_id)) ? $sensor_trans_id : ""; 
          $NM_str_filter .= "sensor_trans_id#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($check_num_cond)) ? $check_num_cond : ""; 
          $NM_str_filter .= "check_num_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($check_num)) ? $check_num : ""; 
          $NM_str_filter .= "check_num#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['pos_check_header']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['room_cond'] = 'select';
      $tp_html['sensor_trans_id_cond'] = 'select';
      $tp_html['check_num_cond'] = 'select';
      $tp_html['room'] = 'text';
      $tp_html['sensor_trans_id'] = 'text';
      $tp_html['check_num'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "room_cond" || $Cada_cmp[0] == "sensor_trans_id_cond" || $Cada_cmp[0] == "check_num_cond"))
                  {
                  ...
                  if ($SC_V6 && $Cada_cmp[0] == "sensor_trans_id")
                  {
                      if (strtoupper($sensor_trans_id_cond) != "II" && strtoupper($sensor_trans_id_cond) != "QP" && strtoupper($sensor_trans_id_cond) != "NP" && strtoupper($sensor_trans_id_cond) != "IN") 
                      { 
                          nmgp_Form_Num_Val($Cada_cmp[1], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = pos_check_header_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(pos_check_header_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   function trata_campos()
   {
      global $room_cond, $room,
             $sensor_trans_id_cond, $sensor_trans_id,
             $check_num_cond, $check_num, $nmgp_tab_label;
      ...
      $sensor_trans_id_cond_salva = $sensor_trans_id_cond; 
      if (!isset($sensor_trans_id_input_2) || $sensor_trans_id_input_2 == "")
      {
          $sensor_trans_id_input_2 = $sensor_trans_id;
      }
      $check_num_cond_salva = $check_num_cond; 
      if (!isset($check_num_input_2) || $check_num_input_2 == "")
      {
          $check_num_input_2 = $check_num;
      }
      if ($room_cond != "in")
      {
          nm_limpa_numero($room, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['room'] = $room; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['room_cond'] = $room_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['sensor_trans_id'] = $sensor_trans_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['sensor_trans_id_cond'] = $sensor_trans_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['check_num'] = $check_num; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['check_num_cond'] = $check_num_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $room;
      if (strtoupper($room_cond) != "II" && strtoupper($room_cond) != "QP" && strtoupper($room_cond) != "NP" && strtoupper($room_cond) != "IN") 
      { 
      ...
      $Conteudo = $sensor_trans_id;
      if (strtoupper($sensor_trans_id_cond) != "II" && strtoupper($sensor_trans_id_cond) != "QP" && strtoupper($sensor_trans_id_cond) != "NP" && strtoupper($sensor_trans_id_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['sensor_trans_id'] = $Conteudo;
      $Conteudo = $check_num;
      if (strtoupper($check_num_cond) != "II" && strtoupper($check_num_cond) != "QP" && strtoupper($check_num_cond) != "NP" && strtoupper($check_num_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['check_num'] = $Conteudo;
      ...
      //----- $sensor_trans_id
      if (isset($sensor_trans_id) || $sensor_trans_id_cond == "nu" || $sensor_trans_id_cond == "nn")
      {
         $this->monta_condicao("Sensor_Trans_ID", $sensor_trans_id_cond, $sensor_trans_id, "", "sensor_trans_id");
      }

      //----- $check_num
      if (isset($check_num) || $check_num_cond == "nu" || $check_num_cond == "nn")
      {
         $this->monta_condicao("Check_Num", $check_num_cond, $check_num, "", "check_num");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pos_check_header']['where_pesq_ant'] = $this->comando . $this->comando_fim;
