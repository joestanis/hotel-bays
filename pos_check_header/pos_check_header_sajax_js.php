  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pos_check_header" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function pos_check_header_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_room_cond = scAjaxGetFieldSelect("room_cond");
    var var_room = scAjaxGetFieldText("room");
    var var_sensor_trans_id_cond = scAjaxGetFieldSelect("sensor_trans_id_cond");
    var var_sensor_trans_id = scAjaxGetFieldText("sensor_trans_id");
    var var_check_num_cond = scAjaxGetFieldSelect("check_num_cond");
    var var_check_num = scAjaxGetFieldText("check_num");
    ...
    x_pos_check_header_ajax_save_filter( var_room_cond, var_room, var_sensor_trans_id_cond, var_sensor_trans_id, var_check_num_cond, var_check_num, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, pos_check_header_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function pos_check_header_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function pos_check_header_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_pos_check_header_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, pos_check_header_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function pos_check_header_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function pos_check_header_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_pos_check_header_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, pos_check_header_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function pos_check_header_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "sensor_trans_id";
  ajax_field_list[2] = "check_num";

  var ajax_error_list = {
    "room": {"label": "Room", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "sensor_trans_id": {"label": "Sensor Trans ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "check_num": {"label": "{lang_dbo_POS_Check_Header_fld_Check_Num}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
