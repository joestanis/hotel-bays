...
$oExportPdf = new pos_check_header_export_pdf;
$oExportPdf->exportPdf();

class pos_check_header_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - dbo.POS_Check_Header :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("pos_check_header_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['pos_check_header']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['pos_check_header']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_pos_check_header.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['pos_check_header']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['pos_check_header']['pdf_name'] : "pos_check_header.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="pos_check_header.php" target="<?php echo $NM_target; ?>" style="display: none"> 
