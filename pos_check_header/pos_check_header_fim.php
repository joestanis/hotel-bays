...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____pos_check_header"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____pos_check_header"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pos_check_header']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['pos_check_header']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pos_check_header']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['pos_check_header']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['pos_check_header']['sc_modal']);
