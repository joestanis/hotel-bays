...
<?php
include_once("Mottech_sync_apps_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_sync_apps_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['recarga'];
}
?>
...
<?php
 include_once("Mottech_sync_apps_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_sync_apps'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_sync_apps'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_sync_apps']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_sync_apps");
 parent.scAjaxDetailHeight("Mottech_sync_apps", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
