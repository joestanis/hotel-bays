...
$oExportPdf = new Mottech_grid_sec_apps_export_pdf;
$oExportPdf->exportPdf();

class Mottech_grid_sec_apps_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Mottech_grid_sec_apps_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Mottech_grid_sec_apps']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Mottech_grid_sec_apps']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Mottech_grid_sec_apps.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Mottech_grid_sec_apps']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Mottech_grid_sec_apps']['pdf_name'] : "Mottech_grid_sec_apps.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="Mottech_grid_sec_apps.php" target="<?php echo $NM_target; ?>" style="display: none"> 
