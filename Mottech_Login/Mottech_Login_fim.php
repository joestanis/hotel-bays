...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_Login"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_Login"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   if ((isset($nmgp_parms) && $nmgp_parms == "glo_menu") || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['Mottech_Login']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['Mottech_Login']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['Mottech_Login']['db_changed'])
           {
