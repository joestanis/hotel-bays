...
<?php
include_once("Mottech_Login_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_Login_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['recarga'];
}
?>
...
<?php
 include_once("Mottech_Login_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_Login'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_Login'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<table id="main_table_form"  align="center" cellpadding="<?php echo $int_iframe_padding; ?>" cellspacing=0 class="scFormBorder"  width="220">
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['mostra_cab'] != "N"))
  {
?>
<tr><td>
     ...
     <TD style="padding: 0px">
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       ...
       <TR align="right" valign="middle">
        <TD class="scFormHeaderFont">
          <IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/grp__NM__Mottech.png" BORDER="0"/>
        </TD>
       </TR>
      </TABLE>
     </TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>;"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_login" class="sc-ui-readonly-login" style=";<?php echo $sStyleReadLab_login; ?>"><?php echo NM_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 <input class="sc-js-input scFormObjectOdd" style="width:200px;" id="id_sc_field_login" type=text name="login" value="<?php echo NM_encode_input($login) ?>"
 size=10 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: 'abcdefghijklmnopqrstuvwxyz0123456789ç .,', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_Login']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { ?>
<span id="id_read_on_pswd" class="sc-ui-readonly-pswd" style=";<?php echo $sStyleReadLab_pswd; ?>"><?php echo NM_encode_input($this->pswd); ?></span><span id="id_read_off_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_pswd; ?>"><input class="sc-js-input scFormObjectOdd" style="width:200px;" id="id_sc_field_pswd" type=password name="pswd" value="" 
 size=10 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: 'abcdefghijklmnopqrstuvwxyz0123456789ç .,', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</TD>
   <?php }?>
...
<input type=hidden name="links" value = "">
 ...
 <a href="javascript:nm_menu_link_links('Mottech_form_add_users')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<br>

 <a href="javascript:nm_menu_link_links('Mottech_retrieve_pswd')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<br>
<?php  } ?>
 </TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "nm_atualiza('alterar'); return false;", "nm_atualiza('alterar'); return false;", "sub_form_b", "", " Login ", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_Login");
 parent.scAjaxDetailHeight("Mottech_Login", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
