...
$old_error_handler = set_error_handler("Mottech_Login_scriptcase_error_handler");

function Mottech_Login_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['Mottech_Login']['contr_erro']) && $_SESSION['scriptcase']['Mottech_Login']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_Mottech_Login->contr_Mottech_Login->Apl_com_erro = true;
            if ($inicial_Mottech_Login->contr_Mottech_Login->NM_ajax_flag)
            {
                $inicial_Mottech_Login->contr_Mottech_Login->NM_ajax_info['errList']['geral_Mottech_Login'][] = $msg;
                return;
            }
            Mottech_Login_scriptcase_error_display($msg, $err_no);
        }
...
function Mottech_Login_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['Mottech_Login'])  && '' != $_SESSION['scriptcase']['error_icon']['Mottech_Login'])  ? $_SESSION['scriptcase']['error_icon']['Mottech_Login']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['Mottech_Login']) && '' != $_SESSION['scriptcase']['error_close']['Mottech_Login']) ? $_SESSION['scriptcase']['error_close']['Mottech_Login'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['Mottech_Login']) && '' != $_SESSION['scriptcase']['error_span_title']['Mottech_Login']) ? $_SESSION['scriptcase']['error_span_title']['Mottech_Login'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['Mottech_Login']) && '' != $_SESSION['scriptcase']['error_icon_title']['Mottech_Login']) ? $_SESSION['scriptcase']['error_icon_title']['Mottech_Login'] : '';
?>
