...
class Acumulative_Cars_Counter_Chart_51_to_120_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Acumulative_Cars_Counter_Chart_51_to_120_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['Acumulative_Cars_Counter_Chart_51_to_120']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['Acumulative_Cars_Counter_Chart_51_to_120']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['Acumulative_Cars_Counter_Chart_51_to_120']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("Acumulative_Cars_Counter_Chart_51_to_120", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['contr_total_geral'] == "OK")
      {
          $this->array_total_room = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['arr_total']['room'];
      }
      else
      {
          $this->array_total_room = array();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['arr_total']['room'] = $this->array_total_room;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       foreach ($this->array_total_room as $i_room => $d_room) {
           if (!in_array($i_room, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_room[3] ] = $d_room[2];
               $this->comp_label[0][ $d_room[3] ] = $d_room[2];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Acumulative_Cars_Counter_Chart_51_to_120_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Acumulative_Cars_Counter_Chart_51_to_120_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['embutida'])
                   {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Acumulative_Cars_Counter_Chart_51_to_120']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['Acumulative_Cars_Counter_Chart_51_to_120']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Acumulative_Cars_Counter_Chart_51_to_120']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['Acumulative_Cars_Counter_Chart_51_to_120']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "Acumulative_Cars_Counter_Chart_51_to_120_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] = "print";
      ...
      $this->total   = new Acumulative_Cars_Counter_Chart_51_to_120_total($this->Ini->sc_page);
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['doc_word'])
{
      ...
      $sFusionChartModule = Acumulative_Cars_Counter_Chart_51_to_120_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = Acumulative_Cars_Counter_Chart_51_to_120_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Acumulative_Cars_Counter_Chart_51_to_120_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Acumulative_Cars_Counter_Chart_51_to_120_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Acumulative_Cars_Counter_Chart_51_to_120_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css'] . '.css');
     ...
     else
     {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Acumulative_Cars_Counter_Chart_51_to_120/Acumulative_Cars_Counter_Chart_51_to_120_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on")
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Acumulative_Cars_Counter_Chart_51_to_120/Acumulative_Cars_Counter_Chart_51_to_120_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&language=en_us&conf_socor=S&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
         if (is_file("Acumulative_Cars_Counter_Chart_51_to_120_help.txt") && !$this->grid_emb_form)
         {
            $Arq_WebHelp = file("Acumulative_Cars_Counter_Chart_51_to_120_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_pdf'] == "S")
      {
      }
      else
      {
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'Acumulative_Cars_Counter_Chart_51_to_120_config_pivot.php?nome_apl=Acumulative_Cars_Counter_Chart_51_to_120&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"Acumulative_Cars_Counter_Chart_51_to_120.php\" style=\"display: none\">\r\n");
       ...
       $nm_saida->saida("</form>\r\n");
          ...
          $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"Acumulative_Cars_Counter_Chart_51_to_120.php\"\r\n");
          ...
          $nm_saida->saida("                    action=\"Acumulative_Cars_Counter_Chart_51_to_120.php\" \r\n");
          $nm_saida->saida("                    target=\"_self\" style=\"display: none\"> \r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("  {\r\n");
          $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "Acumulative_Cars_Counter_Chart_51_to_120/Acumulative_Cars_Counter_Chart_51_to_120_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
          $nm_saida->saida("  }\r\n");
          $nm_saida->saida("  else\r\n");
          $nm_saida->saida("  {\r\n");
          ...
          $nm_saida->saida("    document.F3.action = \"Acumulative_Cars_Counter_Chart_51_to_120.php\";\r\n");
          $nm_saida->saida(" } \r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Acumulative_Cars_Counter_Chart_51_to_120_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_charts']))
   {
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new Acumulative_Cars_Counter_Chart_51_to_120_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['campos_busca']['id']; 
          $tmp_pos = strpos($id, "##@@");
          if ($tmp_pos !== false)
          {
              $id = substr($id, 0, $tmp_pos);
          }
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['campos_busca']['room']; 
          $tmp_pos = strpos($room, "##@@");
          if ($tmp_pos !== false)
          {
              $room = substr($room, 0, $tmp_pos);
          }
          $time_in = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['campos_busca']['time_in']; 
          $tmp_pos = strpos($time_in, "##@@");
          if ($tmp_pos !== false)
          {
              $time_in = substr($time_in, 0, $tmp_pos);
          }
          $time_out = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['campos_busca']['time_out']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orrr']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_andd']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['cond_pesq'], 0, $trab_pos);
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_total'] = $this->array_total_room;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
      $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\" COLSPAN=" . $span_lin_res . " >" . $valor_campo . "\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['embutida'])
      {
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['array_graf_pdf'][] = array("0" => 0, "1" => "T", "2" => 1);
      $nm_saida->saida("</TD>\r\n");
      $nm_saida->saida("    </TR>\r\n");
      ...
      if ($this->NM_totaliz_hrz)
      {
          ...
          foreach ($this->NM_tit_val as $IND => $campo_titulo)
          {
              if ($IND == 0 || $IND == 1)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['array_graf_pdf'][] = array("0" => 0, "1" => 0, "2" => $IND);
              }
              $ind_graf++;
          }
      }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_room))
      {
         ...
         if (isset($this->array_total_room))
         {
             foreach ($this->array_total_room as $campo_room => $dados_room)
             {
                 ...
                 $this->array_room[$col] = $dados_room[3];
             }
      } // isset room
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   //---- 
   function adiciona_registro($sum_prices, $quebra_room, $quebra_room_orig)
   {
      ...
      if (!isset($this->array_total_room[$quebra_room_orig]))
      {
         ...
         $this->array_total_room[$quebra_room_orig][2] = $quebra_room;
         $this->array_total_room[$quebra_room_orig][3] = $quebra_room_orig;
      }
      else
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT ID, Room, str_replace (convert(char(10),Time_In,102), '.', '-') + ' ' + convert(char(8),Time_In,20), str_replace (convert(char(10),Time_Out,102), '.', '-') + ' ' + convert(char(8),Time_Out,20), Elapsed, Overtime, Prices from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT ID, Room, Time_In, Time_Out, Elapsed, Overtime, Prices from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT ID, Room, convert(char(23),Time_In,121), convert(char(23),Time_Out,121), Elapsed, Overtime, Prices from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT ID, Room, Time_In, Time_Out, Elapsed, Overtime, Prices from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['Acumulative_Cars_Counter_Chart_51_to_120']['where_pesq']; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prices, $this->room, $this->room_orig);
            }
   }
//
