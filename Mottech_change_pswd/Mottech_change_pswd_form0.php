...
<?php
include_once("Mottech_change_pswd_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_change_pswd_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['recarga'];
}
?>
...
<?php
 include_once("Mottech_change_pswd_js0.php");
?>
...
<form name="F1" method=post 
               action="Mottech_change_pswd.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_change_pswd'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_change_pswd'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>;"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_change_pswd']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_change_pswd");
 parent.scAjaxDetailHeight("Mottech_change_pswd", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
