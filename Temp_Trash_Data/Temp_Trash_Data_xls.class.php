...
class Temp_Trash_Data_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".xls";
      $this->tit_doc    = "Temp_Trash_Data.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_name']);
          $this->xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
   ...
   function NM_export_minutes()
   {
         ...
         $this->xls_dados->getActiveSheet()->setCellValue($this->calc_cell($this->xls_col) . $this->xls_row, $this->minutes);
         $this->xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_file']);
      if (is_file($this->xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['xls_file'] = $this->xls_f;
      }
?>
...
<HEAD>
 <TITLE>Temp Trash Data :: Excel</TITLE>
