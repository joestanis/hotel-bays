  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Temp_Trash_Data" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function Temp_Trash_Data_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    x_Temp_Trash_Data_ajax_save_filter( var_id_cond, var_id, var_room_cond, var_room, var_prices_cond, var_prices, var_time_in_cond, var_time_in_dia, var_time_in_mes, var_time_in_ano, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, Temp_Trash_Data_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function Temp_Trash_Data_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function Temp_Trash_Data_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Temp_Trash_Data_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, Temp_Trash_Data_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function Temp_Trash_Data_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function Temp_Trash_Data_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Temp_Trash_Data_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, Temp_Trash_Data_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function Temp_Trash_Data_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "room";
  ajax_field_list[2] = "prices";
  ajax_field_list[3] = "time_in";
