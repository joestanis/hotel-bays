...
class Temp_Trash_Data_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= "_Temp_Trash_Data";
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "Temp_Trash_Data.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_name']);
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['order_grid'];
      ...
      { 
          ...
          if ($Cada_col == "minutes" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
             if (!NM_is_utf8($SC_Label))
              {
                  $SC_Label = mb_convert_encoding($SC_Label, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      while (!$rs->EOF)
      {
         ...
         $this->time_out = $rs->fields[4] ;  
         $this->minutes = $rs->fields[5] ;  
   ...
   {
         nmgp_Form_Num_Val($this->id, "", "", "0", "S", "2", "", "N:4", "-") ; 
   ...
   //----- minutes
   function NM_export_minutes()
   {
         nmgp_Form_Num_Val($this->minutes, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if (!NM_is_utf8($this->minutes))
         {
             $this->minutes = mb_convert_encoding($this->minutes, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
          $this->minutes = str_replace('<', '&lt;', $this->minutes);
          $this->minutes = str_replace('>', '&gt;', $this->minutes);
         $this->texto_tag .= "<td>" . $this->minutes . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Temp Trash Data :: RTF</TITLE>
