...
$oExportPdf = new Temp_Trash_Data_export_pdf;
$oExportPdf->exportPdf();

class Temp_Trash_Data_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Temp_Trash_Data_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Temp_Trash_Data']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Temp_Trash_Data']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Temp_Trash_Data.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Temp_Trash_Data']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Temp_Trash_Data']['pdf_name'] : "Temp_Trash_Data.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="Temp_Trash_Data.php" target="<?php echo $NM_target; ?>" style="display: none"> 
