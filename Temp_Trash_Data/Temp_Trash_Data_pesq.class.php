...
class Temp_Trash_Data_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $id_cond, $id,
             $room_cond, $room,
             $prices_cond, $prices,
             $time_in_cond, $time_in, $time_in_dia, $time_in_mes, $time_in_ano,
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Temp_Trash_Data_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Temp_Trash_Data_pack_protect_string($Tipo_filter[0]) . "\">.." . Temp_Trash_Data_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "dbo.Temp_Trash_Qry.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "Temp_Trash_Data.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE>Temp Trash Data</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  Temp_Trash_Data_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  Temp_Trash_Data_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  Temp_Trash_Data_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("Temp_Trash_Data_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="Temp_Trash_Data.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Temp Trash Data</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['id_cond']; 
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['room']; 
          $room_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['room_cond']; 
          $prices = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['prices']; 
          $prices_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['prices_cond']; 
          $time_in_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_dia']; 
          $time_in_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_mes']; 
          $time_in_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_ano']; 
          $time_in_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['NM_operador']; 
...
<?php
   if (is_file("Temp_Trash_Data_help.txt"))
   {
...
?>
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['room'])) ? $this->New_label['room'] : "Room"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="room_cond">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_room" name="room" value="<?php echo NM_encode_input($room) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="prices_cond">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_prices" name="prices" value="<?php echo NM_encode_input($prices) ?>" size=19 alt="{datatype: 'decimal', maxLength: 19, precision: 0, decimalSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['dec_num'] ?>', thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="time_in_cond">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Temp_Trash_Data']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Temp_Trash_Data']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="Temp_Trash_Data.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_time_in_dia').bind('change', function() {sc_Temp_Trash_Data_valida_dia(this)});
    $('#SC_time_in_mes').bind('change', function() {sc_Temp_Trash_Data_valida_mes(this)});
 }
 function sc_Temp_Trash_Data_valida_dia(obj)
 {
 ...
 function sc_Temp_Trash_Data_valida_mes(obj)
 {
 ...
 function sc_Temp_Trash_Data_valida_hora(obj)
 {
 ...
 function sc_Temp_Trash_Data_valida_min(obj)
 {
 ...
 function sc_Temp_Trash_Data_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_Temp_Trash_Data_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_Temp_Trash_Data_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_Temp_Trash_Data_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_Temp_Trash_Data_valida_cic(obj);
     }
     else
     {
         return sc_Temp_Trash_Data_valida_cnpj(obj);
     }
 }
 function sc_Temp_Trash_Data_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/Temp_Trash_Data";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Temp_Trash_Data']['path_libs_php'] . "/nm_gp_limpa.php");
      }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Temp_Trash_Data']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "id_cond" || $Cada_cmp[0] == "room_cond" || $Cada_cmp[0] == "prices_cond"))
                  {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = Temp_Trash_Data_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(Temp_Trash_Data_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   function trata_campos()
   {
      global $id_cond, $id,
             $room_cond, $room,
             $prices_cond, $prices,
             $time_in_cond, $time_in, $time_in_dia, $time_in_mes, $time_in_ano, $nmgp_tab_label;
      ...
      if (!isset($time_in_input_2) || $time_in_input_2 == "")
      {
          $time_in_input_2 = $time_in;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['room'] = $room; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['room_cond'] = $room_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['prices'] = $prices; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['prices_cond'] = $prices_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_dia'] = $time_in_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_mes'] = $time_in_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_ano'] = $time_in_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_cond'] = $time_in_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $id;
      if (strtoupper($id_cond) != "II" && strtoupper($id_cond) != "QP" && strtoupper($id_cond) != "NP" && strtoupper($id_cond) != "IN") 
      { 
      ...
      if (!empty($Conteudo))
      {
          ...
          { 
              ...
              $Conteudo = $this->nm_data->FormataSaida($this->Nm_date_format("DT", "m/d/Y h:i:s a"));
          } 
      }
      $this->cmp_formatado['time_in'] = $Conteudo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_input_2'] = $Conteudo; 
      ...
      {
         $this->monta_condicao("Prices", $prices_cond, $prices, "", "prices");
      }
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']['time_in_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Temp_Trash_Data']['where_pesq_ant'] = $this->comando . $this->comando_fim;
