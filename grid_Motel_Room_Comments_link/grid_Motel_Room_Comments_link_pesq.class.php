...
class grid_Motel_Room_Comments_link_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_Motel_Room_Comments_link_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      if (isset($this->NM_ajax_info['param']['car_plate_cond']))
      {
          $car_plate_cond = $this->NM_ajax_info['param']['car_plate_cond'];
      }
      if (isset($this->NM_ajax_info['param']['car_plate']))
      {
          $car_plate = $this->NM_ajax_info['param']['car_plate'];
      }
      if (isset($this->NM_ajax_info['param']['note_cond']))
      {
          $note_cond = $this->NM_ajax_info['param']['note_cond'];
      }
      if (isset($this->NM_ajax_info['param']['note']))
      {
          $note = $this->NM_ajax_info['param']['note'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_Motel_Room_Comments_link_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_Motel_Room_Comments_link_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_Motel_Room_Comments_link_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "dbo.Motel_Room_Comments.$nome";
         if (in_array($campo_join, $Nm_numeric) && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && (strtoupper($condicao) == "II" || strtoupper($condicao) == "QP" || strtoupper($condicao) == "NP"))
         {
             $nome     = "CAST ($nome AS TEXT)";
             $nome_sum = "CAST ($nome_sum AS TEXT)";
         }
         if (substr($tp_campo, 0, 4) == "DATE" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && strtoupper($condicao) != "QP" && strtoupper($condicao) != "NP")
         {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_Motel_Room_Comments_link.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE>Motel Room Comments</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_Motel_Room_Comments_link_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_Motel_Room_Comments_link_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_Motel_Room_Comments_link_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("grid_Motel_Room_Comments_link_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="grid_Motel_Room_Comments_link.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Motel Room Comments</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $room = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['room']; 
          $room_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['room_cond']; 
          $car_plate = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['car_plate']; 
          $car_plate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['car_plate_cond']; 
          $note = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['note']; 
          $note_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['note_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['NM_operador']; 
      ...
      if (!isset($car_plate_cond) || empty($car_plate_cond))
      {
         $car_plate_cond = "eq";
      }
      if (!isset($note_cond) || empty($note_cond))
      {
         $note_cond = "eq";
      }
      ...
      if (!isset($trans_id_cond) || empty($trans_id_cond))
      {
         $trans_id_cond = "eq";
      }
      if (!isset($reason_id_cond) || empty($reason_id_cond))
      {
         $reason_id_cond = "eq";
      }
      if (!isset($trans_date_cond) || empty($trans_date_cond))
      {
         $trans_date_cond = "eq";
      }
      if (!isset($room) || $room == "")
      ...
      if (!isset($car_plate) || $car_plate == "")
      {
          $car_plate = "";
      }
      if (isset($car_plate) && !empty($car_plate))
      {
...
<?php
   if (is_file("grid_Motel_Room_Comments_link_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="room_cond">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_room" name="room" value="<?php echo NM_encode_input($room) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['car_plate'])) ? $this->New_label['car_plate'] : "Car Plate"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="car_plate_cond">
       <OPTION value="eq" <?php if ("eq" == $car_plate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $car_plate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $car_plate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $car_plate_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "car_plate?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_car_plate" name="car_plate" value="<?php echo NM_encode_input($car_plate) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['note'])) ? $this->New_label['note'] : "Note"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="note_cond">
       <OPTION value="eq" <?php if ("eq" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $note_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "note?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_note" name="note" value="<?php echo NM_encode_input($note) ?>"   size="50" maxlength="50" class="scFilterObjectOdd">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_Motel_Room_Comments_link']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_Motel_Room_Comments_link']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_Motel_Room_Comments_link.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.car_plate.value = "";
   document.F1.note.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/grid_Motel_Room_Comments_link";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments_link']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          $NM_temp  = (isset($car_plate_cond)) ? $car_plate_cond : ""; 
          $NM_str_filter .= "car_plate_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($car_plate)) ? $car_plate : ""; 
          $NM_str_filter .= "car_plate#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($note_cond)) ? $note_cond : ""; 
          $NM_str_filter .= "note_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($note)) ? $note : ""; 
          $NM_str_filter .= "note#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_patch .= "grid_Motel_Room_Comments_link/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_Motel_Room_Comments_link']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['room_cond'] = 'select';
      $tp_html['car_plate_cond'] = 'select';
      $tp_html['note_cond'] = 'select';
      $tp_html['room'] = 'text';
      $tp_html['car_plate'] = 'text';
      $tp_html['note'] = 'text';
              ...
              if (isset($tp_html[$Cada_cmp[0]]))
              {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_Motel_Room_Comments_link_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_Motel_Room_Comments_link_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   function trata_campos()
   {
      ...
      $car_plate_cond_salva = $car_plate_cond; 
      if (!isset($car_plate_input_2) || $car_plate_input_2 == "")
      {
          $car_plate_input_2 = $car_plate;
      }
      $note_cond_salva = $note_cond; 
      if (!isset($note_input_2) || $note_input_2 == "")
      {
          $note_input_2 = $note;
      }
      if ($room_cond != "in")
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['room'] = $room; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['room_cond'] = $room_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['car_plate'] = $car_plate; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['car_plate_cond'] = $car_plate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['note'] = $note; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['note_cond'] = $note_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $room;
      if (strtoupper($room_cond) != "II" && strtoupper($room_cond) != "QP" && strtoupper($room_cond) != "NP" && strtoupper($room_cond) != "IN") 
      { 
      ...
      $Conteudo = $car_plate;
      $this->cmp_formatado['car_plate'] = $Conteudo;
      $Conteudo = $note;
      $this->cmp_formatado['note'] = $Conteudo;

      //----- $room
      if (isset($room) || $room_cond == "nu" || $room_cond == "nn")
      {
         $this->monta_condicao("Room", $room_cond, $room, "", "room");
      }

      //----- $car_plate
      if (isset($car_plate) || $car_plate_cond == "nu" || $car_plate_cond == "nn")
      {
         $this->monta_condicao("Car_Plate", $car_plate_cond, $car_plate, "", "car_plate");
      }

      //----- $note
      if (isset($note) || $note_cond == "nu" || $note_cond == "nn")
      {
         $this->monta_condicao("Note", $note_cond, $note, "", "note");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Motel_Room_Comments_link']['where_pesq_ant'] = $this->comando . $this->comando_fim;
