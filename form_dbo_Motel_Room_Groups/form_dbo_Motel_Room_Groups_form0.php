<?php
class form_dbo_Motel_Room_Groups_form extends form_dbo_Motel_Room_Groups_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Work With Group Prices"); } else { echo strip_tags("Update Group Price"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['sc_redir_atualiz'] == 'ok')
{
?>
...
<?php
include_once("form_dbo_Motel_Room_Groups_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_dbo_Motel_Room_Groups_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['recarga'];
}
...
<?php
 include_once("form_dbo_Motel_Room_Groups_js0.php");
?>
...
<form name="F1" method=post 
               action="form_dbo_Motel_Room_Groups.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_dbo_Motel_Room_Groups'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_dbo_Motel_Room_Groups'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Work With Group Prices"; } else { echo "Update Group Price"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if ((!isset($this->nmgp_cmp_hidden['id_']) || $this->nmgp_cmp_hidden['id_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_id_" style="white-space:nowrap;text-align:right;<?php echo $sStyleHidden_id_; ?>" >       
<?php
      $link_img = "";
      $SC_Label = "" . $this->Ini->Nm_lang['lang_dbo_Motel_Room_Groups_fld_ID']  . "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['ordem_cmp'] == "ID")
      {
          $orderColName = "ID";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['ordem_ord'] == " desc")
          {
      ...
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-ID\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-ID\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-ID\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-ID\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'ID')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a> </TD>
   <?php }?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['name_']) && $this->nmgp_cmp_hidden['name_'] == 'off') { $sStyleHidden_name_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_name_" style="white-space:nowrap;;<?php echo $sStyleHidden_name_; ?>" > <?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Room_Groups_fld_Name'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['price_']) && $this->nmgp_cmp_hidden['price_'] == 'off') { $sStyleHidden_price_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult" id="hidden_field_label_price_" style="white-space:nowrap;;<?php echo $sStyleHidden_price_; ?>" > <?php echo $this->nm_new_label['price_'] ?> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_dbo_Motel_Room_Groups);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_dbo_Motel_Room_Groups = $this->form_vert_form_dbo_Motel_Room_Groups;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_dbo_Motel_Room_Groups))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_form_dbo_Motel_Room_Groups as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_ = $this->form_vert_form_dbo_Motel_Room_Groups[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       $sStyleHidden_id_ = '';
       ...
       $this->name_ = $this->form_vert_form_dbo_Motel_Room_Groups[$sc_seq_vert]['name_']; 
       $name_ = $this->name_; 
       $sStyleHidden_name_ = '';
       ...
       $this->price_ = $this->form_vert_form_dbo_Motel_Room_Groups[$sc_seq_vert]['price_']; 
       $price_ = $this->price_; 
       $sStyleHidden_price_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_dbo_Motel_Room_Groups_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_dbo_Motel_Room_Groups_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_dbo_Motel_Room_Groups_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_dbo_Motel_Room_Groups_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_dbo_Motel_Room_Groups_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_dbo_Motel_Room_Groups_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
 </TD>
   <?php }?>
...
<span id="id_read_on_name_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-name_<?php echo $sc_seq_vert ?>" style=";<?php echo $sStyleReadLab_name_; ?>"><?php echo NM_encode_input($this->name_); ?></span><span id="id_read_off_name_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_name_; ?>">
 ...
 size=50 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult" id="hidden_field_data_price_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_price_; ?>;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult" style=";;vertical-align: top;padding: 0px">
...
<?php } else { ?>
<span id="id_read_on_price_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-price_<?php echo $sc_seq_vert ?>" style=";<?php echo $sStyleReadLab_price_; ?>"><?php echo NM_encode_input($this->price_); ?></span><span id="id_read_off_price_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_price_; ?>">
 <input class="scFormObjectOddMult" style="text-align:left;" id="id_sc_field_price_<?php echo $sc_seq_vert ?>" type=text name="price_<?php echo $sc_seq_vert ?>" value="<?php echo NM_encode_input($price_) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_price_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_price_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_dbo_Motel_Room_Groups = $guarda_form_vert_form_dbo_Motel_Room_Groups;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_Motel_Room_Groups']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
...
?>
<script>
 parent.scAjaxDetailStatus("form_dbo_Motel_Room_Groups");
 parent.scAjaxDetailHeight("form_dbo_Motel_Room_Groups", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
