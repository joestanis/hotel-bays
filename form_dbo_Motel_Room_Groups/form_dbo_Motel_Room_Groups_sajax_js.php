  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_Motel_Room_Groups" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_dbo_Motel_Room_Groups_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Room_Groups_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_validate_id__cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_id_

  function do_ajax_form_dbo_Motel_Room_Groups_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_id__cb

  // ---------- Validate name_
  function do_ajax_form_dbo_Motel_Room_Groups_validate_name_(iNumLinha)
  {
    var nomeCampo_name_ = "name_" + iNumLinha;
    var var_name_ = scAjaxGetFieldText(nomeCampo_name_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Room_Groups_validate_name_(var_name_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_validate_name__cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_name_

  function do_ajax_form_dbo_Motel_Room_Groups_validate_name__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "name_" + iLineNumber;
    }
    else
    {
      sFieldValid = "name_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "name_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "name_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_name__cb

  // ---------- Validate price_
  function do_ajax_form_dbo_Motel_Room_Groups_validate_price_(iNumLinha)
  {
    var nomeCampo_price_ = "price_" + iNumLinha;
    var var_price_ = scAjaxGetFieldText(nomeCampo_price_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Room_Groups_validate_price_(var_price_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_validate_price__cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_price_

  function do_ajax_form_dbo_Motel_Room_Groups_validate_price__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Room_Groups_validate_price__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_Motel_Room_Groups_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_Motel_Room_Groups_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_Motel_Room_Groups_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_add_new_line_cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_add_new_line

  function do_ajax_form_dbo_Motel_Room_Groups_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_dbo_Motel_Room_Groups_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_Motel_Room_Groups_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Room_Groups_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_backup_line_cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_backup_line

  function do_ajax_form_dbo_Motel_Room_Groups_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_dbo_Motel_Room_Groups_backup_line_cb

  function do_ajax_form_dbo_Motel_Room_Groups_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_Motel_Room_Groups_cancel_insert

  function do_ajax_form_dbo_Motel_Room_Groups_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_Motel_Room_Groups_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_Motel_Room_Groups_cancel_update

  function do_ajax_form_dbo_Motel_Room_Groups_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_Motel_Room_Groups_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_Motel_Room_Groups_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_Motel_Room_Groups_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_table_refresh_cb);
  } //  do_ajax_form_dbo_Motel_Room_Groups_table_refresh

  function do_ajax_form_dbo_Motel_Room_Groups_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_Motel_Room_Groups_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_Motel_Room_Groups_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_name_ = scAjaxGetFieldText("name_" + iNumLinha);
...
?>
    x_ajax_form_dbo_Motel_Room_Groups_submit_form(var_id_, var_name_, var_price_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_submit_form_cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_submit_form

  function do_ajax_form_dbo_Motel_Room_Groups_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("name_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_dbo_Motel_Room_Groups_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dbo_Motel_Room_Groups_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_Motel_Room_Groups_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("name_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_Motel_Room_Groups_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_dbo_Motel_Room_Groups_navigate_form_cb);
  } // do_ajax_form_dbo_Motel_Room_Groups_navigate_form

  function do_ajax_form_dbo_Motel_Room_Groups_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_dbo_Motel_Room_Groups_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "name_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "price_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Room_Groups_fld_ID'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["name_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Room_Groups_fld_Name'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["name_"][iNumLinha] = "name_" + iNumLinha;
    ...
    ajax_field_id["name_" + iNumLinha] = new Array("hidden_field_label_name_", "hidden_field_data_name_" + iNumLinha);
    ...
    ajax_error_count["name_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["name_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["name_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["name_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["name_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["name_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["name_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["name_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["name_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['name_'])) ? $this->nmgp_cmp_readonly['name_'] : 'off';
?>
    scAjaxFieldRead("name_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["name_" + iRow] || "on" == ajax_error_count["price_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_name_" + iRow))
        document.getElementById("hidden_field_data_name_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["name_" + iRow] && "off" == ajax_error_count["price_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["name_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_name_" + iRow))
        document.getElementById("hidden_field_data_name_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_price_" + iRow))
