...
<?php
include_once("Mottech_form_sec_apps_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_form_sec_apps_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['recarga'];
}
?>
...
<?php
 include_once("Mottech_form_sec_apps_js0.php");
?>
...
<form name="F1" method=post 
               action="Mottech_form_sec_apps.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_form_sec_apps'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_form_sec_apps'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['mostra_cab'] != "N"))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['fast_search'][2] : "";
?> 
          ...
          <span id="quicksearchph_t">
           <input type="text" id="SC_fast_search_t" class="scFormToolbarInput" style="vertical-align: middle" name="nmgp_arg_fast_search_t" value="<?php echo NM_encode_input($OPC_dat) ?>" size="10" onChange="change_fast_t = 'CH';" alt="{watermark:'<?php echo $this->Ini->Nm_lang['lang_qk_watermark'] ?>', watermarkClass: 'scFormToolbarInputWm', maxLength: 255}">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_app_name" style="<?php echo $sStyleHidden_app_name; ?>;"><span id="id_label_app_name"><?php echo $this->nm_new_label['app_name']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['php_cmp_required']['app_name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['php_cmp_required']['app_name'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_app_name" class="sc-ui-readonly-app_name" style=";<?php echo $sStyleReadLab_app_name; ?>"><?php echo NM_encode_input($this->app_name); ?></span><span id="id_read_off_app_name" style="white-space: nowrap;<?php echo $sStyleReadInp_app_name; ?>">
 ...
 size=50 maxlength=128 alt="{datatype: 'text', maxLength: 128, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_description" class="sc-ui-readonly-description" style=";<?php echo $sStyleReadLab_description; ?>"><?php echo NM_encode_input($this->description); ?></span><span id="id_read_off_description" style="white-space: nowrap;<?php echo $sStyleReadInp_description; ?>">
 ...
 size=50 maxlength=255 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_apps']['mostra_cab'] != "N"))
  {
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_form_sec_apps");
 parent.scAjaxDetailHeight("Mottech_form_sec_apps", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
