  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_Motel_Groups_Rates" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_dbo_Motel_Groups_Rates_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Groups_Rates_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_validate_id__cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_id_

  function do_ajax_form_dbo_Motel_Groups_Rates_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_id__cb

  // ---------- Validate group_id_
  function do_ajax_form_dbo_Motel_Groups_Rates_validate_group_id_(iNumLinha)
  {
    var nomeCampo_group_id_ = "group_id_" + iNumLinha;
    var var_group_id_ = scAjaxGetFieldText(nomeCampo_group_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Groups_Rates_validate_group_id_(var_group_id_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_validate_group_id__cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_group_id_

  function do_ajax_form_dbo_Motel_Groups_Rates_validate_group_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_group_id__cb

  // ---------- Validate dayofweek_
  function do_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek_(iNumLinha)
  {
    var nomeCampo_dayofweek_ = "dayofweek_" + iNumLinha;
    var var_dayofweek_ = scAjaxGetFieldText(nomeCampo_dayofweek_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek_(var_dayofweek_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek__cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek_

  function do_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "dayofweek_" + iLineNumber;
    }
    else
    {
      sFieldValid = "dayofweek_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "dayofweek_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "dayofweek_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_dayofweek__cb

  // ---------- Validate rate_
  function do_ajax_form_dbo_Motel_Groups_Rates_validate_rate_(iNumLinha)
  {
    var nomeCampo_rate_ = "rate_" + iNumLinha;
    var var_rate_ = scAjaxGetFieldText(nomeCampo_rate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Groups_Rates_validate_rate_(var_rate_, iNumLinha, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_validate_rate__cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_rate_

  function do_ajax_form_dbo_Motel_Groups_Rates_validate_rate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "rate_" + iLineNumber;
    }
    else
    {
      sFieldValid = "rate_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rate_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rate_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_Motel_Groups_Rates_validate_rate__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_Motel_Groups_Rates_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_Motel_Groups_Rates_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_Motel_Groups_Rates_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_add_new_line_cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_add_new_line

  function do_ajax_form_dbo_Motel_Groups_Rates_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_dbo_Motel_Groups_Rates_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_Motel_Groups_Rates_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_Motel_Groups_Rates_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_backup_line_cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_backup_line

  function do_ajax_form_dbo_Motel_Groups_Rates_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_dbo_Motel_Groups_Rates_backup_line_cb

  function do_ajax_form_dbo_Motel_Groups_Rates_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_Motel_Groups_Rates_cancel_insert

  function do_ajax_form_dbo_Motel_Groups_Rates_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_Motel_Groups_Rates_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_Motel_Groups_Rates_cancel_update

  function do_ajax_form_dbo_Motel_Groups_Rates_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_Motel_Groups_Rates_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_Motel_Groups_Rates_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_Motel_Groups_Rates_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_table_refresh_cb);
  } //  do_ajax_form_dbo_Motel_Groups_Rates_table_refresh

  function do_ajax_form_dbo_Motel_Groups_Rates_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_Motel_Groups_Rates_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_Motel_Groups_Rates_submit_form(iNumLinha, indexTR)
  {
    ...
    var var_dayofweek_ = scAjaxGetFieldText("dayofweek_" + iNumLinha);
    var var_rate_ = scAjaxGetFieldText("rate_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_Motel_Groups_Rates_submit_form(var_id_, var_group_id_, var_dayofweek_, var_rate_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_submit_form_cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_submit_form

  function do_ajax_form_dbo_Motel_Groups_Rates_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("dayofweek_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rate_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_dbo_Motel_Groups_Rates_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_dbo_Motel_Groups_Rates_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_Motel_Groups_Rates_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("dayofweek_" + iNavForm);
      scAjaxHideErrorDisplay("rate_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_Motel_Groups_Rates_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_dbo_Motel_Groups_Rates_navigate_form_cb);
  } // do_ajax_form_dbo_Motel_Groups_Rates_navigate_form

  function do_ajax_form_dbo_Motel_Groups_Rates_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_dbo_Motel_Groups_Rates_navigate_form_cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "dayofweek_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rate_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Groups_Rates_fld_ID'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["group_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Groups_Rates_fld_Group_ID'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["dayofweek_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Groups_Rates_fld_DayOfWeek'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rate_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_dbo_Motel_Groups_Rates_fld_Rate'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["group_id_"][iNumLinha] = "group_id_" + iNumLinha;
    ajax_field_mult["dayofweek_"][iNumLinha] = "dayofweek_" + iNumLinha;
    ajax_field_mult["rate_"][iNumLinha] = "rate_" + iNumLinha;
    ...
    ajax_field_id["dayofweek_" + iNumLinha] = new Array("hidden_field_label_dayofweek_", "hidden_field_data_dayofweek_" + iNumLinha);
    ajax_field_id["rate_" + iNumLinha] = new Array("hidden_field_label_rate_", "hidden_field_data_rate_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["group_id_" + iNumLinha] = "off";
    ajax_error_count["dayofweek_" + iNumLinha] = "off";
    ajax_error_count["rate_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["dayofweek_" + iNumLinha] = "off";
    ajax_read_only["rate_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["dayofweek_" + iNumLinha] = "on";
    ajax_read_only["rate_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["dayofweek_" + iNumLinha] = null;
    ajax_error_list["rate_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["dayofweek_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["dayofweek_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["dayofweek_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["dayofweek_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["dayofweek_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rate_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rate_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rate_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rate_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rate_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['dayofweek_'])) ? $this->nmgp_cmp_readonly['dayofweek_'] : 'off';
?>
    scAjaxFieldRead("dayofweek_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rate_'])) ? $this->nmgp_cmp_readonly['rate_'] : 'off';
?>
    scAjaxFieldRead("rate_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("dayofweek_" + iSeq, "on");
    scAjaxFieldRead("rate_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["group_id_" + iRow] || "on" == ajax_error_count["dayofweek_" + iRow] || "on" == ajax_error_count["rate_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_dayofweek_" + iRow))
        document.getElementById("hidden_field_data_dayofweek_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_rate_" + iRow))
        document.getElementById("hidden_field_data_rate_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["group_id_" + iRow] && "off" == ajax_error_count["dayofweek_" + iRow] && "off" == ajax_error_count["rate_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["group_id_" + iRow] = "off";
        ajax_error_count["dayofweek_" + iRow] = "off";
        ajax_error_count["rate_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_dayofweek_" + iRow))
        document.getElementById("hidden_field_data_dayofweek_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_rate_" + iRow))
        document.getElementById("hidden_field_data_rate_" + iRow).className = sCssLine;
    }
  }
