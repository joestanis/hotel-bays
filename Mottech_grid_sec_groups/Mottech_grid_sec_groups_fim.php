...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_grid_sec_groups"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['Mottech_form_sec_groups'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_groups']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_groups']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_groups']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_groups']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_groups']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Mottech_grid_sec_groups</TITLE>
