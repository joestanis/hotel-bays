...
$oExportPdf = new grid_Mobile_Users_export_pdf;
$oExportPdf->exportPdf();

class grid_Mobile_Users_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_Mobile_Users_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_Mobile_Users']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_Mobile_Users']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_Mobile_Users.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_Mobile_Users']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_Mobile_Users']['pdf_name'] : "grid_Mobile_Users.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="grid_Mobile_Users.php" target="<?php echo $NM_target; ?>" style="display: none"> 
