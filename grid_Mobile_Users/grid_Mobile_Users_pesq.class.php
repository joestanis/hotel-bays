...
class grid_Mobile_Users_pesq
{
    ...
    * @access  public
    */
   function grid_Mobile_Users_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $fullname_cond, $fullname,
             $id_cond, $id,
             $login_cond, $login,
             $password_cond, $password,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['fullname_cond']))
      {
          $fullname_cond = $this->NM_ajax_info['param']['fullname_cond'];
      }
      if (isset($this->NM_ajax_info['param']['fullname']))
      {
          $fullname = $this->NM_ajax_info['param']['fullname'];
      }
      ...
      if (isset($this->NM_ajax_info['param']['login_cond']))
      {
          $login_cond = $this->NM_ajax_info['param']['login_cond'];
      }
      if (isset($this->NM_ajax_info['param']['login']))
      {
          $login = $this->NM_ajax_info['param']['login'];
      }
      if (isset($this->NM_ajax_info['param']['password_cond']))
      {
          $password_cond = $this->NM_ajax_info['param']['password_cond'];
      }
      if (isset($this->NM_ajax_info['param']['password']))
      {
          $password = $this->NM_ajax_info['param']['password'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_Mobile_Users_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_Mobile_Users_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_Mobile_Users_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "dbo.Mobile_Users.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_Mobile_Users.php";
?>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_Mobile_Users_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_Mobile_Users_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_Mobile_Users_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("grid_Mobile_Users_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="grid_Mobile_Users.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Mobile Users</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          $fullname = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['fullname']; 
          $fullname_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['fullname_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['id_cond']; 
          $login = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['login']; 
          $login_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['login_cond']; 
          $password = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['password']; 
          $password_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['password_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['NM_operador']; 
      ...
      if (!isset($fullname_cond) || empty($fullname_cond))
      {
         $fullname_cond = "eq";
      }
      ...
      if (!isset($password_cond) || empty($password_cond))
      {
         $password_cond = "eq";
      }
      ...
      {
         $tmp_pos = strpos($fullname, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fullname = substr($fullname, 0, $tmp_pos);
         }
      }
      if (!isset($id) || $id == "")
      {
      ...
      {
         $tmp_pos = strpos($password, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $password = substr($password, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_Mobile_Users_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['fullname'])) ? $this->New_label['fullname'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_fullname'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="fullname_cond">
       <OPTION value="eq" <?php if ("eq" == $fullname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $fullname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $fullname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $fullname_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fullname'])) ? $this->New_label['fullname'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_fullname'] . "";
 $nmgp_tab_label .= "fullname?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_fullname" name="fullname" value="<?php echo NM_encode_input($fullname) ?>" size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_Id'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="id_cond">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id'])) ? $this->New_label['id'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_Id'] . "";
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_login'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="login_cond">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['login'])) ? $this->New_label['login'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_login'] . "";
 $nmgp_tab_label .= "login?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_login" name="login" value="<?php echo NM_encode_input($login) ?>" size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['password'])) ? $this->New_label['password'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_password'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="password_cond">
       <OPTION value="eq" <?php if ("eq" == $password_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $password_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $password_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $password_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['password'])) ? $this->New_label['password'] : "" . $this->Ini->Nm_lang['lang_dbo_Mobile_Users_fld_password'] . "";
 $nmgp_tab_label .= "password?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_password" name="password" value="<?php echo NM_encode_input($password) ?>" size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_Mobile_Users']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_Mobile_Users']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_Mobile_Users.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/grid_Mobile_Users";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_Mobile_Users']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          $nmgp_save_name = str_replace('\\', ' ', $nmgp_save_name);
          $nmgp_save_name = str_replace('.', ' ', $nmgp_save_name);
          $NM_temp  = (isset($fullname_cond)) ? $fullname_cond : ""; 
          $NM_str_filter .= "fullname_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fullname)) ? $fullname : ""; 
          $NM_str_filter .= "fullname#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_cond)) ? $id_cond : ""; 
          $NM_str_filter .= "id_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id)) ? $id : ""; 
          $NM_str_filter .= "id#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($login_cond)) ? $login_cond : ""; 
          $NM_str_filter .= "login_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($login)) ? $login : ""; 
          $NM_str_filter .= "login#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($password_cond)) ? $password_cond : ""; 
          $NM_str_filter .= "password_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($password)) ? $password : ""; 
          $NM_str_filter .= "password#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_Mobile_Users']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['fullname_cond'] = 'select';
      $tp_html['id_cond'] = 'select';
      $tp_html['login_cond'] = 'select';
      $tp_html['password_cond'] = 'select';
      $tp_html['fullname'] = 'text';
      $tp_html['id'] = 'text';
      $tp_html['login'] = 'text';
      $tp_html['password'] = 'text';
              ...
              if (isset($tp_html[$Cada_cmp[0]]))
              {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv[] = grid_Mobile_Users_pack_protect_string(trim($v_fim[0]));
                         if (isset($Look_man[$Cada_cmp[0]][$v_fim[0]]))
                         {
                             $v_fim[0] = $v_fim[0] . "##@@" . $Look_man[$Cada_cmp[0]][$v_fim[0]];
                         }
                         $Cada_val_sv1[] = grid_Mobile_Users_pack_protect_string(trim($v_fim[0]));
                      }
                  ...
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_Mobile_Users_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $fullname_cond, $fullname,
             $id_cond, $id,
             $login_cond, $login,
             $password_cond, $password, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $fullname_cond_salva = $fullname_cond; 
      if (!isset($fullname_input_2) || $fullname_input_2 == "")
      {
          $fullname_input_2 = $fullname;
      }
      ...
      $password_cond_salva = $password_cond; 
      if (!isset($password_input_2) || $password_input_2 == "")
      {
          $password_input_2 = $password;
      }
      if ($id_cond != "in")
      {
          nm_limpa_numero($id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['fullname'] = $fullname; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['fullname_cond'] = $fullname_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['id'] = $id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['id_cond'] = $id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['login'] = $login; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['login_cond'] = $login_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['password'] = $password; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['password_cond'] = $password_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $fullname;
      $this->cmp_formatado['fullname'] = $Conteudo;
      $Conteudo = $id;
      if (strtoupper($id_cond) != "II" && strtoupper($id_cond) != "QP" && strtoupper($id_cond) != "IN") 
      { 
      ...
      $Conteudo = $password;
      $this->cmp_formatado['password'] = $Conteudo;

      //----- $fullname
      if (isset($fullname) || $fullname_cond == "nu" || $fullname_cond == "nn")
      {
         $this->monta_condicao("fullname", $fullname_cond, $fullname, "", "fullname");
      }
      ...
      //----- $login
      if (isset($login) || $login_cond == "nu" || $login_cond == "nn")
      {
         $this->monta_condicao("login", $login_cond, $login, "", "login");
      }

      //----- $password
      if (isset($password) || $password_cond == "nu" || $password_cond == "nn")
      {
         $this->monta_condicao("password", $password_cond, $password, "", "password");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['opcao']              = "pesq";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['prim_vez']           = "N";
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_Mobile_Users']['where_pesq_ant'] = $this->comando . $this->comando_fim;
