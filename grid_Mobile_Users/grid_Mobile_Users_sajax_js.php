  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_Mobile_Users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_Mobile_Users_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_fullname_cond = scAjaxGetFieldSelect("fullname_cond");
    var var_fullname = scAjaxGetFieldText("fullname");
    var var_id_cond = scAjaxGetFieldSelect("id_cond");
    var var_id = scAjaxGetFieldText("id");
    var var_login_cond = scAjaxGetFieldSelect("login_cond");
    var var_login = scAjaxGetFieldText("login");
    var var_password_cond = scAjaxGetFieldSelect("password_cond");
    ...
    x_grid_Mobile_Users_ajax_save_filter( var_fullname_cond, var_fullname, var_id_cond, var_id, var_login_cond, var_login, var_password_cond, var_password, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_Mobile_Users_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_Mobile_Users_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_Mobile_Users_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Mobile_Users_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_Mobile_Users_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_Mobile_Users_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_Mobile_Users_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_Mobile_Users_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_Mobile_Users_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_Mobile_Users_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "fullname";
  ajax_field_list[1] = "id";
  ajax_field_list[2] = "login";
  ajax_field_list[3] = "password";

  var ajax_error_list = {
    "fullname": {"label": "{lang_dbo_Mobile_Users_fld_fullname}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id": {"label": "{lang_dbo_Mobile_Users_fld_Id}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "login": {"label": "{lang_dbo_Mobile_Users_fld_login}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "password": {"label": "{lang_dbo_Mobile_Users_fld_password}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
