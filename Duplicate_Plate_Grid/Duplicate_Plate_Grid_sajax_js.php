  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Duplicate_Plate_Grid" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function Duplicate_Plate_Grid_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_car_plate_cond = scAjaxGetFieldText("car_plate_cond");
    ...
    x_Duplicate_Plate_Grid_ajax_save_filter( var_car_plate_cond, var_car_plate, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, Duplicate_Plate_Grid_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function Duplicate_Plate_Grid_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function Duplicate_Plate_Grid_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Duplicate_Plate_Grid_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, Duplicate_Plate_Grid_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function Duplicate_Plate_Grid_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function Duplicate_Plate_Grid_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Duplicate_Plate_Grid_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, Duplicate_Plate_Grid_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function Duplicate_Plate_Grid_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
