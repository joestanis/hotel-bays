...
$oExportPdf = new Duplicate_Plate_Grid_export_pdf;
$oExportPdf->exportPdf();

class Duplicate_Plate_Grid_export_pdf {
...
<head>
 ...
 function checkPDF() {
  $.get(nm_url_rand("Duplicate_Plate_Grid_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Duplicate_Plate_Grid']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Duplicate_Plate_Grid']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_Duplicate_Plate_Grid.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['Duplicate_Plate_Grid']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['Duplicate_Plate_Grid']['pdf_name'] : "Duplicate_Plate_Grid.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
<form name="F0" method="post" action="Duplicate_Plate_Grid.php" target="<?php echo $NM_target; ?>" style="display: none"> 
