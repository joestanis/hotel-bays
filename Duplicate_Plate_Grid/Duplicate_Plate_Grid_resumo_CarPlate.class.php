...
class Duplicate_Plate_Grid_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function Duplicate_Plate_Grid_resumo($tipo = "")
   {
      ...
      $this->array_total_car_plate = array();
   ...
   function monta_resumo($b_export = false)
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['where_resumo'] = "";
      $this->resumo_init();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['contr_total_geral'] == "OK")
      {
          $this->array_total_car_plate = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['arr_total']['car_plate'];
      }
      else
      {
          $this->array_total_car_plate = array();
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['arr_total']['car_plate'] = $this->array_total_car_plate;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       foreach ($this->array_total_car_plate as $i_car_plate => $d_car_plate) {
           if (!in_array($i_car_plate, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_car_plate[2] ] = $d_car_plate[1];
               $this->comp_label[0][ $d_car_plate[2] ] = $d_car_plate[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'car_plate', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_col'] = 1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_sort'] = 'd';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_col']  = 0;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_tabular'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_car_plate => $l_car_plate) {
           if (isset($this->array_total_car_plate[$i_car_plate])) {
               $this->comp_group[$i_car_plate] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_car_plate;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Car Plate"),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['pivot_charts'] = $this->comp_chart_data;
   }
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_Duplicate_Plate_Grid_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_Duplicate_Plate_Grid_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] = "print";
      ...
      $this->total   = new Duplicate_Plate_Grid_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_CarPlate("res", $this->array_total_car_plate);
      ksort($this->array_total_car_plate);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Duplicate_Plate_Grid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_Duplicate_Plate_Grid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Duplicate_Plate_Grid_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css'] . '.css');
   ...
   function monta_barra_top()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['embutida'])
      {
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "Duplicate_Plate_Grid/Duplicate_Plate_Grid_config_print.php?nm_opc=resumo&nm_cor=AM&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "");
...
{ 
       ...
       $nm_saida->saida("  tb_show('', 'Duplicate_Plate_Grid_config_pivot.php?nome_apl=Duplicate_Plate_Grid&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"Duplicate_Plate_Grid.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"Duplicate_Plate_Grid.php\"\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "Duplicate_Plate_Grid/Duplicate_Plate_Grid_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "Duplicate_Plate_Grid/Duplicate_Plate_Grid_iframe.php?scsess=" . session_id() . "&str_tmp=" . $this->Ini->path_imag_temp . "&str_prod=" . $this->Ini->path_prod . "&str_btn=" . $this->Ini->Str_btn_css . "&str_lang=" . $this->Ini->str_lang . "&str_schema=" . $this->Ini->str_schema_all . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&pbfile=" . urlencode($str_pbfile) . "&jspath=" . urlencode($this->Ini->path_js) . "&sc_apbgcol=" . urlencode($this->Ini->path_css) . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_Duplicate_Plate_Grid_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['num_css'] . '.css', 'a');
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
   ...
   function monta_cabecalho()
   {
      ...
      { 
          $car_plate = $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['campos_busca']['car_plate']; 
          $tmp_pos = strpos($car_plate, "##@@");
          if ($tmp_pos !== false)
          {
              $car_plate = substr($car_plate, 0, $tmp_pos);
          }
      } 
   ...
   function monta_titulo()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['graf_total'] = $this->array_total_car_plate;
      $nm_saida->saida(" <TR align=\"center\">\r\n");
      $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\">\r\n");
      ...
      ksort($this->array_total_car_plate);
      if (isset($this->array_total_car_plate))
      {
         foreach ($this->array_total_car_plate as $campo_car_plate => $dados_car_plate)
         {
            $campo_titulo = $campo_car_plate;
            $this->quant_colunas++;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['del_graph_col']['tot']))
      {
          $valor_campo = "&nbsp;";
      }
   ...
   {
      global $parms_cons;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['graf_linhas'] = array();
      $col = 0;
      $lin = 0;
      $this->conv_col = array();
      if (isset($this->array_total_car_plate))
      {
         ...
         if (isset($this->array_total_car_plate))
         {
             ...
             {
                 $col++;
                 $this->conv_col[$campo_car_plate] = $col;
                 $this->array_car_plate[$col] = $dados_car_plate[3];
             }
      } // isset car_plate
      if ($this->NM_export)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['arr_export'] = $this->array_export;
          return;
      }
   ...
   function monta_tab($campo, $nivel, $lin, $col, $nome_dados)
   {
      ...
      if (!isset($this->array_final[$lin][0]))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['graf_linhas'][$lin][0] = $nivel . $espacos . $valor_campo;
      }
      foreach ($this->resumo_campos as $cmp_col => $Xvalores)
      {
          ...
          foreach ($valores as $i => $valor_campo)
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['Duplicate_Plate_Grid']['graf_linhas'][$lin][$col][$ind] = $valor_campo;
   ...
   //---- 
   function adiciona_registro($quebra_car_plate, $quebra_car_plate_orig)
   {
      $quebra_car_plate = $quebra_car_plate;
      //----- Car Plate
      if (!isset($this->array_total_car_plate[$quebra_car_plate_orig]))
      {
         $this->array_total_car_plate[$quebra_car_plate_orig][0] = 1;
         $this->array_total_car_plate[$quebra_car_plate_orig][1] = $quebra_car_plate;
         $this->array_total_car_plate[$quebra_car_plate_orig][2] = $quebra_car_plate_orig;
      }
      else
      {
         $this->array_total_car_plate[$quebra_car_plate_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_order_by = " order by  Car_Plate asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->car_plate = $rs_res->fields[0] ;  
            $this->count = $rs_res->fields[1] ;  
            $this->car_plate_orig = $this->car_plate;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->car_plate, $this->car_plate_orig);
            }
   }
//
