...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Duplicate_Plate_Grid"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Duplicate_Plate_Grid"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Duplicate_Plate_Grid']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Duplicate_Plate_Grid']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Duplicate_Plate_Grid']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Duplicate_Plate_Grid']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Duplicate_Plate_Grid']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Duplicate_Plate_Grid</TITLE>
