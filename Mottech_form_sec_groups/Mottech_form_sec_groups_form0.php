...
<?php
include_once("Mottech_form_sec_groups_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_form_sec_groups_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['recarga'];
}
?>
...
<?php
 include_once("Mottech_form_sec_groups_js0.php");
?>
...
<form name="F1" method=post 
               action="Mottech_form_sec_groups.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_form_sec_groups'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_form_sec_groups'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_sec_groups']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_form_sec_groups");
 parent.scAjaxDetailHeight("Mottech_form_sec_groups", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
