...
class Mottech_form_sec_groups_erro
{
   var $Ini;
   ...
   //----- 
   function Mottech_form_sec_groups_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return Mottech_form_sec_groups_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
