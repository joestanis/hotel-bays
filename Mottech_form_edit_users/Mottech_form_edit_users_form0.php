...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Sec Users"); } else { echo strip_tags("Sec Users"); } ?></TITLE>
...
<?php
include_once("Mottech_form_edit_users_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('Mottech_form_edit_users_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['recarga'];
}
?>
...
<?php
 include_once("Mottech_form_edit_users_js0.php");
?>
...
<form name="F1" method=post 
               action="Mottech_form_edit_users.php" 
               target="_self"> 
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['Mottech_form_edit_users'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['Mottech_form_edit_users'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Sec Users"; } else { echo "Sec Users"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>;"><span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['login'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_login" class="sc-ui-readonly-login" style=";<?php echo $sStyleReadLab_login; ?>"><?php echo NM_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=32 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>;"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<span id="id_read_on_confirm_pswd" class="sc-ui-readonly-confirm_pswd" style=";<?php echo $sStyleReadLab_confirm_pswd; ?>"><?php echo NM_encode_input($this->confirm_pswd); ?></span><span id="id_read_off_confirm_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_confirm_pswd; ?>"><input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_confirm_pswd" type=password name="confirm_pswd" value="" 
 size=10 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<span id="id_read_on_name" class="sc-ui-readonly-name" style=";<?php echo $sStyleReadLab_name; ?>"><?php echo NM_encode_input($this->name); ?></span><span id="id_read_off_name" style="white-space: nowrap;<?php echo $sStyleReadInp_name; ?>">
 ...
 size=50 maxlength=64 alt="{datatype: 'text', maxLength: 64, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_email" style="<?php echo $sStyleHidden_email; ?>;"><span id="id_label_email"><?php echo $this->nm_new_label['email']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['php_cmp_required']['email'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['Lookup_active'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['Lookup_active'][] = 'N'; ?>
...
<input type=hidden name="groups" value="<?php echo NM_encode_input($this->groups_hidden) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php  $this->groups_1 = explode("@?@", $this->groups) ; ?>
...
else
{
   ...
   echo "<table><tr><td>" ; 
   echo " <span id=\"idAjaxSelect_groups\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_groups\" name=\"groups_orig\" size=7 multiple onDblClick=\"nm_add_sel('groups_orig', 'groups_dest', do_ajax_Mottech_form_edit_users_validate_groups, '');  \">" ; 
   echo "\r" ; 
   ...
   echo "<INPUT TYPE=\"image\" name=\"groups_all_right\" SRC=\"" . $this->Ini->path_img_global . "/img_move_right_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_add_all('groups_orig', 'groups_dest', do_ajax_Mottech_form_edit_users_validate_groups, '');    return false;\">";
   echo "<br />";
   echo "<INPUT TYPE=\"image\" name=\"groups_right\" SRC=\"" . $this->Ini->path_img_global . "/img_move_right.gif\" ALIGN=\"absmiddle\" onClick=\"nm_add_sel('groups_orig', 'groups_dest', do_ajax_Mottech_form_edit_users_validate_groups, '');    return false;\">";
   echo "<br />";
   echo "<INPUT TYPE=\"image\" name=\"groups_left\" SRC=\"" . $this->Ini->path_img_global . "/img_move_left.gif\" ALIGN=\"absmiddle\" onClick=\"nm_del_sel('groups_dest', 'groups_orig', do_ajax_Mottech_form_edit_users_validate_groups, '');    return false;\">";
   echo "<br />";
   echo "<INPUT TYPE=\"image\" name=\"groups_all_left\" SRC=\"" . $this->Ini->path_img_global . "/img_move_left_all.gif\" ALIGN=\"absmiddle\" onClick=\"nm_del_all('groups_dest', 'groups_orig', do_ajax_Mottech_form_edit_users_validate_groups, '');    return false;\">";
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd\" style=\";\" name=\"groups_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=7 multiple onDblClick=\"nm_del_sel('groups_dest', 'groups_orig', do_ajax_Mottech_form_edit_users_validate_groups, '');  \">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo "</td></tr></table>";
   echo " <script>document.F1.groups_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "nm_atualiza ('excluir'); return false;", "nm_atualiza ('excluir'); return false;", "sc_b_del_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['Mottech_form_edit_users']['total'] + 1)?>);</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("Mottech_form_edit_users");
 parent.scAjaxDetailHeight("Mottech_form_edit_users", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
