...
class dashboard_ini {
    ...
    function init()
    {
        ...
        $this->sc_page = (!isset($_REQUEST['script_case_init']) || empty($_REQUEST['script_case_init']))
                       ? rand(2, 1000) : $_REQUEST['script_case_init'];
        ...
        $this->nm_dt_criacao   = "20120630";
        $this->nm_hr_criacao   = "233353";
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['sc_aba_iframe']['dashboard'] = array(
            'Acumulative_Sales_by_Month',
            'Top_Electricity_Consumption_Rooms_chart',
            'Acumulative_Sales_by_Shift',
            'Acumulative_Top_10_Rooms',
        );
    } // init
...
<div style="width: 100%">
 <div class="scContainerHeader" style="height:11px; display: block; border-width:0px; "></div>
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scContainerHeaderFont"><span>Mottech Dashboard</span></td>
            <td id="lin1_col2" class="scContainerHeaderFont"><span><?php echo date($this->dateDefaultFormat()); ?></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<div id="columns">
 ...
 <ul id="column1" class="column" style="width: 49%">
  ...
  <li class="scContainerWidget widget" id="widget1">
   <div class="widget-head scContainerTitle">
    <h3 id="id-title-widget1">Acumulative Sales by Month</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Acumulative_Sales_by_Month'); ?>/Acumulative_Sales_by_Month.php?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>

  <li class="scContainerWidget widget" id="widget2">
   <div class="widget-head scContainerTitle">
    <h3 id="id-title-widget2">Top Electricity Consumption Rooms Chart</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget2" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Top_Electricity_Consumption_Rooms_chart'); ?>/Top_Electricity_Consumption_Rooms_chart.php?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
 ...
 <ul id="column2" class="column" style="width: 49%">
  ...
  <li class="scContainerWidget widget" id="widget3">
   <div class="widget-head scContainerTitle">
    <h3 id="id-title-widget3">Acumultive Sale by Shift</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget3" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Acumulative_Sales_by_Shift'); ?>/Acumulative_Sales_by_Shift.php?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>

  <li class="scContainerWidget widget" id="widget5">
   <div class="widget-head scContainerTitle">
    <h3 id="id-title-widget5">Acumulative Top 10 Rooms</h3>
   </div>
   <div class="widget-content" style="height: 400px; padding: 0px">
    <iframe id="id-iframe-widget5" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('Acumulative_Top_10_Rooms'); ?>/Acumulative_Top_10_Rooms.php?script_case_session=<?php echo session_id(); ?>"></iframe>
   </div>
  </li>
...
var widgets_indiv = { widget1: { movable: false, removable: false, collapsible: false, editable: false }, widget2: { movable: false, removable: false, collapsible: false, editable: false }, widget3: { movable: false, removable: false, collapsible: false, editable: false }, widget5: { movable: false, removable: false, collapsible: false, editable: false } };
</script>
