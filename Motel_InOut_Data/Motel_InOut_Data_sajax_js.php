  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Motel_InOut_Data" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function Motel_InOut_Data_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_date_cond = scAjaxGetFieldText("date_cond");
    var var_date_dia = scAjaxGetFieldText("date_dia");
    var var_date_mes = scAjaxGetFieldText("date_mes");
    var var_date_ano = scAjaxGetFieldText("date_ano");
    var var_date_input_2_dia = scAjaxGetFieldText("date_input_2_dia");
    var var_date_input_2_mes = scAjaxGetFieldText("date_input_2_mes");
    var var_date_input_2_ano = scAjaxGetFieldText("date_input_2_ano");
    ...
    x_Motel_InOut_Data_ajax_save_filter( var_date_cond, var_date_dia, var_date_mes, var_date_ano, var_date_input_2_dia, var_date_input_2_mes, var_date_input_2_ano, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, Motel_InOut_Data_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function Motel_InOut_Data_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function Motel_InOut_Data_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_InOut_Data_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, Motel_InOut_Data_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function Motel_InOut_Data_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    NM_cond = document.F1.date_cond.value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_date').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_date').style.display = 'none';
    }
    scAjaxProcOff();
    scAjaxShowDebug();
  ...
  // ---------- delete_filter
  function Motel_InOut_Data_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_Motel_InOut_Data_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, Motel_InOut_Data_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function Motel_InOut_Data_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  var ajax_error_list = {
    "date": {"label": "Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
