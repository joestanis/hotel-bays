...
class Motel_InOut_Data_pesq
{
    ...
    * @access  public
    */
   function Motel_InOut_Data_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $this->init();
      if (isset($this->NM_ajax_info['param']['date_cond']))
      {
          $date_cond = $this->NM_ajax_info['param']['date_cond'];
      }
      if (isset($this->NM_ajax_info['param']['date']))
      {
          $date = $this->NM_ajax_info['param']['date'];
      }
      if (isset($this->NM_ajax_info['param']['date_dia']))
      {
          $date_dia = $this->NM_ajax_info['param']['date_dia'];
      }
      if (isset($this->NM_ajax_info['param']['date_mes']))
      {
          $date_mes = $this->NM_ajax_info['param']['date_mes'];
      }
      if (isset($this->NM_ajax_info['param']['date_ano']))
      {
          $date_ano = $this->NM_ajax_info['param']['date_ano'];
      }
      if (isset($this->NM_ajax_info['param']['date_input_2_dia']))
      {
          $date_input_2_dia = $this->NM_ajax_info['param']['date_input_2_dia'];
      }
      if (isset($this->NM_ajax_info['param']['date_input_2_mes']))
      {
          $date_input_2_mes = $this->NM_ajax_info['param']['date_input_2_mes'];
      }
      if (isset($this->NM_ajax_info['param']['date_input_2_ano']))
      {
          $date_input_2_ano = $this->NM_ajax_info['param']['date_input_2_ano'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . Motel_InOut_Data_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . Motel_InOut_Data_pack_protect_string($Tipo_filter[0]) . "\">.." . Motel_InOut_Data_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "dbo.Motel_InOut_Data.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "Motel_InOut_Data.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE>Motel In Out Data</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  Motel_InOut_Data_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  Motel_InOut_Data_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  Motel_InOut_Data_do_ajax_delete_filter(pos);
 }
...
<?php
include_once("Motel_InOut_Data_sajax_js.php");
?>
<script type="text/javascript">
 $(function() {
 });
</script>
 <FORM name="F1" action="Motel_InOut_Data.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Motel In Out Data</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $date_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_dia']; 
          $date_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_mes']; 
          $date_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_ano']; 
          $date_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_dia']; 
          $date_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_mes']; 
          $date_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_ano']; 
          $date_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("Motel_InOut_Data_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['date'])) ? $this->New_label['date'] : "Date"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <INPUT type="hidden" name="date_cond" value="bw"><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?>
 </TD>
     <TD  class="scFilterFieldOdd">
...
?>
         ...
         <INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_date_mes" name="date_mes" value="<?php echo NM_encode_input($date_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.date_cond.value)">
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_date_dia" name="date_dia" value="<?php echo NM_encode_input($date_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.date_cond.value)">
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_date"  <?php echo $str_display_date; ?> class="scFilterFieldFontOdd">
         ...
         <INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_date_input_2_mes" name="date_input_2_mes" value="<?php echo NM_encode_input($date_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.date_cond.value)">
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_date_input_2_dia" name="date_input_2_dia" value="<?php echo NM_encode_input($date_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.date_cond.value)">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['Motel_InOut_Data']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['Motel_InOut_Data']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="Motel_InOut_Data.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_date_dia').bind('change', function() {sc_Motel_InOut_Data_valida_dia(this)});
    $('#SC_date_input_2_dia').bind('change', function() {sc_Motel_InOut_Data_valida_dia(this)});
    $('#SC_date_input_2_mes').bind('change', function() {sc_Motel_InOut_Data_valida_mes(this)});
    $('#SC_date_mes').bind('change', function() {sc_Motel_InOut_Data_valida_mes(this)});
 }
 function sc_Motel_InOut_Data_valida_dia(obj)
 {
 ...
 function sc_Motel_InOut_Data_valida_mes(obj)
 {
 ...
 function sc_Motel_InOut_Data_valida_hora(obj)
 {
 ...
 function sc_Motel_InOut_Data_valida_min(obj)
 {
 ...
 function sc_Motel_InOut_Data_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_Motel_InOut_Data_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_Motel_InOut_Data_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_Motel_InOut_Data_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_Motel_InOut_Data_valida_cic(obj);
     }
     else
     {
         return sc_Motel_InOut_Data_valida_cnpj(obj);
     }
 }
 function sc_Motel_InOut_Data_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Mottech/Motel_InOut_Data";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Motel_InOut_Data']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          $NM_temp  = (isset($date_cond)) ? $date_cond : ""; 
          $NM_str_filter .= "date_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_dia)) ? $date_dia : ""; 
          $NM_str_filter .= "date_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_mes)) ? $date_mes : ""; 
          $NM_str_filter .= "date_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_ano)) ? $date_ano : ""; 
          $NM_str_filter .= "date_ano#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_input_2_dia)) ? $date_input_2_dia : ""; 
          $NM_str_filter .= "date_input_2_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_input_2_mes)) ? $date_input_2_mes : ""; 
          $NM_str_filter .= "date_input_2_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($date_input_2_ano)) ? $date_input_2_ano : ""; 
          $NM_str_filter .= "date_input_2_ano#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['Motel_InOut_Data']['path_libs_php'] . "/nm_edit.php");
      }
      $sc_conv_var = array();
      $Look_man = array();
      $tp_html['date_cond'] = 'text';
      $tp_html['date_dia'] = 'text';
      $tp_html['date_mes'] = 'text';
      $tp_html['date_ano'] = 'text';
      $tp_html['date_input_2_dia'] = 'text';
      $tp_html['date_input_2_mes'] = 'text';
      $tp_html['date_input_2_ano'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              if (isset($sc_conv_var[$Cada_cmp[0]]))
              {
                  $Cada_cmp[0] = $sc_conv_var[$Cada_cmp[0]];
              }
              if (isset($tp_html[$Cada_cmp[0]]))
              {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = Motel_InOut_Data_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(Motel_InOut_Data_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $date_cond, $date, $date_dia, $date_mes, $date_ano, $date_input_2_dia, $date_input_2_mes, $date_input_2_ano, $nmgp_tab_label;
      ...
      if (!isset($date_input_2) || $date_input_2 == "")
      {
          $date_input_2 = $date;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_dia'] = $date_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_mes'] = $date_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_ano'] = $date_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_dia'] = $date_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_mes'] = $date_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2_ano'] = $date_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_cond'] = $date_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo  = "";
      $Formato   = "";
      if (!empty($date_dia))
      {
          $Conteudo .= (strlen($date_dia) == 2) ? $date_dia : "0" . $date_dia;
          $Formato  .= "DD";
      }
      if (!empty($date_mes))
      {
          $Conteudo .= (strlen($date_mes) == 2) ? $date_mes : "0" . $date_mes;
          $Formato  .= "MM";
      }
      $Conteudo .= $date_ano;
      $Formato  .= "YYYY";
      ...
      $this->cmp_formatado['date'] = $Conteudo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      if (!empty($date_input_2_dia))
      {
          $Conteudo .= (strlen($date_input_2_dia) == 2) ? $date_input_2_dia : "0" . $date_input_2_dia;
          $Formato  .= "DD";
      }
      if (!empty($date_input_2_mes))
      {
          $Conteudo .= (strlen($date_input_2_mes) == 2) ? $date_input_2_mes : "0" . $date_input_2_mes;
          $Formato  .= "MM";
      }
      $Conteudo .= $date_input_2_ano;
      $Formato  .= "YYYY";
      if (!empty($Conteudo))
      {
          if (is_numeric($Conteudo) && $Conteudo > 0) 
      ...
      $this->cmp_formatado['date_Input_2'] = $Conteudo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2'] = $Conteudo; 

      //----- $date
      $nm_tp_dado = "DT";
      $nm_format_db = "mm/dd/yyyy";
      $condicao = strtoupper($date_cond);
      $array_date = array();
      $array_date2 = array();
      $nm_psq_dt1 = $date_dia . $date_mes . $date_ano . $date_hor . $date_min . $date_seg;
      $nm_psq_dt_inf  = ("" == $date_ano) ? "YYYY" : "$date_ano";
      $nm_psq_dt_inf .= "-";
      $nm_psq_dt_inf .= ("" == $date_mes) ? "MM" : "$date_mes";
      $nm_psq_dt_inf .= "-";
      $nm_psq_dt_inf .= ("" == $date_dia) ? "DD"   : "$date_dia";
      $nm_psq_dt_inf .= " ";
      $nm_psq_dt_inf .= ("" == $date_hor) ? "HH" : "$date_hor";
      $nm_psq_dt_inf .= ":";
      $nm_psq_dt_inf .= ("" == $date_min) ? "II" : "$date_min";
      $nm_psq_dt_inf .= ":";
      $nm_psq_dt_inf .= ("" == $date_seg) ? "SS" : "$date_seg";
      nm_conv_form_data_hora($nm_psq_dt_inf, "AAAA-MM-DD HH:II:SS", $nm_format_db);
      $array_date["dia"] = ("" == $date_dia) ? "__"   : "$date_dia";
      $array_date["mes"] = ("" == $date_mes) ? "__"   : "$date_mes";
      $array_date["ano"] = ("" == $date_ano) ? "____" : "$date_ano";
      $array_date["hor"] = ("" == $date_hor) ? "__" : "$date_hor";
      $array_date["min"] = ("" == $date_min) ? "__" : "$date_min";
      $array_date["seg"] = ("" == $date_seg) ? "__" : "$date_seg";
      $this->NM_data_qp = $array_date;
      $nm_dt_compl = $array_date["ano"] . "-" . $array_date["mes"] . "-" . $array_date["dia"] . " " . $array_date["hor"] . ":" . $array_date["min"] . ":" . $array_date["seg"];
      nm_conv_form_data_hora($nm_dt_compl, "AAAA-MM-DD HH:II:SS", $nm_format_db);
//
      if ($condicao == "BW")
      {
          $array_date2["dia"] = ("" == $date_input_2_dia) ? "__"   : "$date_input_2_dia";
          $array_date2["mes"] = ("" == $date_input_2_mes) ? "__"   : "$date_input_2_mes";
          $array_date2["ano"] = ("" == $date_input_2_ano) ? "____" : "$date_input_2_ano";
          $array_date2["hor"] = ("" == $date_input_2_hor) ? "__" : "$date_input_2_hor";
          $array_date2["min"] = ("" == $date_input_2_min) ? "__" : "$date_input_2_min";
          $array_date2["seg"] = ("" == $date_input_2_seg) ? "__" : "$date_input_2_seg";
          $this->data_menor($array_date);
          $nm_dt_compl = $array_date["ano"] . "-" . $array_date["mes"] . "-" . $array_date["dia"] . " " . $array_date["hor"] . ":" . $array_date["min"] . ":" . $array_date["seg"];
          nm_conv_form_data_hora($nm_dt_compl, "AAAA-MM-DD HH:II:SS", $nm_format_db);
          $this->data_maior($array_date2);
          $nm_dt_compl_2 = $array_date2["ano"] . "-" . $array_date2["mes"] . "-" . $array_date2["dia"] . " " . $array_date2["hor"] . ":" . $array_date2["min"] . ":" . $array_date2["seg"];
      ...
      {
          $this->monta_condicao("date", $condicao, trim($nm_dt_compl), trim($nm_dt_compl_2), "date", $nm_tp_dado);
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']['date_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['where_pesq_ant'] = $this->comando . $this->comando_fim;
