...
class Motel_InOut_Data_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo   .= ".rtf";
      $this->tit_doc    = "Motel_InOut_Data.rtf";
   }
...
$_SESSION['scriptcase']['Motel_InOut_Data']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_name']);
      }
...
$_SESSION['scriptcase']['Motel_InOut_Data']['contr_erro'] = 'off'; 
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['Motel_InOut_Data']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE>Motel In Out Data :: RTF</TITLE>
