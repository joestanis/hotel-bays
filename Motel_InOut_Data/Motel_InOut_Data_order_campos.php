<?php
   ...
   session_start();
    $Ord_Cmp = new Motel_InOut_Data_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class Motel_InOut_Data_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   {
       $tab_def_campos['sc_field_0'] = "[1] + N' - ' + [2]";
       $tab_converte["[1] + N' - ' + [2]"]   = "sc_field_0";
   }
   ...
   {
       $tab_def_campos['sc_field_1'] = "[3] + N' - ' + [4]";
       $tab_converte["[3] + N' - ' + [4]"]   = "sc_field_1";
   }
   ...
   {
       $tab_def_campos['sc_field_2'] = "[5] + N' - ' + [6]";
       $tab_converte["[5] + N' - ' + [6]"]   = "sc_field_2";
   }
   ...
   {
       $tab_def_campos['sc_field_3'] = "[6] + N' - ' + [7]";
       $tab_converte["[6] + N' - ' + [7]"]   = "sc_field_3";
   }
   ...
   {
       $tab_def_campos['sc_field_4'] = "[7] + N' - ' + [8]";
       $tab_converte["[7] + N' - ' + [8]"]   = "sc_field_4";
   }
   ...
   {
       $tab_def_campos['sc_field_5'] = "[9] + N' - ' + [10]";
       $tab_converte["[9] + N' - ' + [10]"]   = "sc_field_5";
   }
   ...
   {
       $tab_def_campos['sc_field_6'] = "[10] + N' - ' + [11]";
       $tab_converte["[10] + N' - ' + [11]"]   = "sc_field_6";
   }
   ...
   {
       $tab_def_campos['sc_field_7'] = "[11] + N' - ' + [12]";
       $tab_converte["[11] + N' - ' + [12]"]   = "sc_field_7";
   }
   ...
   {
       $tab_def_campos['sc_field_8'] = "[13] + N' - ' + [14]";
       $tab_converte["[13] + N' - ' + [14]"]   = "sc_field_8";
   }
   ...
   {
       $tab_def_campos['sc_field_9'] = "[15] + N' - ' + [16]";
       $tab_converte["[15] + N' - ' + [16]"]   = "sc_field_9";
   }
   ...
   {
       $tab_def_campos['sc_field_10'] = "[16] + N' - ' + [17]";
       $tab_converte["[16] + N' - ' + [17]"]   = "sc_field_10";
   }
   ...
   {
       $tab_def_campos['sc_field_11'] = "[18] + N' - ' + [19]";
       $tab_converte["[18] + N' - ' + [19]"]   = "sc_field_11";
   }
   ...
   {
       $tab_def_campos['sc_field_12'] = "[20] + N' - ' + [21]";
       $tab_converte["[20] + N' - ' + [21]"]   = "sc_field_12";
   }
   ...
   {
       $tab_def_campos['sc_field_13'] = "[22] + N' - ' + [23]";
       $tab_converte["[22] + N' - ' + [23]"]   = "sc_field_13";
   }
   ...
   {
       $tab_def_campos['sc_field_14'] = "[24] + N' - ' + [25]";
       $tab_converte["[24] + N' - ' + [25]"]   = "sc_field_14";
   }
   ...
   {
       $tab_def_campos['sc_field_15'] = "[26] + N' - ' + [27]";
       $tab_converte["[26] + N' - ' + [27]"]   = "sc_field_15";
   }
   ...
   {
       $tab_def_campos['sc_field_16'] = "[28] + N' - ' + [29]";
       $tab_converte["[28] + N' - ' + [29]"]   = "sc_field_16";
   }
   ...
   {
       $tab_def_campos['sc_field_17'] = "[30] + N' - ' + [31]";
       $tab_converte["[30] + N' - ' + [31]"]   = "sc_field_17";
   }
   ...
   {
       $tab_def_campos['sc_field_18'] = "[31] + N' - ' + [32]";
       $tab_converte["[31] + N' - ' + [32]"]   = "sc_field_18";
   }
   ...
   {
       $tab_def_campos['sc_field_19'] = "[33] + N' - ' + [34]";
       $tab_converte["[33] + N' - ' + [34]"]   = "sc_field_19";
   }
   ...
   {
       $tab_def_campos['sc_field_20'] = "[35] + N' - ' + [36]";
       $tab_converte["[35] + N' - ' + [36]"]   = "sc_field_20";
   }
   ...
   {
       $tab_def_campos['sc_field_21'] = "[37] + N' - ' + [38]";
       $tab_converte["[37] + N' - ' + [38]"]   = "sc_field_21";
   }
   ...
   {
       $tab_def_campos['sc_field_22'] = "[38] + N' - ' + [39]";
       $tab_converte["[38] + N' - ' + [39]"]   = "sc_field_22";
   }
   ...
   {
       $tab_def_campos['sc_field_23'] = "[40] + N' - ' + [41]";
       $tab_converte["[40] + N' - ' + [41]"]   = "sc_field_23";
   }
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['Motel_InOut_Data']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
