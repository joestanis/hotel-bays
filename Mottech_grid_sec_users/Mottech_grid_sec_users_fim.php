...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_grid_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Mottech_____Mottech_grid_sec_users"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['Mottech_form_edit_users'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Mottech_grid_sec_users']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Mottech_grid_sec_users</TITLE>
