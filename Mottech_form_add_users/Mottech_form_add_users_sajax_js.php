  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_Mottech_form_add_users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_Mottech_form_add_users_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_form_add_users_validate_login(var_login, var_script_case_init, do_ajax_Mottech_form_add_users_validate_login_cb);
  } // do_ajax_Mottech_form_add_users_validate_login

  function do_ajax_Mottech_form_add_users_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_form_add_users_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_Mottech_form_add_users_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_form_add_users_validate_pswd(var_pswd, var_script_case_init, do_ajax_Mottech_form_add_users_validate_pswd_cb);
  } // do_ajax_Mottech_form_add_users_validate_pswd

  function do_ajax_Mottech_form_add_users_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_form_add_users_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_Mottech_form_add_users_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_form_add_users_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_Mottech_form_add_users_validate_confirm_pswd_cb);
  } // do_ajax_Mottech_form_add_users_validate_confirm_pswd

  function do_ajax_Mottech_form_add_users_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_form_add_users_validate_confirm_pswd_cb

  // ---------- Validate name
  function do_ajax_Mottech_form_add_users_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_form_add_users_validate_name(var_name, var_script_case_init, do_ajax_Mottech_form_add_users_validate_name_cb);
  } // do_ajax_Mottech_form_add_users_validate_name

  function do_ajax_Mottech_form_add_users_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "name";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_form_add_users_validate_name_cb

  // ---------- Validate email
  function do_ajax_Mottech_form_add_users_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_Mottech_form_add_users_validate_email(var_email, var_script_case_init, do_ajax_Mottech_form_add_users_validate_email_cb);
  } // do_ajax_Mottech_form_add_users_validate_email

  function do_ajax_Mottech_form_add_users_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "email";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_Mottech_form_add_users_validate_email_cb
  // ---------- Form
  function do_ajax_Mottech_form_add_users_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_Mottech_form_add_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_Mottech_form_add_users_submit_form_cb);
  } // do_ajax_Mottech_form_add_users_submit_form

  function do_ajax_Mottech_form_add_users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_Mottech_form_add_users_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_Mottech_form_add_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_Mottech_form_add_users_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_Mottech_form_add_users_navigate_form_cb);
  } // do_ajax_Mottech_form_add_users_navigate_form

  function do_ajax_Mottech_form_add_users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_Mottech_form_add_users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_Mottech_form_add_users_navigate_form_cb
